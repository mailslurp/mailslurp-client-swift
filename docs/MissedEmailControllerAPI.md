...
# **getAllMissedEmails**
```swift
    open class func getAllMissedEmails( before: Date? = nil,  inboxId: UUID? = nil,  page: Int? = nil,  searchFilter: String? = nil,  since: Date? = nil,  size: Int? = nil,  sort: Sort_getAllMissedEmails? = nil) -> Promise<PageMissedEmailProjection>
```
...
// Get all MissedEmails in paginated format
MissedEmailControllerAPI.getAllMissedEmails(before: before, inboxId: inboxId, page: page, searchFilter: searchFilter, since: since, size: size, sort: sort).then {
...
```swift
    open class func getAllUnknownMissedEmails( before: Date? = nil,  inboxId: UUID? = nil,  page: Int? = nil,  searchFilter: String? = nil,  since: Date? = nil,  size: Int? = nil,  sort: Sort_getAllUnknownMissedEmails? = nil) -> Promise<PageUnknownMissedEmailProjection>
```
...
// Get all unknown missed emails in paginated format
MissedEmailControllerAPI.getAllUnknownMissedEmails(before: before, inboxId: inboxId, page: page, searchFilter: searchFilter, since: since, size: size, sort: sort).then {
         // when the promise is fulfilled
     }.always {
         // regardless of whether the promise is fulfilled, or rejected
     }.catch { errorType in
...
```swift
    open class func waitForNthMissedEmail( before: Date? = nil,  inboxId: UUID? = nil,  index: Int? = nil,  since: Date? = nil,  timeout: Int64? = nil) -> Promise<MissedEmail>
```
...
// Wait for Nth missed email
MissedEmailControllerAPI.waitForNthMissedEmail(before: before, inboxId: inboxId, index: index, since: since, timeout: timeout).then {
         // when the promise is fulfilled
     }.always {
         // regardless of whether the promise is fulfilled, or rejected
     }.catch { errorType in
