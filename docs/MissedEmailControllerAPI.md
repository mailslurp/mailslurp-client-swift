...
# **getAllMissedEmails**
```swift
    open class func getAllMissedEmails( page: Int? = nil,  searchFilter: String? = nil,  size: Int? = nil,  sort: Sort_getAllMissedEmails? = nil) -> Promise<PageMissedEmailProjection>
```
...
// Get all MissedEmails in paginated format
MissedEmailControllerAPI.getAllMissedEmails(page: page, searchFilter: searchFilter, size: size, sort: sort).then {
