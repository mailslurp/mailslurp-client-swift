...
```swift
    open class func getAllSentTrackingPixels( page: Int? = nil,  searchFilter: String? = nil,  size: Int? = nil,  sort: Sort_getAllSentTrackingPixels? = nil) -> Promise<PageTrackingPixelProjection>
```
...
// Get all sent email tracking pixels in paginated form
SentEmailsControllerAPI.getAllSentTrackingPixels(page: page, searchFilter: searchFilter, size: size, sort: sort).then {
...
```swift
    open class func getSentEmailTrackingPixels( _id: UUID,  page: Int? = nil,  searchFilter: String? = nil,  size: Int? = nil,  sort: Sort_getSentEmailTrackingPixels? = nil) -> Promise<PageTrackingPixelProjection>
```
...
// Get all tracking pixels for a sent email in paginated form
SentEmailsControllerAPI.getSentEmailTrackingPixels(_id: _id, page: page, searchFilter: searchFilter, size: size, sort: sort).then {
         // when the promise is fulfilled
     }.always {
         // regardless of whether the promise is fulfilled, or rejected
     }.catch { errorType in
