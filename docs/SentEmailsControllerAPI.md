...
# **deleteSentEmail**
```swift
    open class func deleteSentEmail(_id: UUID, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
// Delete sent email receipt
SentEmailsControllerAPI.deleteSentEmail(_id: _id) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getSentEmailHTMLContent(_id: UUID, completion: @escaping (_ data: String?, _ error: Error?) -> Void)
```
...
// Get sent email HTML content
SentEmailsControllerAPI.getSentEmailHTMLContent(_id: _id) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getSentEmailPreviewURLs(_id: UUID, completion: @escaping (_ data: EmailPreviewUrls?, _ error: Error?) -> Void)
```
...
// Get sent email URL for viewing in browser or downloading
SentEmailsControllerAPI.getSentEmailPreviewURLs(_id: _id) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getSentEmailTrackingPixels(_id: UUID, page: Int? = nil, size: Int? = nil, sort: Sort_getSentEmailTrackingPixels? = nil, searchFilter: String? = nil, since: Date? = nil, before: Date? = nil, completion: @escaping (_ data: PageTrackingPixelProjection?, _ error: Error?) -> Void)
```
...
SentEmailsControllerAPI.getSentEmailTrackingPixels(_id: _id, page: page, size: size, sort: sort, searchFilter: searchFilter, since: since, before: before) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
