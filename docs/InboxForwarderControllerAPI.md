...
```swift
    open class func deleteInboxForwarder(_id: UUID, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
// Delete an inbox forwarder
InboxForwarderControllerAPI.deleteInboxForwarder(_id: _id) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **getInboxForwarder**
```swift
    open class func getInboxForwarder(_id: UUID, completion: @escaping (_ data: InboxForwarderDto?, _ error: Error?) -> Void)
```
...
// Get an inbox forwarder
InboxForwarderControllerAPI.getInboxForwarder(_id: _id) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **testInboxForwarder**
```swift
    open class func testInboxForwarder(_id: UUID, inboxForwarderTestOptions: InboxForwarderTestOptions, completion: @escaping (_ data: InboxForwarderTestResult?, _ error: Error?) -> Void)
```
...
// Test an inbox forwarder
InboxForwarderControllerAPI.testInboxForwarder(_id: _id, inboxForwarderTestOptions: inboxForwarderTestOptions) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
