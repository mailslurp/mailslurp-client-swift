...
let createInboxForwarderOptions = CreateInboxForwarderOptions(field: "field_example", forwardToRecipients: ["forwardToRecipients_example"], match: "match_example") // CreateInboxForwarderOptions | createInboxForwarderOptions
...
# **getInboxForwarders**
```swift
    open class func getInboxForwarders( before: Date? = nil,  inboxId: UUID? = nil,  page: Int? = nil,  searchFilter: String? = nil,  since: Date? = nil,  size: Int? = nil,  sort: Sort_getInboxForwarders? = nil) -> Promise<PageInboxForwarderDto>
```
...
// List inbox forwarders
InboxForwarderControllerAPI.getInboxForwarders(before: before, inboxId: inboxId, page: page, searchFilter: searchFilter, since: since, size: size, sort: sort).then {
         // when the promise is fulfilled
     }.always {
         // regardless of whether the promise is fulfilled, or rejected
     }.catch { errorType in
