...
# **getBouncedEmail**
```swift
    open class func getBouncedEmail( _id: UUID) -> Promise<Bounce>
```
...
# **getBouncedEmails**
```swift
    open class func getBouncedEmails( page: Int? = nil,  size: Int? = nil,  sort: Sort_getBouncedEmails? = nil) -> Promise<PageBouncedEmail>
```
...
# **getBouncedRecipient**
```swift
    open class func getBouncedRecipient( _id: UUID) -> Promise<BounceRecipient>
```
...
```swift
    open class func getBouncedRecipients( page: Int? = nil,  size: Int? = nil,  sort: Sort_getBouncedRecipients? = nil) -> Promise<PageBouncedRecipients>
```
