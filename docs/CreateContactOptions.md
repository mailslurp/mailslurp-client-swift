...
**emailAddresses** | **Set<String>** | Set of email addresses belonging to the contact | [optional] 
**tags** | **Set<String>** | Tags that can be used to search and group contacts | [optional] 
