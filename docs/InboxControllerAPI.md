...
# **createInbox**
```swift
    open class func createInbox(allowTeamAccess: Bool? = nil, _description: String? = nil, emailAddress: String? = nil, expiresAt: Date? = nil, expiresIn: Int64? = nil, favourite: Bool? = nil, name: String? = nil, tags: [String]? = nil, useDomainPool: Bool? = nil, completion: @escaping (_ data: Inbox?, _ error: Error?) -> Void)
```
...
// Create an inbox email address. An inbox has a real email address and can send and receive emails.
InboxControllerAPI.createInbox(allowTeamAccess: allowTeamAccess, _description: _description, emailAddress: emailAddress, expiresAt: expiresAt, expiresIn: expiresIn, favourite: favourite, name: name, tags: tags, useDomainPool: useDomainPool) { (response, error) in
