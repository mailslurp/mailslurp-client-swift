...
# **createInbox**
```swift
    open class func createInbox(emailAddress: String? = nil, tags: [String]? = nil, name: String? = nil, description: String? = nil, useDomainPool: Bool? = nil, favourite: Bool? = nil, expiresAt: Date? = nil, expiresIn: Int64? = nil, allowTeamAccess: Bool? = nil, inboxType: InboxType_createInbox? = nil, virtualInbox: Bool? = nil, completion: @escaping (_ data: InboxDto?, _ error: Error?) -> Void)
```
...
let description = "description_example" // String | Optional description of the inbox for labelling purposes. Is shown in the dashboard and can be used with (optional)
...
// Create an inbox email address. An inbox has a real email address and can send and receive emails. Inboxes can be either `SMTP` or `HTTP` inboxes.
InboxControllerAPI.createInbox(emailAddress: emailAddress, tags: tags, name: name, description: description, useDomainPool: useDomainPool, favourite: favourite, expiresAt: expiresAt, expiresIn: expiresIn, allowTeamAccess: allowTeamAccess, inboxType: inboxType, virtualInbox: virtualInbox) { (response, error) in
...
# **createInboxRuleset**
```swift
    open class func createInboxRuleset(inboxId: UUID, createInboxRulesetOptions: CreateInboxRulesetOptions, completion: @escaping (_ data: InboxRulesetDto?, _ error: Error?) -> Void)
```
...
// Create an inbox ruleset
InboxControllerAPI.createInboxRuleset(inboxId: inboxId, createInboxRulesetOptions: createInboxRulesetOptions) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func createInboxWithDefaults(completion: @escaping (_ data: InboxDto?, _ error: Error?) -> Void)
```
...
// Create an inbox with default options. Uses MailSlurp domain pool address and is private.
InboxControllerAPI.createInboxWithDefaults() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func createInboxWithOptions(createInboxDto: CreateInboxDto, completion: @escaping (_ data: InboxDto?, _ error: Error?) -> Void)
```
...
let createInboxDto = CreateInboxDto(emailAddress: "emailAddress_example", name: "name_example", description: "description_example", useDomainPool: false, tags: ["tags_example"], expiresAt: Date(), favourite: false, expiresIn: 123, allowTeamAccess: false, inboxType: "inboxType_example", virtualInbox: false) // CreateInboxDto | 
...
```swift
    open class func deleteAllInboxEmails(inboxId: UUID, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
// Delete all emails in a given inboxes.
InboxControllerAPI.deleteAllInboxEmails(inboxId: inboxId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **doesInboxExist**
```swift
    open class func doesInboxExist(emailAddress: String, completion: @escaping (_ data: InboxExistsDto?, _ error: Error?) -> Void)
```
...
// Does inbox exist
InboxControllerAPI.doesInboxExist(emailAddress: emailAddress) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **flushExpired**
```swift
    open class func flushExpired(before: Date? = nil, completion: @escaping (_ data: FlushExpiredInboxesResult?, _ error: Error?) -> Void)
```
...
// Remove expired inboxes
InboxControllerAPI.flushExpired(before: before) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **getAllInboxes**
```swift
    open class func getAllInboxes(page: Int? = nil, size: Int? = nil, sort: Sort_getAllInboxes? = nil, favourite: Bool? = nil, search: String? = nil, tag: String? = nil, teamAccess: Bool? = nil, since: Date? = nil, before: Date? = nil, completion: @escaping (_ data: PageInboxProjection?, _ error: Error?) -> Void)
```
...
// List All Inboxes Paginated
InboxControllerAPI.getAllInboxes(page: page, size: size, sort: sort, favourite: favourite, search: search, tag: tag, teamAccess: teamAccess, since: since, before: before) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **getEmails**
```swift
    open class func getEmails(inboxId: UUID, size: Int? = nil, limit: Int? = nil, sort: Sort_getEmails? = nil, retryTimeout: Int64? = nil, delayTimeout: Int64? = nil, minCount: Int64? = nil, unreadOnly: Bool? = nil, before: Date? = nil, since: Date? = nil, completion: @escaping (_ data: [EmailPreview]?, _ error: Error?) -> Void)
```
...
// Get emails in an Inbox. This method is not idempotent as it allows retries and waits if you want certain conditions to be met before returning. For simple listing and sorting of known emails use the email controller instead.
InboxControllerAPI.getEmails(inboxId: inboxId, size: size, limit: limit, sort: sort, retryTimeout: retryTimeout, delayTimeout: delayTimeout, minCount: minCount, unreadOnly: unreadOnly, before: before, since: since) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **getImapSmtpAccess**
```swift
    open class func getImapSmtpAccess(inboxId: UUID? = nil, completion: @escaping (_ data: ImapSmtpAccessDetails?, _ error: Error?) -> Void)
```
...
InboxControllerAPI.getImapSmtpAccess(inboxId: inboxId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **getInbox**
```swift
    open class func getInbox(inboxId: UUID, completion: @escaping (_ data: InboxDto?, _ error: Error?) -> Void)
```
...
```swift
    open class func getInboxByEmailAddress(emailAddress: String, completion: @escaping (_ data: InboxByEmailAddressResult?, _ error: Error?) -> Void)
```
...
// Search for an inbox with the provided email address
InboxControllerAPI.getInboxByEmailAddress(emailAddress: emailAddress) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **getInboxByName**
```swift
    open class func getInboxByName(name: String, completion: @escaping (_ data: InboxByNameResult?, _ error: Error?) -> Void)
```
...
// Search for an inbox with the given name
InboxControllerAPI.getInboxByName(name: name) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **getInboxCount**
```swift
    open class func getInboxCount(completion: @escaping (_ data: CountDto?, _ error: Error?) -> Void)
```
...
// Get total inbox count
InboxControllerAPI.getInboxCount() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **getInboxEmailCount**
```swift
    open class func getInboxEmailCount(inboxId: UUID, completion: @escaping (_ data: CountDto?, _ error: Error?) -> Void)
```
...
// Get email count in inbox
InboxControllerAPI.getInboxEmailCount(inboxId: inboxId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getInboxEmailsPaginated(inboxId: UUID, page: Int? = nil, size: Int? = nil, sort: Sort_getInboxEmailsPaginated? = nil, since: Date? = nil, before: Date? = nil, completion: @escaping (_ data: PageEmailPreview?, _ error: Error?) -> Void)
```
...
// Get inbox emails paginated
InboxControllerAPI.getInboxEmailsPaginated(inboxId: inboxId, page: page, size: size, sort: sort, since: since, before: before) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **getInboxIds**
```swift
    open class func getInboxIds(completion: @escaping (_ data: InboxIdsResult?, _ error: Error?) -> Void)
```
...
// Get all inbox IDs
InboxControllerAPI.getInboxIds() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **getInboxSentEmails**
```swift
    open class func getInboxSentEmails(inboxId: UUID, page: Int? = nil, size: Int? = nil, sort: Sort_getInboxSentEmails? = nil, searchFilter: String? = nil, since: Date? = nil, before: Date? = nil, completion: @escaping (_ data: PageSentEmailProjection?, _ error: Error?) -> Void)
```
...
// Get Inbox Sent Emails
InboxControllerAPI.getInboxSentEmails(inboxId: inboxId, page: page, size: size, sort: sort, searchFilter: searchFilter, since: since, before: before) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **getInboxes**
```swift
    open class func getInboxes(size: Int? = nil, sort: Sort_getInboxes? = nil, since: Date? = nil, before: Date? = nil, completion: @escaping (_ data: [InboxDto]?, _ error: Error?) -> Void)
```
...
// List Inboxes and email addresses
InboxControllerAPI.getInboxes(size: size, sort: sort, since: since, before: before) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getLatestEmailInInbox(inboxId: UUID, timeoutMillis: Int64, completion: @escaping (_ data: Email?, _ error: Error?) -> Void)
```
...
// Get latest email in an inbox. Use `WaitForController` to get emails that may not have arrived yet.
InboxControllerAPI.getLatestEmailInInbox(inboxId: inboxId, timeoutMillis: timeoutMillis) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getOrganizationInboxes(page: Int? = nil, size: Int? = nil, sort: Sort_getOrganizationInboxes? = nil, searchFilter: String? = nil, since: Date? = nil, before: Date? = nil, completion: @escaping (_ data: PageOrganizationInboxProjection?, _ error: Error?) -> Void)
```
...
// List Organization Inboxes Paginated
InboxControllerAPI.getOrganizationInboxes(page: page, size: size, sort: sort, searchFilter: searchFilter, since: since, before: before) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **listInboxRulesets**
```swift
    open class func listInboxRulesets(inboxId: UUID, page: Int? = nil, size: Int? = nil, sort: Sort_listInboxRulesets? = nil, searchFilter: String? = nil, since: Date? = nil, before: Date? = nil, completion: @escaping (_ data: PageInboxRulesetDto?, _ error: Error?) -> Void)
```
...
// List inbox rulesets
InboxControllerAPI.listInboxRulesets(inboxId: inboxId, page: page, size: size, sort: sort, searchFilter: searchFilter, since: since, before: before) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func listInboxTrackingPixels(inboxId: UUID, page: Int? = nil, size: Int? = nil, sort: Sort_listInboxTrackingPixels? = nil, searchFilter: String? = nil, since: Date? = nil, before: Date? = nil, completion: @escaping (_ data: PageTrackingPixelProjection?, _ error: Error?) -> Void)
```
...
// List inbox tracking pixels
InboxControllerAPI.listInboxTrackingPixels(inboxId: inboxId, page: page, size: size, sort: sort, searchFilter: searchFilter, since: since, before: before) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **sendEmail**
```swift
    open class func sendEmail(inboxId: UUID, sendEmailOptions: SendEmailOptions, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
# **sendEmailAndConfirm**
```swift
    open class func sendEmailAndConfirm(inboxId: UUID, sendEmailOptions: SendEmailOptions, completion: @escaping (_ data: SentEmailDto?, _ error: Error?) -> Void)
```
...
# **sendEmailWithQueue**
```swift
    open class func sendEmailWithQueue(inboxId: UUID, validateBeforeEnqueue: Bool, sendEmailOptions: SendEmailOptions, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
// Send email with queue
InboxControllerAPI.sendEmailWithQueue(inboxId: inboxId, validateBeforeEnqueue: validateBeforeEnqueue, sendEmailOptions: sendEmailOptions) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **sendSmtpEnvelope**
```swift
    open class func sendSmtpEnvelope(inboxId: UUID, sendSMTPEnvelopeOptions: SendSMTPEnvelopeOptions, completion: @escaping (_ data: SentEmailDto?, _ error: Error?) -> Void)
```
...
// Send email using an SMTP mail envelope and message body and return sent confirmation
InboxControllerAPI.sendSmtpEnvelope(inboxId: inboxId, sendSMTPEnvelopeOptions: sendSMTPEnvelopeOptions) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **sendTestEmail**
```swift
    open class func sendTestEmail(inboxId: UUID, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
// Send a test email to inbox
InboxControllerAPI.sendTestEmail(inboxId: inboxId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **setInboxFavourited**
```swift
    open class func setInboxFavourited(inboxId: UUID, setInboxFavouritedOptions: SetInboxFavouritedOptions, completion: @escaping (_ data: InboxDto?, _ error: Error?) -> Void)
```
...
# **updateInbox**
```swift
    open class func updateInbox(inboxId: UUID, updateInboxOptions: UpdateInboxOptions, completion: @escaping (_ data: InboxDto?, _ error: Error?) -> Void)
```
...
let inboxId = 987 // UUID | 
let updateInboxOptions = UpdateInboxOptions(name: "name_example", description: "description_example", tags: ["tags_example"], expiresAt: Date(), favourite: false) // UpdateInboxOptions | 
