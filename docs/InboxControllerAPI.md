...
# **createInboxRuleset**
```swift
    open class func createInboxRuleset( inboxId: UUID,  createRulesetOptions: CreateRulesetOptions) -> Promise<RulesetDto>
```
...
// Create an inbox ruleset
InboxControllerAPI.createInboxRuleset(inboxId: inboxId, createRulesetOptions: createRulesetOptions).then {
         // when the promise is fulfilled
     }.always {
         // regardless of whether the promise is fulfilled, or rejected
     }.catch { errorType in
...
# **doesInboxExist**
```swift
    open class func doesInboxExist( emailAddress: String,  allowCatchAll: Bool? = nil,  ipAddress: String? = nil,  sender: String? = nil) -> Promise<InboxExistsDto>
```
...
let allowCatchAll = true // Bool | Allow catch all (optional)
let ipAddress = "ipAddress_example" // String | IP address (optional)
let sender = "sender_example" // String | Sender (optional)

// Does inbox exist
InboxControllerAPI.doesInboxExist(emailAddress: emailAddress, allowCatchAll: allowCatchAll, ipAddress: ipAddress, sender: sender).then {
         // when the promise is fulfilled
     }.always {
         // regardless of whether the promise is fulfilled, or rejected
     }.catch { errorType in
...
# **listInboxRulesets**
```swift
    open class func listInboxRulesets( inboxId: UUID,  page: Int? = nil,  size: Int? = nil,  sort: Sort_listInboxRulesets? = nil,  searchFilter: String? = nil,  since: Date? = nil,  before: Date? = nil) -> Promise<PageRulesetDto>
```
