...
# **createInbox**
```swift
    open class func createInbox(_description: String? = nil, emailAddress: String? = nil, expiresAt: Date? = nil, expiresIn: Int64? = nil, favourite: Bool? = nil, name: String? = nil, tags: [String]? = nil, useDomainPool: Bool? = nil, completion: @escaping (_ data: Inbox?, _ error: Error?) -> Void)
```
...
// Create an Inbox (email address)
InboxControllerAPI.createInbox(_description: _description, emailAddress: emailAddress, expiresAt: expiresAt, expiresIn: expiresIn, favourite: favourite, name: name, tags: tags, useDomainPool: useDomainPool) { (response, error) in
...
let createInboxDto = CreateInboxDto(_description: "_description_example", emailAddress: "emailAddress_example", expiresAt: Date(), expiresIn: 123, favourite: false, name: "name_example", tags: ["tags_example"], useDomainPool: false) // CreateInboxDto | createInboxDto
