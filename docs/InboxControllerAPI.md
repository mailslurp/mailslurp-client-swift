...
# **createInbox**
```swift
    open class func createInbox( allowTeamAccess: Bool? = nil,  _description: String? = nil,  emailAddress: String? = nil,  expiresAt: Date? = nil,  expiresIn: Int64? = nil,  favourite: Bool? = nil,  inboxType: InboxType_createInbox? = nil,  name: String? = nil,  tags: [String]? = nil,  useDomainPool: Bool? = nil) -> Promise<Inbox>
```
...
// Create an inbox email address. An inbox has a real email address and can send and receive emails. Inboxes can be either `SMTP` or `HTTP` inboxes.
InboxControllerAPI.createInbox(allowTeamAccess: allowTeamAccess, _description: _description, emailAddress: emailAddress, expiresAt: expiresAt, expiresIn: expiresIn, favourite: favourite, inboxType: inboxType, name: name, tags: tags, useDomainPool: useDomainPool).then {
...
```swift
    open class func createInboxWithDefaults() -> Promise<Inbox>
```
...
```swift
    open class func createInboxWithOptions( createInboxDto: CreateInboxDto) -> Promise<Inbox>
```
...
let createInboxDto = CreateInboxDto(allowTeamAccess: false, _description: "_description_example", emailAddress: "emailAddress_example", expiresAt: Date(), expiresIn: 123, favourite: false, inboxType: "inboxType_example", name: "name_example", tags: ["tags_example"], useDomainPool: false) // CreateInboxDto | createInboxDto
...
# **getAllInboxes**
```swift
    open class func getAllInboxes( before: Date? = nil,  favourite: Bool? = nil,  page: Int? = nil,  search: String? = nil,  since: Date? = nil,  size: Int? = nil,  sort: Sort_getAllInboxes? = nil,  tag: String? = nil,  teamAccess: Bool? = nil) -> Promise<PageInboxProjection>
```
...
let teamAccess = true // Bool | DEPRECATED. Optionally filter by team access. (optional) (default to false)

// List All Inboxes Paginated
InboxControllerAPI.getAllInboxes(before: before, favourite: favourite, page: page, search: search, since: since, size: size, sort: sort, tag: tag, teamAccess: teamAccess).then {
         // when the promise is fulfilled
     }.always {
         // regardless of whether the promise is fulfilled, or rejected
     }.catch { errorType in
...
# **getEmails**
```swift
    open class func getEmails( inboxId: UUID,  before: Date? = nil,  delayTimeout: Int64? = nil,  limit: Int? = nil,  minCount: Int64? = nil,  retryTimeout: Int64? = nil,  since: Date? = nil,  size: Int? = nil,  sort: Sort_getEmails? = nil,  unreadOnly: Bool? = nil) -> Promise<[EmailPreview]>
```
...
let delayTimeout = 987 // Int64 | delayTimeout (optional)
...
let unreadOnly = true // Bool | unreadOnly (optional)

// Get emails in an Inbox. This method is not idempotent as it allows retries and waits if you want certain conditions to be met before returning. For simple listing and sorting of known emails use the email controller instead.
InboxControllerAPI.getEmails(inboxId: inboxId, before: before, delayTimeout: delayTimeout, limit: limit, minCount: minCount, retryTimeout: retryTimeout, since: since, size: size, sort: sort, unreadOnly: unreadOnly).then {
         // when the promise is fulfilled
     }.always {
         // regardless of whether the promise is fulfilled, or rejected
     }.catch { errorType in
 ...
 **delayTimeout** | **Int64** | delayTimeout | [optional] 
...
# **getInbox**
```swift
    open class func getInbox( inboxId: UUID) -> Promise<Inbox>
```
...
```swift
    open class func getInboxEmailsPaginated( inboxId: UUID,  before: Date? = nil,  page: Int? = nil,  since: Date? = nil,  size: Int? = nil,  sort: Sort_getInboxEmailsPaginated? = nil) -> Promise<PageEmailPreview>
```
...
// Get inbox emails paginated
InboxControllerAPI.getInboxEmailsPaginated(inboxId: inboxId, before: before, page: page, since: since, size: size, sort: sort).then {
         // when the promise is fulfilled
     }.always {
         // regardless of whether the promise is fulfilled, or rejected
     }.catch { errorType in
...
# **getInboxSentEmails**
```swift
    open class func getInboxSentEmails( inboxId: UUID,  before: Date? = nil,  page: Int? = nil,  searchFilter: String? = nil,  since: Date? = nil,  size: Int? = nil,  sort: Sort_getInboxSentEmails? = nil) -> Promise<PageSentEmailProjection>
```
...
// Get Inbox Sent Emails
InboxControllerAPI.getInboxSentEmails(inboxId: inboxId, before: before, page: page, searchFilter: searchFilter, since: since, size: size, sort: sort).then {
         // when the promise is fulfilled
     }.always {
         // regardless of whether the promise is fulfilled, or rejected
     }.catch { errorType in
...
# **getInboxes**
```swift
    open class func getInboxes( before: Date? = nil,  since: Date? = nil,  size: Int? = nil,  sort: Sort_getInboxes? = nil) -> Promise<[Inbox]>
```
...
// List Inboxes and email addresses
InboxControllerAPI.getInboxes(before: before, since: since, size: size, sort: sort).then {
         // when the promise is fulfilled
     }.always {
         // regardless of whether the promise is fulfilled, or rejected
     }.catch { errorType in
...
```swift
    open class func getOrganizationInboxes( before: Date? = nil,  page: Int? = nil,  searchFilter: String? = nil,  since: Date? = nil,  size: Int? = nil,  sort: Sort_getOrganizationInboxes? = nil) -> Promise<PageOrganizationInboxProjection>
```
...
// List Organization Inboxes Paginated
InboxControllerAPI.getOrganizationInboxes(before: before, page: page, searchFilter: searchFilter, since: since, size: size, sort: sort).then {
         // when the promise is fulfilled
     }.always {
         // regardless of whether the promise is fulfilled, or rejected
     }.catch { errorType in
...
# **listInboxRulesets**
```swift
    open class func listInboxRulesets( inboxId: UUID,  before: Date? = nil,  page: Int? = nil,  searchFilter: String? = nil,  since: Date? = nil,  size: Int? = nil,  sort: Sort_listInboxRulesets? = nil) -> Promise<PageInboxRulesetDto>
```
...
// List inbox rulesets
InboxControllerAPI.listInboxRulesets(inboxId: inboxId, before: before, page: page, searchFilter: searchFilter, since: since, size: size, sort: sort).then {
         // when the promise is fulfilled
     }.always {
         // regardless of whether the promise is fulfilled, or rejected
     }.catch { errorType in
...
```swift
    open class func listInboxTrackingPixels( inboxId: UUID,  before: Date? = nil,  page: Int? = nil,  searchFilter: String? = nil,  since: Date? = nil,  size: Int? = nil,  sort: Sort_listInboxTrackingPixels? = nil) -> Promise<PageTrackingPixelProjection>
```
...
// List inbox tracking pixels
InboxControllerAPI.listInboxTrackingPixels(inboxId: inboxId, before: before, page: page, searchFilter: searchFilter, since: since, size: size, sort: sort).then {
         // when the promise is fulfilled
     }.always {
         // regardless of whether the promise is fulfilled, or rejected
     }.catch { errorType in
...
# **sendEmail**
```swift
    open class func sendEmail( inboxId: UUID,  sendEmailOptions: SendEmailOptions? = nil) -> Promise<Void>
```
...
let sendEmailOptions = SendEmailOptions(addTrackingPixel: false, attachments: ["attachments_example"], bcc: ["bcc_example"], body: "body_example", cc: ["cc_example"], charset: "charset_example", from: "from_example", html: false, isHTML: false, replyTo: "replyTo_example", sendStrategy: "sendStrategy_example", subject: "subject_example", template: 123, templateVariables: "TODO", to: ["to_example"], toContacts: [123], toGroup: 123, useInboxName: false) // SendEmailOptions | Options for the email (optional)
...
# **sendEmailAndConfirm**
```swift
    open class func sendEmailAndConfirm( inboxId: UUID,  sendEmailOptions: SendEmailOptions? = nil) -> Promise<SentEmailDto>
```
...
# **setInboxFavourited**
```swift
    open class func setInboxFavourited( inboxId: UUID,  setInboxFavouritedOptions: SetInboxFavouritedOptions) -> Promise<Inbox>
```
...
# **updateInbox**
```swift
    open class func updateInbox( inboxId: UUID,  updateInboxOptions: UpdateInboxOptions) -> Promise<Inbox>
```
