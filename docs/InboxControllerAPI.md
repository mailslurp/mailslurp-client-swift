...
let allowTeamAccess = true // Bool | Grant team access to this inbox and the emails that belong to it for team members of your organization. (optional)
...
# **getAllInboxes**
```swift
    open class func getAllInboxes( favourite: Bool? = nil,  page: Int? = nil,  search: String? = nil,  size: Int? = nil,  sort: Sort_getAllInboxes? = nil,  tag: String? = nil,  teamAccess: Bool? = nil) -> Promise<PageInboxProjection>
```
...
let teamAccess = true // Bool | Optionally filter by team access. Defaults to false so organization inboxes are not included (optional) (default to false)

// List All Inboxes Paginated
InboxControllerAPI.getAllInboxes(favourite: favourite, page: page, search: search, size: size, sort: sort, tag: tag, teamAccess: teamAccess).then {
         // when the promise is fulfilled
     }.always {
         // regardless of whether the promise is fulfilled, or rejected
     }.catch { errorType in
...
# **getEmails**
```swift
    open class func getEmails( inboxId: UUID,  delayTimeout: Int64? = nil,  limit: Int? = nil,  minCount: Int64? = nil,  retryTimeout: Int64? = nil,  since: Date? = nil,  size: Int? = nil,  sort: Sort_getEmails? = nil,  unreadOnly: Bool? = nil) -> Promise<[EmailPreview]>
```
...
// Get emails in an Inbox. This method is not idempotent as it allows retries and waits if you want certain conditions to be met before returning. For simple listing and sorting of known emails use the email controller instead.
InboxControllerAPI.getEmails(inboxId: inboxId, delayTimeout: delayTimeout, limit: limit, minCount: minCount, retryTimeout: retryTimeout, since: since, size: size, sort: sort, unreadOnly: unreadOnly).then {
         // when the promise is fulfilled
     }.always {
         // regardless of whether the promise is fulfilled, or rejected
     }.catch { errorType in
...
```swift
    open class func getInboxEmailsPaginated( inboxId: UUID,  page: Int? = nil,  size: Int? = nil,  sort: Sort_getInboxEmailsPaginated? = nil) -> Promise<PageEmailPreview>
```
...
// Get inbox emails paginated
InboxControllerAPI.getInboxEmailsPaginated(inboxId: inboxId, page: page, size: size, sort: sort).then {
         // when the promise is fulfilled
     }.always {
         // regardless of whether the promise is fulfilled, or rejected
     }.catch { errorType in
...
# **getInboxSentEmails**
```swift
    open class func getInboxSentEmails( inboxId: UUID,  page: Int? = nil,  searchFilter: String? = nil,  size: Int? = nil,  sort: Sort_getInboxSentEmails? = nil) -> Promise<PageSentEmailProjection>
```
...
// Get Inbox Sent Emails
InboxControllerAPI.getInboxSentEmails(inboxId: inboxId, page: page, searchFilter: searchFilter, size: size, sort: sort).then {
         // when the promise is fulfilled
     }.always {
         // regardless of whether the promise is fulfilled, or rejected
     }.catch { errorType in
...
# **getInboxes**
```swift
    open class func getInboxes( size: Int? = nil,  sort: Sort_getInboxes? = nil) -> Promise<[Inbox]>
```
...
// List Inboxes and email addresses
InboxControllerAPI.getInboxes(size: size, sort: sort).then {
         // when the promise is fulfilled
     }.always {
         // regardless of whether the promise is fulfilled, or rejected
     }.catch { errorType in
...
```swift
    open class func getOrganizationInboxes( page: Int? = nil,  searchFilter: String? = nil,  size: Int? = nil,  sort: Sort_getOrganizationInboxes? = nil) -> Promise<PageOrganizationInboxProjection>
```
...
// List Organization Inboxes Paginated
InboxControllerAPI.getOrganizationInboxes(page: page, searchFilter: searchFilter, size: size, sort: sort).then {
         // when the promise is fulfilled
     }.always {
         // regardless of whether the promise is fulfilled, or rejected
     }.catch { errorType in
...
# **listInboxRulesets**
```swift
    open class func listInboxRulesets( inboxId: UUID,  page: Int? = nil,  searchFilter: String? = nil,  size: Int? = nil,  sort: Sort_listInboxRulesets? = nil) -> Promise<PageInboxRulesetDto>
```
...
// List inbox rulesets
InboxControllerAPI.listInboxRulesets(inboxId: inboxId, page: page, searchFilter: searchFilter, size: size, sort: sort).then {
         // when the promise is fulfilled
     }.always {
         // regardless of whether the promise is fulfilled, or rejected
     }.catch { errorType in
...
```swift
    open class func listInboxTrackingPixels( inboxId: UUID,  page: Int? = nil,  searchFilter: String? = nil,  size: Int? = nil,  sort: Sort_listInboxTrackingPixels? = nil) -> Promise<PageTrackingPixelProjection>
```
...
// List inbox tracking pixels
InboxControllerAPI.listInboxTrackingPixels(inboxId: inboxId, page: page, searchFilter: searchFilter, size: size, sort: sort).then {
         // when the promise is fulfilled
     }.always {
         // regardless of whether the promise is fulfilled, or rejected
     }.catch { errorType in
