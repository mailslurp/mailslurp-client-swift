...
let _description = "_description_example" // String | Optional description for an inbox. (optional)
...
// Create an Inbox (email address)
InboxControllerAPI.createInbox(_description: _description, emailAddress: emailAddress, expiresAt: expiresAt, favourite: favourite, name: name, tags: tags) { (response, error) in
...
------------- | ------------- | ------------- | -------------
 **_description** | **String** | Optional description for an inbox. | [optional] 
...
let createInboxDto = CreateInboxDto(_description: "_description_example", emailAddress: "emailAddress_example", expiresAt: Date(), favourite: false, name: "name_example", tags: ["tags_example"]) // CreateInboxDto | createInboxDto
