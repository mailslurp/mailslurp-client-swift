...
# **getAttachments**
```swift
    open class func getAttachments( page: Int? = nil,  size: Int? = nil,  sort: Sort_getAttachments? = nil,  fileNameFilter: String? = nil,  since: Date? = nil,  before: Date? = nil,  inboxId: UUID? = nil,  emailId: UUID? = nil,  sentEmailId: UUID? = nil) -> Promise<PageAttachmentEntity>
```
...
// Get email attachments
AttachmentControllerAPI.getAttachments(page: page, size: size, sort: sort, fileNameFilter: fileNameFilter, since: since, before: before, inboxId: inboxId, emailId: emailId, sentEmailId: sentEmailId).then {
         // when the promise is fulfilled
     }.always {
         // regardless of whether the promise is fulfilled, or rejected
     }.catch { errorType in
