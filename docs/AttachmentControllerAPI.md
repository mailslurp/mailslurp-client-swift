...
# **getAttachments1**
```swift
    open class func getAttachments1( page: Int? = nil,  size: Int? = nil,  sort: Sort_getAttachments1? = nil,  fileNameFilter: String? = nil,  since: Date? = nil,  before: Date? = nil) -> Promise<PageAttachmentEntity>
```
...
// Get email attachments
AttachmentControllerAPI.getAttachments1(page: page, size: size, sort: sort, fileNameFilter: fileNameFilter, since: since, before: before).then {
         // when the promise is fulfilled
     }.always {
         // regardless of whether the promise is fulfilled, or rejected
     }.catch { errorType in
...
```swift
    open class func uploadAttachmentBytes( requestBody: [Data],  contentType: String? = nil,  filename: String? = nil) -> Promise<[String]>
```
...
// Upload an attachment for sending using file byte stream input octet stream. Returns an array whose first element is the ID of the uploaded attachment.
AttachmentControllerAPI.uploadAttachmentBytes(requestBody: requestBody, contentType: contentType, filename: filename).then {
         // when the promise is fulfilled
     }.always {
         // regardless of whether the promise is fulfilled, or rejected
     }.catch { errorType in
