...
let testInboxRulesetReceivingOptions = TestInboxRulesetReceivingOptions(inboxId: 123, fromSender: "fromSender_example") // TestInboxRulesetReceivingOptions | 

// Test receiving with inbox rulesets
InboxRulesetControllerAPI.testInboxRulesetReceiving(testInboxRulesetReceivingOptions: testInboxRulesetReceivingOptions).then {
         // when the promise is fulfilled
     }.always {
         // regardless of whether the promise is fulfilled, or rejected
     }.catch { errorType in
...
let testInboxRulesetSendingOptions = TestInboxRulesetSendingOptions(inboxId: 123, recipient: "recipient_example") // TestInboxRulesetSendingOptions | 

// Test sending with inbox rulesets
InboxRulesetControllerAPI.testInboxRulesetSending(testInboxRulesetSendingOptions: testInboxRulesetSendingOptions).then {
         // when the promise is fulfilled
     }.always {
         // regardless of whether the promise is fulfilled, or rejected
     }.catch { errorType in
