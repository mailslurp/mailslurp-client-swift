...
let emailId = 987 // UUID | ID of email
let forwardEmailOptions = ForwardEmailOptions(bcc: ["bcc_example"], cc: ["cc_example"], from: "from_example", subject: "subject_example", to: ["to_example"]) // ForwardEmailOptions | forwardEmailOptions
