...
let emailId = 987 // UUID | emailId
let replyToEmailOptions = ReplyToEmailOptions(attachments: ["attachments_example"], body: "body_example", charset: "charset_example", isHTML: false, replyTo: "replyTo_example", sendStrategy: "sendStrategy_example", template: 123, templateVariables: 123) // ReplyToEmailOptions | replyToEmailOptions
