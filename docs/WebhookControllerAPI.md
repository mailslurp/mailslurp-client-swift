...
```swift
    open class func createAccountWebhook(createWebhookOptions: CreateWebhookOptions, completion: @escaping (_ data: WebhookDto?, _ error: Error?) -> Void)
```
...
// Attach a WebHook URL to an inbox
WebhookControllerAPI.createAccountWebhook(createWebhookOptions: createWebhookOptions) { (response, error) in
...
# **createWebhook**
```swift
    open class func createWebhook(inboxId: UUID, createWebhookOptions: CreateWebhookOptions, completion: @escaping (_ data: WebhookDto?, _ error: Error?) -> Void)
```
...
// Attach a WebHook URL to an inbox
WebhookControllerAPI.createWebhook(inboxId: inboxId, createWebhookOptions: createWebhookOptions) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **deleteAllWebhooks**
```swift
    open class func deleteAllWebhooks(completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
// Delete all webhooks
WebhookControllerAPI.deleteAllWebhooks() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **deleteWebhookById**
```swift
    open class func deleteWebhookById(webhookId: UUID, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
// Delete a webhook
WebhookControllerAPI.deleteWebhookById(webhookId: webhookId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getAllWebhookResults(page: Int? = nil, size: Int? = nil, sort: Sort_getAllWebhookResults? = nil, searchFilter: String? = nil, since: Date? = nil, before: Date? = nil, unseenOnly: Bool? = nil, completion: @escaping (_ data: PageWebhookResult?, _ error: Error?) -> Void)
```
...
// Get results for all webhooks
WebhookControllerAPI.getAllWebhookResults(page: page, size: size, sort: sort, searchFilter: searchFilter, since: since, before: before, unseenOnly: unseenOnly) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **getAllWebhooks**
```swift
    open class func getAllWebhooks(page: Int? = nil, size: Int? = nil, sort: Sort_getAllWebhooks? = nil, searchFilter: String? = nil, since: Date? = nil, before: Date? = nil, completion: @escaping (_ data: PageWebhookProjection?, _ error: Error?) -> Void)
```
...
// List Webhooks Paginated
WebhookControllerAPI.getAllWebhooks(page: page, size: size, sort: sort, searchFilter: searchFilter, since: since, before: before) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getInboxWebhooksPaginated(inboxId: UUID, page: Int? = nil, size: Int? = nil, sort: Sort_getInboxWebhooksPaginated? = nil, searchFilter: String? = nil, since: Date? = nil, before: Date? = nil, completion: @escaping (_ data: PageWebhookProjection?, _ error: Error?) -> Void)
```
...
// Get paginated webhooks for an Inbox
WebhookControllerAPI.getInboxWebhooksPaginated(inboxId: inboxId, page: page, size: size, sort: sort, searchFilter: searchFilter, since: since, before: before) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getJsonSchemaForWebhookEvent(event: Event_getJsonSchemaForWebhookEvent, completion: @escaping (_ data: JSONSchemaDto?, _ error: Error?) -> Void)
```
...
WebhookControllerAPI.getJsonSchemaForWebhookEvent(event: event) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getJsonSchemaForWebhookPayload(webhookId: UUID, completion: @escaping (_ data: JSONSchemaDto?, _ error: Error?) -> Void)
```
...
WebhookControllerAPI.getJsonSchemaForWebhookPayload(webhookId: webhookId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getTestWebhookPayloadBounce(completion: @escaping (_ data: WebhookBouncePayload?, _ error: Error?) -> Void)
```
...
WebhookControllerAPI.getTestWebhookPayloadBounce() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getTestWebhookPayloadBounceRecipient(completion: @escaping (_ data: WebhookBounceRecipientPayload?, _ error: Error?) -> Void)
```
...
WebhookControllerAPI.getTestWebhookPayloadBounceRecipient() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getTestWebhookPayloadEmailOpened(completion: @escaping (_ data: WebhookEmailOpenedPayload?, _ error: Error?) -> Void)
```
...
WebhookControllerAPI.getTestWebhookPayloadEmailOpened() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getTestWebhookPayloadEmailRead(completion: @escaping (_ data: WebhookEmailReadPayload?, _ error: Error?) -> Void)
```
...
WebhookControllerAPI.getTestWebhookPayloadEmailRead() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getTestWebhookPayloadForWebhook(webhookId: UUID, completion: @escaping (_ data: AbstractWebhookPayload?, _ error: Error?) -> Void)
```
...
WebhookControllerAPI.getTestWebhookPayloadForWebhook(webhookId: webhookId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getTestWebhookPayloadNewAttachment(completion: @escaping (_ data: WebhookNewAttachmentPayload?, _ error: Error?) -> Void)
```
...
// Get webhook test payload for new attachment event
WebhookControllerAPI.getTestWebhookPayloadNewAttachment() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getTestWebhookPayloadNewContact(completion: @escaping (_ data: WebhookNewContactPayload?, _ error: Error?) -> Void)
```
...
// Get webhook test payload for new contact event
WebhookControllerAPI.getTestWebhookPayloadNewContact() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getTestWebhookPayloadNewEmail(completion: @escaping (_ data: WebhookNewEmailPayload?, _ error: Error?) -> Void)
```
...
// Get webhook test payload for new email event
WebhookControllerAPI.getTestWebhookPayloadNewEmail() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **getWebhookResult**
```swift
    open class func getWebhookResult(webhookResultId: UUID, completion: @escaping (_ data: WebhookResultDto?, _ error: Error?) -> Void)
```
...
// Get a webhook result for a webhook
WebhookControllerAPI.getWebhookResult(webhookResultId: webhookResultId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **getWebhookResults**
```swift
    open class func getWebhookResults(webhookId: UUID, page: Int? = nil, size: Int? = nil, sort: Sort_getWebhookResults? = nil, searchFilter: String? = nil, since: Date? = nil, before: Date? = nil, unseenOnly: Bool? = nil, completion: @escaping (_ data: PageWebhookResult?, _ error: Error?) -> Void)
```
...
// Get a webhook results for a webhook
WebhookControllerAPI.getWebhookResults(webhookId: webhookId, page: page, size: size, sort: sort, searchFilter: searchFilter, since: since, before: before, unseenOnly: unseenOnly) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getWebhookResultsUnseenErrorCount(completion: @escaping (_ data: UnseenErrorCountDto?, _ error: Error?) -> Void)
```
...
// Get count of unseen webhook results with error status
WebhookControllerAPI.getWebhookResultsUnseenErrorCount() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func redriveWebhookResult(webhookResultId: UUID, completion: @escaping (_ data: WebhookRedriveResult?, _ error: Error?) -> Void)
```
...
// Get a webhook result and try to resend the original webhook payload
WebhookControllerAPI.redriveWebhookResult(webhookResultId: webhookResultId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func verifyWebhookSignature(verifyWebhookSignatureOptions: VerifyWebhookSignatureOptions, completion: @escaping (_ data: VerifyWebhookSignatureResults?, _ error: Error?) -> Void)
```
...
// Verify a webhook payload signature
WebhookControllerAPI.verifyWebhookSignature(verifyWebhookSignatureOptions: verifyWebhookSignatureOptions) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
