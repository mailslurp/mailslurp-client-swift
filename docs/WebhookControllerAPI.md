...
```swift
    open class func getAllWebhookResults(page: Int? = nil, size: Int? = nil, sort: Sort_getAllWebhookResults? = nil, completion: @escaping (_ data: PageWebhookResult?, _ error: Error?) -> Void)
```
...
// Get results for all webhooks
WebhookControllerAPI.getAllWebhookResults(page: page, size: size, sort: sort) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **getWebhookResult**
```swift
    open class func getWebhookResult(webhookResultId: UUID, completion: @escaping (_ data: WebhookResultEntity?, _ error: Error?) -> Void)
```
...
# **getWebhookResults**
```swift
    open class func getWebhookResults(webhookId: UUID, page: Int? = nil, size: Int? = nil, sort: Sort_getWebhookResults? = nil, completion: @escaping (_ data: PageWebhookResult?, _ error: Error?) -> Void)
```
...
// Get a webhook results for a webhook
WebhookControllerAPI.getWebhookResults(webhookId: webhookId, page: page, size: size, sort: sort) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
