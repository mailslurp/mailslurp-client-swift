...
```swift
    open class func createNewEmailAddress(useDomainPool: Bool, completion: @escaping (_ data: Inbox?, _ error: Error?) -> Void)
```
...
let useDomainPool = true // Bool | useDomainPool

// Create new random inbox
CommonActionsControllerAPI.createNewEmailAddress(useDomainPool: useDomainPool) { (response, error) in
...
```swift
    open class func createNewEmailAddress1(useDomainPool: Bool, completion: @escaping (_ data: Inbox?, _ error: Error?) -> Void)
```
...
// Create new random inbox
CommonActionsControllerAPI.createNewEmailAddress1(useDomainPool: useDomainPool) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
