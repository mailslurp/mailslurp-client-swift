...
@objcMembers open class AttachmentControllerAPI : NSObject {
     ...
     */
    open class func getAttachmentWithRequestBuilder(attachmentId: String) -> RequestBuilder<AttachmentEntityDto> {
        var localVariablePath = "/attachments/{attachmentId}"
        let attachmentIdPreEscape = "\(APIHelper.mapValueToPathItem(attachmentId))"
        let attachmentIdPostEscape = attachmentIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{attachmentId}", with: attachmentIdPostEscape, options: .literal, range: nil)
        ...
        let localVariableRequestBuilder: RequestBuilder<AttachmentEntityDto>.Type = mailslurpAPI.requestBuilderFactory.getBuilder()
    ...
    open class func getAttachments( page: Int? = nil,  size: Int? = nil,  sort: Sort_getAttachments? = nil,  fileNameFilter: String? = nil,  since: Date? = nil,  before: Date? = nil,  inboxId: UUID? = nil,  emailId: UUID? = nil,  sentEmailId: UUID? = nil) -> Promise<PageAttachmentEntity> {
        ...
        getAttachmentsWithRequestBuilder(page: page, size: size, sort: sort, fileNameFilter: fileNameFilter, since: since, before: before, inboxId: inboxId, emailId: emailId, sentEmailId: sentEmailId).execute { result in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body)
            case let .failure(error):
     ...
     */
    open class func getAttachmentsWithRequestBuilder(page: Int? = nil, size: Int? = nil, sort: Sort_getAttachments? = nil, fileNameFilter: String? = nil, since: Date? = nil, before: Date? = nil, inboxId: UUID? = nil, emailId: UUID? = nil, sentEmailId: UUID? = nil) -> RequestBuilder<PageAttachmentEntity> {
        let localVariablePath = "/attachments"
        let localVariableURLString = mailslurpAPI.basePath + localVariablePath
        let localVariableParameters: [String: Any]? = nil
        ...
        localVariableUrlComponents?.queryItems = APIHelper.mapValuesToQueryItems([
            ...
            "sentEmailId": (wrappedValue: sentEmailId?.encodeToJSON(), isExplode: true),
        ])
    ...
    open class func uploadAttachmentBytes( contentType: String? = nil,  contentType2: String? = nil,  contentId: String? = nil,  filename: String? = nil,  fileSize: Int64? = nil,  filename2: String? = nil) -> Promise<[String]> {
        let deferred = Promise<[String]>.pending()
        uploadAttachmentBytesWithRequestBuilder(contentType: contentType, contentType2: contentType2, contentId: contentId, filename: filename, fileSize: fileSize, filename2: filename2).execute { result in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body)
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<[String]> 
     */
    open class func uploadAttachmentBytesWithRequestBuilder(contentType: String? = nil, contentType2: String? = nil, contentId: String? = nil, filename: String? = nil, fileSize: Int64? = nil, filename2: String? = nil) -> RequestBuilder<[String]> {
        ...
        localVariableUrlComponents?.queryItems = APIHelper.mapValuesToQueryItems([
            ...
            "fileSize": (wrappedValue: fileSize?.encodeToJSON(), isExplode: true),
        ])
    ...
    open class func uploadMultipartForm( contentId: String? = nil,  contentType: String? = nil,  filename: String? = nil,  contentTypeHeader: String? = nil,  xFilename: String? = nil,  xFilenameRaw: String? = nil,  xFilesize: Int64? = nil,  uploadMultipartFormRequest: UploadMultipartFormRequest? = nil) -> Promise<[String]> {
        let deferred = Promise<[String]>.pending()
        uploadMultipartFormWithRequestBuilder(contentId: contentId, contentType: contentType, filename: filename, contentTypeHeader: contentTypeHeader, xFilename: xFilename, xFilenameRaw: xFilenameRaw, xFilesize: xFilesize, uploadMultipartFormRequest: uploadMultipartFormRequest).execute { result in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body)
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<[String]> 
     */
    open class func uploadMultipartFormWithRequestBuilder(contentId: String? = nil, contentType: String? = nil, filename: String? = nil, contentTypeHeader: String? = nil, xFilename: String? = nil, xFilenameRaw: String? = nil, xFilesize: Int64? = nil, uploadMultipartFormRequest: UploadMultipartFormRequest? = nil) -> RequestBuilder<[String]> {
        ...
        localVariableUrlComponents?.queryItems = APIHelper.mapValuesToQueryItems([
            ...
            "filename": (wrappedValue: filename?.encodeToJSON(), isExplode: true),
            "contentTypeHeader": (wrappedValue: contentTypeHeader?.encodeToJSON(), isExplode: true),
            "x-filename": (wrappedValue: xFilename?.encodeToJSON(), isExplode: true),
            "x-filename-raw": (wrappedValue: xFilenameRaw?.encodeToJSON(), isExplode: true),
            "x-filesize": (wrappedValue: xFilesize?.encodeToJSON(), isExplode: true),
        ])
