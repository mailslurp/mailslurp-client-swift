...
@objc open class AttachmentControllerAPI : NSObject {
    ...
    open class func getAttachments( page: Int? = nil,  size: Int? = nil,  sort: Sort_getAttachments? = nil,  fileNameFilter: String? = nil,  since: Date? = nil,  before: Date? = nil) -> Promise<PageAttachmentEntity> {
        ...
        getAttachmentsWithRequestBuilder(page: page, size: size, sort: sort, fileNameFilter: fileNameFilter, since: since, before: before).execute { result in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body)
            case let .failure(error):
    ...
    /**
     ...
     - parameter uploadAttachmentBytesRequest: (body)  
    ...
    open class func uploadAttachmentBytes( uploadAttachmentBytesRequest: UploadAttachmentBytesRequest,  contentType: String? = nil,  filename: String? = nil) -> Promise<[String]> {
        let deferred = Promise<[String]>.pending()
        uploadAttachmentBytesWithRequestBuilder(uploadAttachmentBytesRequest: uploadAttachmentBytesRequest, contentType: contentType, filename: filename).execute { result in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body)
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<[String]> 
     */
    open class func uploadAttachmentBytesWithRequestBuilder(uploadAttachmentBytesRequest: UploadAttachmentBytesRequest, contentType: String? = nil, filename: String? = nil) -> RequestBuilder<[String]> {
        let localVariablePath = "/attachments/bytes"
        let localVariableURLString = mailslurpAPI.basePath + localVariablePath
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: uploadAttachmentBytesRequest)
    ...
    open class func uploadMultipartForm( contentType: String? = nil,  filename: String? = nil,  xFilename: String? = nil,  uploadMultipartFormRequest: UploadMultipartFormRequest? = nil) -> Promise<[String]> {
        let deferred = Promise<[String]>.pending()
        uploadMultipartFormWithRequestBuilder(contentType: contentType, filename: filename, xFilename: xFilename, uploadMultipartFormRequest: uploadMultipartFormRequest).execute { result in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body)
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<[String]> 
     */
    open class func uploadMultipartFormWithRequestBuilder(contentType: String? = nil, filename: String? = nil, xFilename: String? = nil, uploadMultipartFormRequest: UploadMultipartFormRequest? = nil) -> RequestBuilder<[String]> {
