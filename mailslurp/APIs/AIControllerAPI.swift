...
@objcMembers open class AIControllerAPI : NSObject {
     ...
     */
    public enum Sort_createTransformer: String, Sendable, CaseIterable {
        case asc = "ASC"
        case desc = "DESC"
    }
     ...
     */
    open class func createTransformer(options: AITranformCreateOptions, page: Int? = nil, size: Int? = nil, sort: Sort_createTransformer? = nil, apiConfiguration: mailslurpAPIConfiguration = mailslurpAPIConfiguration.shared) -> Promise<PageAITransformProjection> {
        let deferred = Promise<PageAITransformProjection>.pending()
        createTransformerWithRequestBuilder(options: options, page: page, size: size, sort: sort, apiConfiguration: apiConfiguration).execute { result in
            switch result {
     ...
     */
    open class func createTransformerWithRequestBuilder(options: AITranformCreateOptions, page: Int? = nil, size: Int? = nil, sort: Sort_createTransformer? = nil, apiConfiguration: mailslurpAPIConfiguration = mailslurpAPIConfiguration.shared) -> RequestBuilder<PageAITransformProjection> {
        ...
        localVariableUrlComponents?.queryItems = APIHelper.mapValuesToQueryItems([
            ...
            "options": (wrappedValue: options.asParameter(codableHelper: apiConfiguration.codableHelper), isExplode: true),
        ])
     ...
     */
    open class func createTransformer1(aITranformCreateOptions: AITranformCreateOptions, apiConfiguration: mailslurpAPIConfiguration = mailslurpAPIConfiguration.shared) -> Promise<AITransformDto> {
        let deferred = Promise<AITransformDto>.pending()
        createTransformer1WithRequestBuilder(aITranformCreateOptions: aITranformCreateOptions, apiConfiguration: apiConfiguration).execute { result in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body)
            case let .failure(error):
     ...
     */
    open class func createTransformer1WithRequestBuilder(aITranformCreateOptions: AITranformCreateOptions, apiConfiguration: mailslurpAPIConfiguration = mailslurpAPIConfiguration.shared) -> RequestBuilder<AITransformDto> {
        let localVariablePath = "/ai/transformer"
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: aITranformCreateOptions, codableHelper: apiConfiguration.codableHelper)
