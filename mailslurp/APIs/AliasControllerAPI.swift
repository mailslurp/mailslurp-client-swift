...
@objcMembers open class AliasControllerAPI : NSObject {
     ...
     */
    open class func getAliasThreadsWithRequestBuilder(aliasId: UUID, page: Int? = nil, size: Int? = nil, sort: Sort_getAliasThreads? = nil, since: Date? = nil, before: Date? = nil) -> RequestBuilder<PageAliasThreadProjection> {
        ...
        let localVariableRequestBuilder: RequestBuilder<PageAliasThreadProjection>.Type = mailslurpAPI.requestBuilderFactory.getBuilder()
     ...
     */
    open class func getThreadWithRequestBuilder(threadId: UUID) -> RequestBuilder<AliasThreadProjection> {
        ...
        let localVariableRequestBuilder: RequestBuilder<AliasThreadProjection>.Type = mailslurpAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - returns: RequestBuilder<PageAliasThreadProjection> 
     */
    open class func getThreadsPaginatedWithRequestBuilder(page: Int? = nil, size: Int? = nil, sort: Sort_getThreadsPaginated? = nil, since: Date? = nil, before: Date? = nil) -> RequestBuilder<PageAliasThreadProjection> {
