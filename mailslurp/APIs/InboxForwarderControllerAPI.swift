...
open class InboxForwarderControllerAPI {
    /**
    ...
    /**
     ...
     - parameter id: (path) ID of inbox forwarder 
     - parameter apiResponseQueue: The queue on which api response is dispatched.
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func deleteInboxForwarder(id: UUID, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) {
        deleteInboxForwarderWithRequestBuilder(id: id).execute(apiResponseQueue) { result -> Void in
            switch result {
            case .success:
                completion((), nil)
            case let .failure(error):
     ...
     */
    open class func deleteInboxForwarderWithRequestBuilder(id: UUID) -> RequestBuilder<Void> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getInboxForwarder(id: UUID, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue, completion: @escaping ((_ data: InboxForwarderDto?, _ error: Error?) -> Void)) {
        getInboxForwarderWithRequestBuilder(id: id).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<InboxForwarderDto> 
     */
    open class func getInboxForwarderWithRequestBuilder(id: UUID) -> RequestBuilder<InboxForwarderDto> {
        var path = "/forwarders/{id}"
        let idPreEscape = "\(APIHelper.mapValueToPathItem(id))"
        let idPostEscape = idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{id}", with: idPostEscape, options: .literal, range: nil)
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func testInboxForwarder(id: UUID, inboxForwarderTestOptions: InboxForwarderTestOptions, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue, completion: @escaping ((_ data: InboxForwarderTestResult?, _ error: Error?) -> Void)) {
        testInboxForwarderWithRequestBuilder(id: id, inboxForwarderTestOptions: inboxForwarderTestOptions).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
     ...
     */
    open class func testInboxForwarderWithRequestBuilder(id: UUID, inboxForwarderTestOptions: InboxForwarderTestOptions) -> RequestBuilder<InboxForwarderTestResult> {
