...
@objc open class InboxForwarderControllerAPI : NSObject {
    ...
    open class func getAllInboxForwarderEvents( page: Int? = nil,  size: Int? = nil,  sort: Sort_getAllInboxForwarderEvents? = nil) -> Promise<PageInboxForwarderEvents> {
        ...
        getAllInboxForwarderEventsWithRequestBuilder(page: page, size: size, sort: sort).execute { result in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body)
            case let .failure(error):
     ...
     */
    open class func getAllInboxForwarderEventsWithRequestBuilder(page: Int? = nil, size: Int? = nil, sort: Sort_getAllInboxForwarderEvents? = nil) -> RequestBuilder<PageInboxForwarderEvents> {
