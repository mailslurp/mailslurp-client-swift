...
@objcMembers open class InboxForwarderControllerAPI : NSObject {
    ...
    open class func createNewInboxForwarder( createInboxForwarderOptions: CreateInboxForwarderOptions,  inboxId: UUID? = nil) -> Promise<InboxForwarderDto> {
        ...
        createNewInboxForwarderWithRequestBuilder(createInboxForwarderOptions: createInboxForwarderOptions, inboxId: inboxId).execute { result in
            switch result {
    ...
    open class func getAllInboxForwarderEvents( page: Int? = nil,  size: Int? = nil,  inboxId: UUID? = nil,  emailId: UUID? = nil,  sentId: UUID? = nil,  sort: Sort_getAllInboxForwarderEvents? = nil) -> Promise<PageInboxForwarderEvents> {
        ...
        getAllInboxForwarderEventsWithRequestBuilder(page: page, size: size, inboxId: inboxId, emailId: emailId, sentId: sentId, sort: sort).execute { result in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body)
            case let .failure(error):
     ...
     */
    open class func getAllInboxForwarderEventsWithRequestBuilder(page: Int? = nil, size: Int? = nil, inboxId: UUID? = nil, emailId: UUID? = nil, sentId: UUID? = nil, sort: Sort_getAllInboxForwarderEvents? = nil) -> RequestBuilder<PageInboxForwarderEvents> {
