...
@objc open class InboxRulesetControllerAPI : NSObject {
     ...
     */
    open class func createNewInboxRuleset( inboxId: UUID,  createInboxRulesetOptions: CreateInboxRulesetOptions, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<InboxRulesetDto> {
     ...
     */
    open class func getInboxRulesets( inboxId: UUID? = nil,  page: Int? = nil,  size: Int? = nil,  sort: Sort_getInboxRulesets? = nil,  searchFilter: String? = nil,  since: Date? = nil,  before: Date? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<PageInboxRulesetDto> {
