...
@objc open class SentEmailsControllerAPI : NSObject {
     ...
     */
    open class func getSentDeliveryStatus( deliveryId: UUID, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<DeliveryStatus> {
        let deferred = Promise<DeliveryStatus>.pending()
    ...
    /**
     ...
     - API Key:
       ...
       - name: API_KEY
     - parameter deliveryId: (path)  
     - returns: RequestBuilder<DeliveryStatus> 
     */
    open class func getSentDeliveryStatusWithRequestBuilder(deliveryId: UUID) -> RequestBuilder<DeliveryStatus> {
        ...
        let requestBuilder: RequestBuilder<DeliveryStatus>.Type = mailslurpAPI.requestBuilderFactory.getBuilder()
