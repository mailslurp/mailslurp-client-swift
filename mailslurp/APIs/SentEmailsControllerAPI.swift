...
@objc open class SentEmailsControllerAPI : NSObject {
     ...
     */
    open class func getSentDeliveryStatus( deliveryId: UUID, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<DeliveryStatusDto> {
        let deferred = Promise<DeliveryStatusDto>.pending()
        getSentDeliveryStatusWithRequestBuilder(deliveryId: deliveryId).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body!)
            case let .failure(error):
    ...
    open class func getSentDeliveryStatusWithRequestBuilder(deliveryId: UUID) -> RequestBuilder<DeliveryStatusDto> {
        var path = "/sent/delivery-status/{deliveryId}"
        ...
        path = path.replacingOccurrences(of: "{deliveryId}", with: deliveryIdPostEscape, options: .literal, range: nil)
        let URLString = mailslurpAPI.basePath + path
        let parameters: [String: Any]? = nil
        ...
        let requestBuilder: RequestBuilder<DeliveryStatusDto>.Type = mailslurpAPI.requestBuilderFactory.getBuilder()
     ...
     */
    open class func getSentDeliveryStatuses( page: Int? = nil,  size: Int? = nil,  sort: Sort_getSentDeliveryStatuses? = nil,  since: Date? = nil,  before: Date? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<PageDeliveryStatus> {
        let deferred = Promise<PageDeliveryStatus>.pending()
        getSentDeliveryStatusesWithRequestBuilder(page: page, size: size, sort: sort, since: since, before: before).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body!)
            case let .failure(error):
    ...
    /**
     ...
     - returns: Promise<PageDeliveryStatus>
     */
    open class func getSentDeliveryStatusesBySentId( sentId: UUID,  page: Int? = nil,  size: Int? = nil,  sort: Sort_getSentDeliveryStatusesBySentId? = nil,  since: Date? = nil,  before: Date? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<PageDeliveryStatus> {
        let deferred = Promise<PageDeliveryStatus>.pending()
        getSentDeliveryStatusesBySentIdWithRequestBuilder(sentId: sentId, page: page, size: size, sort: sort, since: since, before: before).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body!)
            case let .failure(error):
    ...
    open class func getSentDeliveryStatusesBySentIdWithRequestBuilder(sentId: UUID, page: Int? = nil, size: Int? = nil, sort: Sort_getSentDeliveryStatusesBySentId? = nil, since: Date? = nil, before: Date? = nil) -> RequestBuilder<PageDeliveryStatus> {
        var path = "/sent/{sentId}/delivery-status"
        ...
        path = path.replacingOccurrences(of: "{sentId}", with: sentIdPostEscape, options: .literal, range: nil)
        let URLString = mailslurpAPI.basePath + path
        let parameters: [String: Any]? = nil
     ...
     */
    open class func getSentEmailsWithQueueResults( page: Int? = nil,  size: Int? = nil,  sort: Sort_getSentEmailsWithQueueResults? = nil,  since: Date? = nil,  before: Date? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<PageSentEmailWithQueueProjection> {
    ...
    /**
     ...
     - returns: Promise<DeliveryStatusDto>
     */
    open class func waitForDeliveryStatuses( sentId: UUID? = nil,  inboxId: UUID? = nil,  timeout: Int64? = nil,  index: Int? = nil,  since: Date? = nil,  before: Date? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<DeliveryStatusDto> {
        let deferred = Promise<DeliveryStatusDto>.pending()
        waitForDeliveryStatusesWithRequestBuilder(sentId: sentId, inboxId: inboxId, timeout: timeout, index: index, since: since, before: before).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body!)
            case let .failure(error):
    ...
    open class func waitForDeliveryStatusesWithRequestBuilder(sentId: UUID? = nil, inboxId: UUID? = nil, timeout: Int64? = nil, index: Int? = nil, since: Date? = nil, before: Date? = nil) -> RequestBuilder<DeliveryStatusDto> {
        let path = "/sent/delivery-status/wait-for"
        let URLString = mailslurpAPI.basePath + path
        let parameters: [String: Any]? = nil

        var urlComponents = URLComponents(string: URLString)
        urlComponents?.queryItems = APIHelper.mapValuesToQueryItems([
            "sentId": sentId?.encodeToJSON(),
            "inboxId": inboxId?.encodeToJSON(),
