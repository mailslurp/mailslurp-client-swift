...
@objcMembers open class WebhookControllerAPI : NSObject {
     ...
     */
    open class func getAllWebhookResultsWithRequestBuilder(page: Int? = nil, size: Int? = nil, sort: Sort_getAllWebhookResults? = nil, searchFilter: String? = nil, since: Date? = nil, before: Date? = nil, unseenOnly: Bool? = nil, resultType: ResultType_getAllWebhookResults? = nil, eventName: EventName_getAllWebhookResults? = nil, minStatusCode: Int? = nil, maxStatusCode: Int? = nil, inboxId: UUID? = nil, smsId: UUID? = nil, attachmentId: UUID? = nil, emailId: UUID? = nil, phoneId: UUID? = nil, apiConfiguration: mailslurpAPIConfiguration = mailslurpAPIConfiguration.shared) -> RequestBuilder<PageWebhookResult> {
    ...
    /**
     ...
     - returns: Promise<PageWebhookProjection>
     */
    open class func getAllWebhooks(page: Int? = nil, size: Int? = nil, sort: Sort_getAllWebhooks? = nil, searchFilter: String? = nil, since: Date? = nil, inboxId: UUID? = nil, phoneId: UUID? = nil, before: Date? = nil, health: Health_getAllWebhooks? = nil, eventType: EventType_getAllWebhooks? = nil, url: String? = nil, apiConfiguration: mailslurpAPIConfiguration = mailslurpAPIConfiguration.shared) -> Promise<PageWebhookProjection> {
        let deferred = Promise<PageWebhookProjection>.pending()
        getAllWebhooksWithRequestBuilder(page: page, size: size, sort: sort, searchFilter: searchFilter, since: since, inboxId: inboxId, phoneId: phoneId, before: before, health: health, eventType: eventType, url: url, apiConfiguration: apiConfiguration).execute { result in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body)
            case let .failure(error):
    ...
    /**
     ...
     - returns: Promise<PageWebhookResult>
     */
    open class func getWebhookResults(webhookId: UUID, page: Int? = nil, size: Int? = nil, sort: Sort_getWebhookResults? = nil, searchFilter: String? = nil, since: Date? = nil, before: Date? = nil, unseenOnly: Bool? = nil, resultType: ResultType_getWebhookResults? = nil, eventName: EventName_getWebhookResults? = nil, minStatusCode: Int? = nil, maxStatusCode: Int? = nil, inboxId: UUID? = nil, smsId: UUID? = nil, attachmentId: UUID? = nil, emailId: UUID? = nil, phoneId: UUID? = nil, apiConfiguration: mailslurpAPIConfiguration = mailslurpAPIConfiguration.shared) -> Promise<PageWebhookResult> {
        let deferred = Promise<PageWebhookResult>.pending()
    ...
    /**
     ...
     - returns: RequestBuilder<PageWebhookResult> 
     */
    open class func getWebhookResultsWithRequestBuilder(webhookId: UUID, page: Int? = nil, size: Int? = nil, sort: Sort_getWebhookResults? = nil, searchFilter: String? = nil, since: Date? = nil, before: Date? = nil, unseenOnly: Bool? = nil, resultType: ResultType_getWebhookResults? = nil, eventName: EventName_getWebhookResults? = nil, minStatusCode: Int? = nil, maxStatusCode: Int? = nil, inboxId: UUID? = nil, smsId: UUID? = nil, attachmentId: UUID? = nil, emailId: UUID? = nil, phoneId: UUID? = nil, apiConfiguration: mailslurpAPIConfiguration = mailslurpAPIConfiguration.shared) -> RequestBuilder<PageWebhookResult> {
    ...
    /**
     ...
     - returns: Promise<WebhookDto>
     */
    open class func updateWebhook(webhookId: UUID, createWebhookOptions: CreateWebhookOptions, inboxId: UUID? = nil, phoneNumberId: UUID? = nil, overrideAuth: Bool? = nil, apiConfiguration: mailslurpAPIConfiguration = mailslurpAPIConfiguration.shared) -> Promise<WebhookDto> {
        let deferred = Promise<WebhookDto>.pending()
        updateWebhookWithRequestBuilder(webhookId: webhookId, createWebhookOptions: createWebhookOptions, inboxId: inboxId, phoneNumberId: phoneNumberId, overrideAuth: overrideAuth, apiConfiguration: apiConfiguration).execute { result in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body)
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<WebhookDto> 
     */
    open class func updateWebhookWithRequestBuilder(webhookId: UUID, createWebhookOptions: CreateWebhookOptions, inboxId: UUID? = nil, phoneNumberId: UUID? = nil, overrideAuth: Bool? = nil, apiConfiguration: mailslurpAPIConfiguration = mailslurpAPIConfiguration.shared) -> RequestBuilder<WebhookDto> {
        var localVariablePath = "/webhooks/{webhookId}"
        let webhookIdPreEscape = "\(APIHelper.mapValueToPathItem(webhookId))"
        let webhookIdPostEscape = webhookIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{webhookId}", with: webhookIdPostEscape, options: .literal, range: nil)
