...
@objc open class WebhookControllerAPI : NSObject {
    ...
    /**
     ...
     - returns: Promise<WebhookDto>
     */
    open class func createWebhookForPhoneNumber( phoneNumberId: UUID,  createWebhookOptions: CreateWebhookOptions, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<WebhookDto> {
        let deferred = Promise<WebhookDto>.pending()
        createWebhookForPhoneNumberWithRequestBuilder(phoneNumberId: phoneNumberId, createWebhookOptions: createWebhookOptions).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body!)
            case let .failure(error):
    ...
    open class func createWebhookForPhoneNumberWithRequestBuilder(phoneNumberId: UUID, createWebhookOptions: CreateWebhookOptions) -> RequestBuilder<WebhookDto> {
        var path = "/phone/numbers/{phoneNumberId}/webhooks"
     ...
     */
    open class func deleteAllWebhooks( before: Date? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<Void> {
        let deferred = Promise<Void>.pending()
        deleteAllWebhooksWithRequestBuilder(before: before).execute(apiResponseQueue) { result -> Void in
            switch result {
            case .success:
     ...
     */
    open class func getAllWebhooks( page: Int? = nil,  size: Int? = nil,  sort: Sort_getAllWebhooks? = nil,  searchFilter: String? = nil,  since: Date? = nil,  inboxId: UUID? = nil,  phoneId: UUID? = nil,  before: Date? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<PageWebhookProjection> {
        let deferred = Promise<PageWebhookProjection>.pending()
        getAllWebhooksWithRequestBuilder(page: page, size: size, sort: sort, searchFilter: searchFilter, since: since, inboxId: inboxId, phoneId: phoneId, before: before).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body!)
            case let .failure(error):
    ...
    /**
     ...
     - returns: Promise<PageWebhookProjection>
     */
    open class func getPhoneNumberWebhooksPaginated( phoneId: UUID,  page: Int? = nil,  size: Int? = nil,  sort: Sort_getPhoneNumberWebhooksPaginated? = nil,  since: Date? = nil,  before: Date? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<PageWebhookProjection> {
        let deferred = Promise<PageWebhookProjection>.pending()
        getPhoneNumberWebhooksPaginatedWithRequestBuilder(phoneId: phoneId, page: page, size: size, sort: sort, since: since, before: before).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body!)
            case let .failure(error):
    ...
    open class func getPhoneNumberWebhooksPaginatedWithRequestBuilder(phoneId: UUID, page: Int? = nil, size: Int? = nil, sort: Sort_getPhoneNumberWebhooksPaginated? = nil, since: Date? = nil, before: Date? = nil) -> RequestBuilder<PageWebhookProjection> {
        var path = "/phone/numbers/{phoneId}/webhooks/paginated"
    ...
    /**
     ...
     - returns: Promise<WebhookDto>
     */
    open class func updateWebhookHeaders( webhookId: UUID,  webhookHeaders: WebhookHeaders, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<WebhookDto> {
        let deferred = Promise<WebhookDto>.pending()
        updateWebhookHeadersWithRequestBuilder(webhookId: webhookId, webhookHeaders: webhookHeaders).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body!)
            case let .failure(error):
    ...
    open class func updateWebhookHeadersWithRequestBuilder(webhookId: UUID, webhookHeaders: WebhookHeaders) -> RequestBuilder<WebhookDto> {
        var path = "/webhooks/{webhookId}/headers"
        let webhookIdPreEscape = "\(APIHelper.mapValueToPathItem(webhookId))"
        let webhookIdPostEscape = webhookIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{webhookId}", with: webhookIdPostEscape, options: .literal, range: nil)
        let URLString = mailslurpAPI.basePath + path
        let parameters = JSONEncodingHelper.encodingParameters(forEncodableObject: webhookHeaders)
