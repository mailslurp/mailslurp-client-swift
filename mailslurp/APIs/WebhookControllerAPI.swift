...
@objcMembers open class WebhookControllerAPI : NSObject {
     ...
     */
    public enum Health_getAllAccountWebhooks: String, CaseIterable {
    ...
    open class func getAllAccountWebhooks( page: Int? = nil,  size: Int? = nil,  sort: Sort_getAllAccountWebhooks? = nil,  since: Date? = nil,  before: Date? = nil,  eventType: EventType_getAllAccountWebhooks? = nil,  health: Health_getAllAccountWebhooks? = nil,  searchFilter: String? = nil) -> Promise<PageWebhookProjection> {
        ...
        getAllAccountWebhooksWithRequestBuilder(page: page, size: size, sort: sort, since: since, before: before, eventType: eventType, health: health, searchFilter: searchFilter).execute { result in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body)
            case let .failure(error):
     ...
     */
    open class func getAllAccountWebhooksWithRequestBuilder(page: Int? = nil, size: Int? = nil, sort: Sort_getAllAccountWebhooks? = nil, since: Date? = nil, before: Date? = nil, eventType: EventType_getAllAccountWebhooks? = nil, health: Health_getAllAccountWebhooks? = nil, searchFilter: String? = nil) -> RequestBuilder<PageWebhookProjection> {
        ...
        localVariableUrlComponents?.queryItems = APIHelper.mapValuesToQueryItems([
            ...
            "health": (wrappedValue: health?.encodeToJSON(), isExplode: true),
     ...
     * enum for parameter sort
     */
    public enum Sort_getAllWebhookEndpoints: String, CaseIterable {
        case asc = "ASC"
        case desc = "DESC"
    }
     ...
     * enum for parameter health
     */
    public enum Health_getAllWebhookEndpoints: String, CaseIterable {
        case healthy = "HEALTHY"
        case unhealthy = "UNHEALTHY"
    }
     ...
     * enum for parameter eventType
     */
    public enum EventType_getAllWebhookEndpoints: String, CaseIterable {
        case emailReceived = "EMAIL_RECEIVED"
        case newEmail = "NEW_EMAIL"
        case newContact = "NEW_CONTACT"
        case newAttachment = "NEW_ATTACHMENT"
    ...
    open class func getAllWebhookEndpoints( page: Int? = nil,  size: Int? = nil,  sort: Sort_getAllWebhookEndpoints? = nil,  searchFilter: String? = nil,  since: Date? = nil,  inboxId: UUID? = nil,  phoneId: UUID? = nil,  before: Date? = nil,  health: Health_getAllWebhookEndpoints? = nil,  eventType: EventType_getAllWebhookEndpoints? = nil) -> Promise<PageWebhookEndpointProjection> {
        ...
        getAllWebhookEndpointsWithRequestBuilder(page: page, size: size, sort: sort, searchFilter: searchFilter, since: since, inboxId: inboxId, phoneId: phoneId, before: before, health: health, eventType: eventType).execute { result in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body)
            case let .failure(error):
    ...
    open class func getAllWebhookEndpointsWithRequestBuilder(page: Int? = nil, size: Int? = nil, sort: Sort_getAllWebhookEndpoints? = nil, searchFilter: String? = nil, since: Date? = nil, inboxId: UUID? = nil, phoneId: UUID? = nil, before: Date? = nil, health: Health_getAllWebhookEndpoints? = nil, eventType: EventType_getAllWebhookEndpoints? = nil) -> RequestBuilder<PageWebhookEndpointProjection> {
        ...
        let localVariableRequestBuilder: RequestBuilder<PageWebhookEndpointProjection>.Type = mailslurpAPI.requestBuilderFactory.getBuilder()
     ...
     * enum for parameter health
     */
    public enum Health_getAllWebhooks: String, CaseIterable {
        case healthy = "HEALTHY"
        case unhealthy = "UNHEALTHY"
    }
     ...
     * enum for parameter eventType
     */
    public enum EventType_getAllWebhooks: String, CaseIterable {
        case emailReceived = "EMAIL_RECEIVED"
        case newEmail = "NEW_EMAIL"
        case newContact = "NEW_CONTACT"
        case newAttachment = "NEW_ATTACHMENT"
    ...
    open class func getAllWebhooks( page: Int? = nil,  size: Int? = nil,  sort: Sort_getAllWebhooks? = nil,  searchFilter: String? = nil,  since: Date? = nil,  inboxId: UUID? = nil,  phoneId: UUID? = nil,  before: Date? = nil,  health: Health_getAllWebhooks? = nil,  eventType: EventType_getAllWebhooks? = nil,  url: String? = nil) -> Promise<PageWebhookProjection> {
        let deferred = Promise<PageWebhookProjection>.pending()
        getAllWebhooksWithRequestBuilder(page: page, size: size, sort: sort, searchFilter: searchFilter, since: since, inboxId: inboxId, phoneId: phoneId, before: before, health: health, eventType: eventType, url: url).execute { result in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body)
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<PageWebhookProjection> 
     */
    open class func getAllWebhooksWithRequestBuilder(page: Int? = nil, size: Int? = nil, sort: Sort_getAllWebhooks? = nil, searchFilter: String? = nil, since: Date? = nil, inboxId: UUID? = nil, phoneId: UUID? = nil, before: Date? = nil, health: Health_getAllWebhooks? = nil, eventType: EventType_getAllWebhooks? = nil, url: String? = nil) -> RequestBuilder<PageWebhookProjection> {
     ...
     * enum for parameter health
     */
    public enum Health_getInboxWebhooksPaginated: String, CaseIterable {
        case healthy = "HEALTHY"
        case unhealthy = "UNHEALTHY"
    }
     ...
     * enum for parameter eventType
     */
    public enum EventType_getInboxWebhooksPaginated: String, CaseIterable {
        case emailReceived = "EMAIL_RECEIVED"
        case newEmail = "NEW_EMAIL"
        case newContact = "NEW_CONTACT"
        case newAttachment = "NEW_ATTACHMENT"
    ...
    open class func getInboxWebhooksPaginated( inboxId: UUID,  page: Int? = nil,  size: Int? = nil,  sort: Sort_getInboxWebhooksPaginated? = nil,  searchFilter: String? = nil,  since: Date? = nil,  before: Date? = nil,  health: Health_getInboxWebhooksPaginated? = nil,  eventType: EventType_getInboxWebhooksPaginated? = nil) -> Promise<PageWebhookProjection> {
        let deferred = Promise<PageWebhookProjection>.pending()
        getInboxWebhooksPaginatedWithRequestBuilder(inboxId: inboxId, page: page, size: size, sort: sort, searchFilter: searchFilter, since: since, before: before, health: health, eventType: eventType).execute { result in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body)
            case let .failure(error):
     ...
     * enum for parameter eventType
     */
    public enum EventType_getPhoneNumberWebhooksPaginated: String, CaseIterable {
        case emailReceived = "EMAIL_RECEIVED"
        case newEmail = "NEW_EMAIL"
        case newContact = "NEW_CONTACT"
        case newAttachment = "NEW_ATTACHMENT"
     ...
     * enum for parameter health
     */
    public enum Health_getPhoneNumberWebhooksPaginated: String, CaseIterable {
        case healthy = "HEALTHY"
        case unhealthy = "UNHEALTHY"
    }
    ...
    open class func getPhoneNumberWebhooksPaginated( phoneId: UUID,  page: Int? = nil,  size: Int? = nil,  sort: Sort_getPhoneNumberWebhooksPaginated? = nil,  since: Date? = nil,  before: Date? = nil,  eventType: EventType_getPhoneNumberWebhooksPaginated? = nil,  searchFilter: String? = nil,  health: Health_getPhoneNumberWebhooksPaginated? = nil) -> Promise<PageWebhookProjection> {
        let deferred = Promise<PageWebhookProjection>.pending()
        getPhoneNumberWebhooksPaginatedWithRequestBuilder(phoneId: phoneId, page: page, size: size, sort: sort, since: since, before: before, eventType: eventType, searchFilter: searchFilter, health: health).execute { result in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body)
            case let .failure(error):
     ...
     * enum for parameter sort
     */
    public enum Sort_getWebhooks: String, CaseIterable {
        case asc = "ASC"
        case desc = "DESC"
    }
    ...
    open class func getWebhooks( inboxId: UUID,  page: Int? = nil,  size: Int? = nil,  sort: Sort_getWebhooks? = nil) -> Promise<[WebhookProjection]> {
        ...
        getWebhooksWithRequestBuilder(inboxId: inboxId, page: page, size: size, sort: sort).execute { result in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body)
            case let .failure(error):
     ...
     */
    @available(*, deprecated, message: "This operation is deprecated.")
    open class func getWebhooksWithRequestBuilder(inboxId: UUID, page: Int? = nil, size: Int? = nil, sort: Sort_getWebhooks? = nil) -> RequestBuilder<[WebhookProjection]> {
        var localVariablePath = "/inboxes/{inboxId}/webhooks"
        let inboxIdPreEscape = "\(APIHelper.mapValueToPathItem(inboxId))"
        let inboxIdPostEscape = inboxIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{inboxId}", with: inboxIdPostEscape, options: .literal, range: nil)
        ...
        let localVariableRequestBuilder: RequestBuilder<[WebhookProjection]>.Type = mailslurpAPI.requestBuilderFactory.getBuilder()
    ...
    open class func updateWebhook( webhookId: UUID,  createWebhookOptions: CreateWebhookOptions,  inboxId: UUID? = nil,  phoneNumberId: UUID? = nil,  overrideAuth: Bool? = nil) -> Promise<WebhookDto> {
        let deferred = Promise<WebhookDto>.pending()
        updateWebhookWithRequestBuilder(webhookId: webhookId, createWebhookOptions: createWebhookOptions, inboxId: inboxId, phoneNumberId: phoneNumberId, overrideAuth: overrideAuth).execute { result in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body)
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<WebhookDto> 
     */
    open class func updateWebhookWithRequestBuilder(webhookId: UUID, createWebhookOptions: CreateWebhookOptions, inboxId: UUID? = nil, phoneNumberId: UUID? = nil, overrideAuth: Bool? = nil) -> RequestBuilder<WebhookDto> {
        var localVariablePath = "/webhooks/{webhookId}"
        let webhookIdPreEscape = "\(APIHelper.mapValueToPathItem(webhookId))"
        let webhookIdPostEscape = webhookIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{webhookId}", with: webhookIdPostEscape, options: .literal, range: nil)
        ...
        localVariableUrlComponents?.queryItems = APIHelper.mapValuesToQueryItems([
            ...
            "overrideAuth": (wrappedValue: overrideAuth?.encodeToJSON(), isExplode: true),
        ])
