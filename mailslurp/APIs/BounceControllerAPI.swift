...
@objcMembers open class BounceControllerAPI : NSObject {
     ...
     * enum for parameter sort
     */
    public enum Sort_getReputationItems: String, CaseIterable {
        case asc = "ASC"
        case desc = "DESC"
    }
    ...
    open class func getReputationItems( page: Int? = nil,  size: Int? = nil,  sort: Sort_getReputationItems? = nil,  since: Date? = nil,  before: Date? = nil) -> Promise<PageReputationItems> {
        ...
        getReputationItemsWithRequestBuilder(page: page, size: size, sort: sort, since: since, before: before).execute { result in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body)
            case let .failure(error):
     ...
     */
    open class func getReputationItemsWithRequestBuilder(page: Int? = nil, size: Int? = nil, sort: Sort_getReputationItems? = nil, since: Date? = nil, before: Date? = nil) -> RequestBuilder<PageReputationItems> {
        ...
        let localVariableRequestBuilder: RequestBuilder<PageReputationItems>.Type = mailslurpAPI.requestBuilderFactory.getBuilder()
