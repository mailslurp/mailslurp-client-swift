...
@objcMembers open class ToolsControllerAPI : NSObject {
    ...
    open class func deleteNewFakeEmailAddress( emailAddress: String) -> Promise<Void> {
        ...
        deleteNewFakeEmailAddressWithRequestBuilder(emailAddress: emailAddress).execute { result in
            switch result {
            case .success:
     ...
     */
    open class func deleteNewFakeEmailAddressWithRequestBuilder(emailAddress: String) -> RequestBuilder<Void> {
        let localVariablePath = "/tools/fake-email"
        let localVariableURLString = mailslurpAPI.basePath + localVariablePath
        let localVariableParameters: [String: Any]? = nil
    ...
    open class func getFakeEmailByEmailAddress( emailAddress: String) -> Promise<FakeEmailResult> {
        ...
        getFakeEmailByEmailAddressWithRequestBuilder(emailAddress: emailAddress).execute { result in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body)
            case let .failure(error):
     ...
     */
    open class func getFakeEmailByEmailAddressWithRequestBuilder(emailAddress: String) -> RequestBuilder<FakeEmailResult> {
    ...
    open class func getFakeEmailRaw( _id: UUID) -> Promise<String> {
        ...
        getFakeEmailRawWithRequestBuilder(_id: _id).execute { result in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body)
            case let .failure(error):
     ...
     */
    open class func getFakeEmailRawWithRequestBuilder(_id: UUID) -> RequestBuilder<String> {
