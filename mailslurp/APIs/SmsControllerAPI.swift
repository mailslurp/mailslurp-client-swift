...
@objcMembers open class SmsControllerAPI : NSObject {
     ...
     */
    open class func getAllSmsMessages(phoneNumber: UUID? = nil, page: Int? = nil, size: Int? = nil, sort: Sort_getAllSmsMessages? = nil, since: Date? = nil, before: Date? = nil, search: String? = nil, favourite: Bool? = nil, apiConfiguration: mailslurpAPIConfiguration = mailslurpAPIConfiguration.shared) -> Promise<PageSmsProjection> {
        let deferred = Promise<PageSmsProjection>.pending()
        getAllSmsMessagesWithRequestBuilder(phoneNumber: phoneNumber, page: page, size: size, sort: sort, since: since, before: before, search: search, favourite: favourite, apiConfiguration: apiConfiguration).execute { result in
            switch result {
