...
@objc open class SmsControllerAPI : NSObject {
     ...
     */
    open class func getSmsMessage( smsId: UUID, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<SmsMessage> {
        let deferred = Promise<SmsMessage>.pending()
