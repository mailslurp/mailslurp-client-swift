...
@objcMembers open class MFAControllerAPI : NSObject {
     ...
     */
    open class func createTotpDeviceForCustom(createTotpDeviceOtpAuthUrlOptions: CreateTotpDeviceOtpAuthUrlOptions, apiConfiguration: mailslurpAPIConfiguration = mailslurpAPIConfiguration.shared) -> Promise<TotpDeviceDto> {
        let deferred = Promise<TotpDeviceDto>.pending()
        createTotpDeviceForCustomWithRequestBuilder(createTotpDeviceOtpAuthUrlOptions: createTotpDeviceOtpAuthUrlOptions, apiConfiguration: apiConfiguration).execute { result in
            switch result {
     ...
     */
    open class func createTotpDeviceForCustomWithRequestBuilder(createTotpDeviceOtpAuthUrlOptions: CreateTotpDeviceOtpAuthUrlOptions, apiConfiguration: mailslurpAPIConfiguration = mailslurpAPIConfiguration.shared) -> RequestBuilder<TotpDeviceDto> {
    ...
    /**
     ...
     - parameter _id: (path)  
     - parameter at: (query)  (optional)
     - parameter apiConfiguration: The configuration for the http request.
     - returns: Promise<TotpDeviceCodeDto>
     */
    open class func getTotpDeviceCode(_id: UUID, at: Date? = nil, apiConfiguration: mailslurpAPIConfiguration = mailslurpAPIConfiguration.shared) -> Promise<TotpDeviceCodeDto> {
        let deferred = Promise<TotpDeviceCodeDto>.pending()
        getTotpDeviceCodeWithRequestBuilder(_id: _id, at: at, apiConfiguration: apiConfiguration).execute { result in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body)
            case let .failure(error):
     ...
     */
    open class func getTotpDeviceCodeWithRequestBuilder(_id: UUID, at: Date? = nil, apiConfiguration: mailslurpAPIConfiguration = mailslurpAPIConfiguration.shared) -> RequestBuilder<TotpDeviceCodeDto> {
