...
@objc open class PhoneControllerAPI : NSObject {
     ...
     */
    open class func getPhoneNumbers( page: Int? = nil,  size: Int? = nil,  sort: Sort_getPhoneNumbers? = nil,  since: Date? = nil,  before: Date? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<PagePhoneNumberProjection> {
    ...
    /**
     ...
     - returns: Promise<Void>
     */
    open class func testPhoneNumberSendSms( phoneNumberId: UUID,  testPhoneNumberOptions: TestPhoneNumberOptions, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<Void> {
        let deferred = Promise<Void>.pending()
        testPhoneNumberSendSmsWithRequestBuilder(phoneNumberId: phoneNumberId, testPhoneNumberOptions: testPhoneNumberOptions).execute(apiResponseQueue) { result -> Void in
            switch result {
            case .success:
                deferred.resolver.fulfill(())
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func testPhoneNumberSendSmsWithRequestBuilder(phoneNumberId: UUID, testPhoneNumberOptions: TestPhoneNumberOptions) -> RequestBuilder<Void> {
