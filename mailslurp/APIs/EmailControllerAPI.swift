...
@objcMembers open class EmailControllerAPI : NSObject {
    ...
    open class func getEmail( emailId: UUID) -> Promise<Email> {
        ...
        getEmailWithRequestBuilder(emailId: emailId).execute { result in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body)
            case let .failure(error):
     ...
     */
    open class func getEmailWithRequestBuilder(emailId: UUID) -> RequestBuilder<Email> {
        var localVariablePath = "/emails/{emailId}"
        let emailIdPreEscape = "\(APIHelper.mapValueToPathItem(emailId))"
        let emailIdPostEscape = emailIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{emailId}", with: emailIdPostEscape, options: .literal, range: nil)
    ...
    open class func getEmailContentPart( emailId: UUID,  contentType: String,  strict: Bool? = nil,  index: Int? = nil) -> Promise<EmailContentPartResult> {
        ...
        getEmailContentPartWithRequestBuilder(emailId: emailId, contentType: contentType, strict: strict, index: index).execute { result in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body)
            case let .failure(error):
     ...
     */
    open class func getEmailContentPartWithRequestBuilder(emailId: UUID, contentType: String, strict: Bool? = nil, index: Int? = nil) -> RequestBuilder<EmailContentPartResult> {
        ...
        localVariableUrlComponents?.queryItems = APIHelper.mapValuesToQueryItems([
            ...
            "strict": (wrappedValue: strict?.encodeToJSON(), isExplode: true),
    ...
    open class func getEmailContentPartContent( emailId: UUID,  contentType: String,  strict: Bool? = nil,  index: Int? = nil) -> Promise<String> {
        let deferred = Promise<String>.pending()
        getEmailContentPartContentWithRequestBuilder(emailId: emailId, contentType: contentType, strict: strict, index: index).execute { result in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body)
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<String> 
     */
    open class func getEmailContentPartContentWithRequestBuilder(emailId: UUID, contentType: String, strict: Bool? = nil, index: Int? = nil) -> RequestBuilder<String> {
    ...
    open class func getEmailHTML( emailId: UUID,  replaceCidImages: Bool? = nil) -> Promise<String> {
        let deferred = Promise<String>.pending()
        getEmailHTMLWithRequestBuilder(emailId: emailId, replaceCidImages: replaceCidImages).execute { result in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body)
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<String> 
     */
    open class func getEmailHTMLWithRequestBuilder(emailId: UUID, replaceCidImages: Bool? = nil) -> RequestBuilder<String> {
    ...
    open class func getEmailHTMLJson( emailId: UUID,  replaceCidImages: Bool? = nil) -> Promise<EmailHtmlDto> {
        ...
        getEmailHTMLJsonWithRequestBuilder(emailId: emailId, replaceCidImages: replaceCidImages).execute { result in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body)
            case let .failure(error):
     ...
     */
    open class func getEmailHTMLJsonWithRequestBuilder(emailId: UUID, replaceCidImages: Bool? = nil) -> RequestBuilder<EmailHtmlDto> {
    ...
    open class func getEmailLinks( emailId: UUID,  selector: String? = nil) -> Promise<EmailLinksResult> {
        ...
        getEmailLinksWithRequestBuilder(emailId: emailId, selector: selector).execute { result in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body)
            case let .failure(error):
     ...
     */
    open class func getEmailLinksWithRequestBuilder(emailId: UUID, selector: String? = nil) -> RequestBuilder<EmailLinksResult> {
        ...
        var localVariableUrlComponents = URLComponents(string: localVariableURLString)
        localVariableUrlComponents?.queryItems = APIHelper.mapValuesToQueryItems([
            "selector": (wrappedValue: selector?.encodeToJSON(), isExplode: true),
        ])
    ...
    open class func getEmailSummary( emailId: UUID,  decode: Bool? = nil) -> Promise<EmailPreview> {
        let deferred = Promise<EmailPreview>.pending()
        getEmailSummaryWithRequestBuilder(emailId: emailId, decode: decode).execute { result in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body)
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<EmailPreview> 
     */
    open class func getEmailSummaryWithRequestBuilder(emailId: UUID, decode: Bool? = nil) -> RequestBuilder<EmailPreview> {
    ...
    open class func getEmailThread( threadId: UUID) -> Promise<EmailThreadDto> {
        ...
        getEmailThreadWithRequestBuilder(threadId: threadId).execute { result in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body)
            case let .failure(error):
     ...
     */
    open class func getEmailThreadWithRequestBuilder(threadId: UUID) -> RequestBuilder<EmailThreadDto> {
        ...
        let localVariableRequestBuilder: RequestBuilder<EmailThreadDto>.Type = mailslurpAPI.requestBuilderFactory.getBuilder()
     ...
     */
    public enum Sort_getEmailThreadItems: String, CaseIterable {
        case asc = "ASC"
        case desc = "DESC"
    }
    ...
    open class func getEmailThreadItems( threadId: UUID,  sort: Sort_getEmailThreadItems? = nil) -> Promise<EmailThreadItemsDto> {
        ...
        getEmailThreadItemsWithRequestBuilder(threadId: threadId, sort: sort).execute { result in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body)
            case let .failure(error):
     ...
     */
    open class func getEmailThreadItemsWithRequestBuilder(threadId: UUID, sort: Sort_getEmailThreadItems? = nil) -> RequestBuilder<EmailThreadItemsDto> {
        ...
        let localVariableRequestBuilder: RequestBuilder<EmailThreadItemsDto>.Type = mailslurpAPI.requestBuilderFactory.getBuilder()
     ...
     * enum for parameter sort
     */
    public enum Sort_getEmailThreads: String, CaseIterable {
        case asc = "ASC"
        case desc = "DESC"
    }
    ...
    open class func getEmailThreads( htmlSelector: UUID? = nil,  page: Int? = nil,  size: Int? = nil,  sort: Sort_getEmailThreads? = nil,  searchFilter: String? = nil,  since: Date? = nil,  before: Date? = nil) -> Promise<PageEmailThreadProjection> {
        ...
        getEmailThreadsWithRequestBuilder(htmlSelector: htmlSelector, page: page, size: size, sort: sort, searchFilter: searchFilter, since: since, before: before).execute { result in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body)
            case let .failure(error):
     ...
     */
    open class func getEmailThreadsWithRequestBuilder(htmlSelector: UUID? = nil, page: Int? = nil, size: Int? = nil, sort: Sort_getEmailThreads? = nil, searchFilter: String? = nil, since: Date? = nil, before: Date? = nil) -> RequestBuilder<PageEmailThreadProjection> {
        ...
        let localVariableRequestBuilder: RequestBuilder<PageEmailThreadProjection>.Type = mailslurpAPI.requestBuilderFactory.getBuilder()
    ...
    open class func getEmailsOffsetPaginated( inboxId: [UUID]? = nil,  page: Int? = nil,  size: Int? = nil,  sort: Sort_getEmailsOffsetPaginated? = nil,  unreadOnly: Bool? = nil,  searchFilter: String? = nil,  since: Date? = nil,  before: Date? = nil,  favourited: Bool? = nil,  syncConnectors: Bool? = nil,  plusAddressId: UUID? = nil) -> Promise<PageEmailProjection> {
        ...
        getEmailsOffsetPaginatedWithRequestBuilder(inboxId: inboxId, page: page, size: size, sort: sort, unreadOnly: unreadOnly, searchFilter: searchFilter, since: since, before: before, favourited: favourited, syncConnectors: syncConnectors, plusAddressId: plusAddressId).execute { result in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body)
            case let .failure(error):
    ...
    open class func getEmailsOffsetPaginatedWithRequestBuilder(inboxId: [UUID]? = nil, page: Int? = nil, size: Int? = nil, sort: Sort_getEmailsOffsetPaginated? = nil, unreadOnly: Bool? = nil, searchFilter: String? = nil, since: Date? = nil, before: Date? = nil, favourited: Bool? = nil, syncConnectors: Bool? = nil, plusAddressId: UUID? = nil) -> RequestBuilder<PageEmailProjection> {
        ...
        localVariableUrlComponents?.queryItems = APIHelper.mapValuesToQueryItems([
            ...
            "plusAddressId": (wrappedValue: plusAddressId?.encodeToJSON(), isExplode: true),
        ])
    ...
    open class func getEmailsPaginated( inboxId: [UUID]? = nil,  page: Int? = nil,  size: Int? = nil,  sort: Sort_getEmailsPaginated? = nil,  unreadOnly: Bool? = nil,  searchFilter: String? = nil,  since: Date? = nil,  before: Date? = nil,  syncConnectors: Bool? = nil,  plusAddressId: UUID? = nil,  favourited: Bool? = nil) -> Promise<PageEmailProjection> {
        let deferred = Promise<PageEmailProjection>.pending()
        getEmailsPaginatedWithRequestBuilder(inboxId: inboxId, page: page, size: size, sort: sort, unreadOnly: unreadOnly, searchFilter: searchFilter, since: since, before: before, syncConnectors: syncConnectors, plusAddressId: plusAddressId, favourited: favourited).execute { result in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body)
            case let .failure(error):
    ...
    open class func getOrganizationEmailsPaginated( inboxId: [UUID]? = nil,  page: Int? = nil,  size: Int? = nil,  sort: Sort_getOrganizationEmailsPaginated? = nil,  unreadOnly: Bool? = nil,  searchFilter: String? = nil,  since: Date? = nil,  before: Date? = nil,  syncConnectors: Bool? = nil,  favourited: Bool? = nil,  plusAddressId: UUID? = nil) -> Promise<PageEmailProjection> {
        let deferred = Promise<PageEmailProjection>.pending()
        getOrganizationEmailsPaginatedWithRequestBuilder(inboxId: inboxId, page: page, size: size, sort: sort, unreadOnly: unreadOnly, searchFilter: searchFilter, since: since, before: before, syncConnectors: syncConnectors, favourited: favourited, plusAddressId: plusAddressId).execute { result in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body)
            case let .failure(error):
    ...
    open class func searchEmails( searchEmailsOptions: SearchEmailsOptions,  syncConnectors: Bool? = nil,  favourited: Bool? = nil,  plusAddressId: UUID? = nil) -> Promise<PageEmailProjection> {
        let deferred = Promise<PageEmailProjection>.pending()
        searchEmailsWithRequestBuilder(searchEmailsOptions: searchEmailsOptions, syncConnectors: syncConnectors, favourited: favourited, plusAddressId: plusAddressId).execute { result in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body)
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<PageEmailProjection> 
     */
    open class func searchEmailsWithRequestBuilder(searchEmailsOptions: SearchEmailsOptions, syncConnectors: Bool? = nil, favourited: Bool? = nil, plusAddressId: UUID? = nil) -> RequestBuilder<PageEmailProjection> {
    ...
    open class func setEmailFavourited( emailId: UUID,  favourited: Bool) -> Promise<Void> {
        let deferred = Promise<Void>.pending()
        setEmailFavouritedWithRequestBuilder(emailId: emailId, favourited: favourited).execute { result in
            switch result {
            case .success:
                deferred.resolver.fulfill(())
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func setEmailFavouritedWithRequestBuilder(emailId: UUID, favourited: Bool) -> RequestBuilder<Void> {
