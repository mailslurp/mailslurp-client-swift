...
open class EmailControllerAPI {
     ...
     */
    open class func applyImapFlagOperation(emailId: UUID, imapFlagOperationOptions: ImapFlagOperationOptions, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue, completion: @escaping ((_ data: EmailPreview?, _ error: Error?) -> Void)) {
        applyImapFlagOperationWithRequestBuilder(emailId: emailId, imapFlagOperationOptions: imapFlagOperationOptions).execute(apiResponseQueue) { result -> Void in
            switch result {
    ...
    open class func applyImapFlagOperationWithRequestBuilder(emailId: UUID, imapFlagOperationOptions: ImapFlagOperationOptions) -> RequestBuilder<EmailPreview> {
        var path = "/emails/{emailId}/imap-flag-operation"
        ...
        let parameters = JSONEncodingHelper.encodingParameters(forEncodableObject: imapFlagOperationOptions)
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func downloadAttachment(emailId: UUID, attachmentId: String, apiKey: String? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue, completion: @escaping ((_ data: Data?, _ error: Error?) -> Void)) {
        downloadAttachmentWithRequestBuilder(emailId: emailId, attachmentId: attachmentId, apiKey: apiKey).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func downloadAttachmentBase64(emailId: UUID, attachmentId: String, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue, completion: @escaping ((_ data: DownloadAttachmentDto?, _ error: Error?) -> Void)) {
        downloadAttachmentBase64WithRequestBuilder(emailId: emailId, attachmentId: attachmentId).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func downloadBody(emailId: UUID, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue, completion: @escaping ((_ data: String?, _ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func downloadBodyBytes(emailId: UUID, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue, completion: @escaping ((_ data: Data?, _ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func forwardEmail(emailId: UUID, forwardEmailOptions: ForwardEmailOptions, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue, completion: @escaping ((_ data: SentEmailDto?, _ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getAttachmentMetaData(emailId: UUID, attachmentId: String, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue, completion: @escaping ((_ data: AttachmentMetaData?, _ error: Error?) -> Void)) {
        getAttachmentMetaDataWithRequestBuilder(emailId: emailId, attachmentId: attachmentId).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getEmailAttachments(emailId: UUID, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue, completion: @escaping ((_ data: [AttachmentMetaData]?, _ error: Error?) -> Void)) {
        getEmailAttachmentsWithRequestBuilder(emailId: emailId).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getEmailCount(apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue, completion: @escaping ((_ data: CountDto?, _ error: Error?) -> Void)) {
        getEmailCountWithRequestBuilder().execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getEmailHTMLJson(emailId: UUID, decode: Bool? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue, completion: @escaping ((_ data: EmailHtmlDto?, _ error: Error?) -> Void)) {
        getEmailHTMLJsonWithRequestBuilder(emailId: emailId, decode: decode).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    open class func getEmailHTMLJsonWithRequestBuilder(emailId: UUID, decode: Bool? = nil) -> RequestBuilder<EmailHtmlDto> {
        var path = "/emails/{emailId}/html/json"
        let emailIdPreEscape = "\(APIHelper.mapValueToPathItem(emailId))"
        let emailIdPostEscape = emailIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{emailId}", with: emailIdPostEscape, options: .literal, range: nil)
        let URLString = mailslurpAPI.basePath + path
        ...
        let requestBuilder: RequestBuilder<EmailHtmlDto>.Type = mailslurpAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getEmailHTMLQuery(emailId: UUID, htmlSelector: String, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue, completion: @escaping ((_ data: EmailTextLinesResult?, _ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getEmailLinks(emailId: UUID, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue, completion: @escaping ((_ data: EmailLinksResult?, _ error: Error?) -> Void)) {
        getEmailLinksWithRequestBuilder(emailId: emailId).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    open class func getEmailLinksWithRequestBuilder(emailId: UUID) -> RequestBuilder<EmailLinksResult> {
        ...
        let requestBuilder: RequestBuilder<EmailLinksResult>.Type = mailslurpAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getEmailPreviewURLs(emailId: UUID, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue, completion: @escaping ((_ data: EmailPreviewUrls?, _ error: Error?) -> Void)) {
        getEmailPreviewURLsWithRequestBuilder(emailId: emailId).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getEmailTextLines(emailId: UUID, decodeHtmlEntities: Bool? = nil, lineSeparator: String? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue, completion: @escaping ((_ data: EmailTextLinesResult?, _ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getEmailsPaginated(inboxId: [UUID]? = nil, page: Int? = nil, size: Int? = nil, sort: Sort_getEmailsPaginated? = nil, unreadOnly: Bool? = nil, searchFilter: String? = nil, since: Date? = nil, before: Date? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue, completion: @escaping ((_ data: PageEmailProjection?, _ error: Error?) -> Void)) {
        getEmailsPaginatedWithRequestBuilder(inboxId: inboxId, page: page, size: size, sort: sort, unreadOnly: unreadOnly, searchFilter: searchFilter, since: since, before: before).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getGravatarUrlForEmailAddress(emailAddress: String, size: String? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue, completion: @escaping ((_ data: GravatarUrl?, _ error: Error?) -> Void)) {
        getGravatarUrlForEmailAddressWithRequestBuilder(emailAddress: emailAddress, size: size).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    open class func getGravatarUrlForEmailAddressWithRequestBuilder(emailAddress: String, size: String? = nil) -> RequestBuilder<GravatarUrl> {
        ...
        let requestBuilder: RequestBuilder<GravatarUrl>.Type = mailslurpAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getLatestEmail(inboxIds: [UUID]? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue, completion: @escaping ((_ data: Email?, _ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getLatestEmailInInbox1(inboxId: UUID, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue, completion: @escaping ((_ data: Email?, _ error: Error?) -> Void)) {
        getLatestEmailInInbox1WithRequestBuilder(inboxId: inboxId).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    open class func getOrganizationEmailsPaginated(inboxId: [UUID]? = nil, page: Int? = nil, size: Int? = nil, sort: Sort_getOrganizationEmailsPaginated? = nil, unreadOnly: Bool? = nil, searchFilter: String? = nil, since: Date? = nil, before: Date? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue, completion: @escaping ((_ data: PageEmailProjection?, _ error: Error?) -> Void)) {
        getOrganizationEmailsPaginatedWithRequestBuilder(inboxId: inboxId, page: page, size: size, sort: sort, unreadOnly: unreadOnly, searchFilter: searchFilter, since: since, before: before).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func markAsRead(emailId: UUID, read: Bool? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue, completion: @escaping ((_ data: EmailPreview?, _ error: Error?) -> Void)) {
        markAsReadWithRequestBuilder(emailId: emailId, read: read).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func sendEmailSourceOptional(inboxId: UUID, sendEmailOptions: SendEmailOptions, useDomainPool: Bool? = nil, virtualSend: Bool? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) {
        sendEmailSourceOptionalWithRequestBuilder(inboxId: inboxId, sendEmailOptions: sendEmailOptions, useDomainPool: useDomainPool, virtualSend: virtualSend).execute(apiResponseQueue) { result -> Void in
            switch result {
            case .success:
                completion((), nil)
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func sendEmailSourceOptionalWithRequestBuilder(inboxId: UUID, sendEmailOptions: SendEmailOptions, useDomainPool: Bool? = nil, virtualSend: Bool? = nil) -> RequestBuilder<Void> {
        var path = "/emails"
        ...
        urlComponents?.queryItems = APIHelper.mapValuesToQueryItems([
            ...
            "virtualSend": virtualSend?.encodeToJSON(),
        ])
