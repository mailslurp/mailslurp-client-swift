...
@objcMembers open class InboxReplierControllerAPI : NSObject {
     ...
     */
    public enum Sort_getAllInboxReplierEvents: String, CaseIterable {
        case asc = "ASC"
        case desc = "DESC"
    }
    ...
    open class func getAllInboxReplierEvents( inboxReplierId: UUID? = nil,  inboxId: UUID? = nil,  emailId: UUID? = nil,  sentId: UUID? = nil,  page: Int? = nil,  size: Int? = nil,  sort: Sort_getAllInboxReplierEvents? = nil) -> Promise<PageInboxReplierEvents> {
        ...
        getAllInboxReplierEventsWithRequestBuilder(inboxReplierId: inboxReplierId, inboxId: inboxId, emailId: emailId, sentId: sentId, page: page, size: size, sort: sort).execute { result in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body)
            case let .failure(error):
     ...
     */
    open class func getAllInboxReplierEventsWithRequestBuilder(inboxReplierId: UUID? = nil, inboxId: UUID? = nil, emailId: UUID? = nil, sentId: UUID? = nil, page: Int? = nil, size: Int? = nil, sort: Sort_getAllInboxReplierEvents? = nil) -> RequestBuilder<PageInboxReplierEvents> {
        ...
        var localVariableUrlComponents = URLComponents(string: localVariableURLString)
        localVariableUrlComponents?.queryItems = APIHelper.mapValuesToQueryItems([
            "inboxReplierId": (wrappedValue: inboxReplierId?.encodeToJSON(), isExplode: true),
            "inboxId": (wrappedValue: inboxId?.encodeToJSON(), isExplode: true),
