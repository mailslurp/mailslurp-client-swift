...
@objc open class CommonActionsControllerAPI : NSObject {
     ...
     */
    open class func createNewEmailAddressWithRequestBuilder(allowTeamAccess: Bool? = nil, useDomainPool: Bool? = nil, expiresAt: Date? = nil, expiresIn: Int64? = nil, emailAddress: String? = nil, inboxType: InboxType_createNewEmailAddress? = nil, _description: String? = nil, name: String? = nil, tags: [String]? = nil, favourite: Bool? = nil, virtualInbox: Bool? = nil, useShortAddress: Bool? = nil, domainName: String? = nil, domainId: UUID? = nil) -> RequestBuilder<InboxDto> {
    ...
    /**
     ...
     - returns: RequestBuilder<InboxDto> 
     */
    open class func createRandomInboxWithRequestBuilder(allowTeamAccess: Bool? = nil, useDomainPool: Bool? = nil, expiresAt: Date? = nil, expiresIn: Int64? = nil, emailAddress: String? = nil, inboxType: InboxType_createRandomInbox? = nil, _description: String? = nil, name: String? = nil, tags: [String]? = nil, favourite: Bool? = nil, virtualInbox: Bool? = nil, useShortAddress: Bool? = nil, domainName: String? = nil, domainId: UUID? = nil) -> RequestBuilder<InboxDto> {
