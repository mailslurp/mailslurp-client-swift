...
@objcMembers open class ExpiredControllerAPI : NSObject {
    ...
    open class func getExpiredInboxes( page: Int? = nil,  size: Int? = nil,  sort: Sort_getExpiredInboxes? = nil,  since: Date? = nil,  before: Date? = nil,  inboxId: UUID? = nil) -> Promise<PageExpiredInboxRecordProjection> {
        ...
        getExpiredInboxesWithRequestBuilder(page: page, size: size, sort: sort, since: since, before: before, inboxId: inboxId).execute { result in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body)
            case let .failure(error):
     ...
     */
    open class func getExpiredInboxesWithRequestBuilder(page: Int? = nil, size: Int? = nil, sort: Sort_getExpiredInboxes? = nil, since: Date? = nil, before: Date? = nil, inboxId: UUID? = nil) -> RequestBuilder<PageExpiredInboxRecordProjection> {
