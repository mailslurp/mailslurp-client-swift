...
@objc open class TemplateControllerAPI : NSObject {
     ...
     */
    open class func getTemplatePreviewHtml( templateId: UUID, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<String> {
     ...
     */
    open class func getTemplatePreviewJson( templateId: UUID, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<TemplatePreview> {
