...
@objc open class WaitForControllerAPI : NSObject {
     ...
     */
    open class func waitFor( waitForConditions: WaitForConditions, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<[EmailPreview]> {
    ...
    /**
     ...
     - returns: Promise<[EmailPreview]>
     */
    open class func waitForEmailCount( inboxId: UUID,  count: Int,  timeout: Int64? = nil,  unreadOnly: Bool? = nil,  before: Date? = nil,  since: Date? = nil,  sort: Sort_waitForEmailCount? = nil,  delay: Int64? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<[EmailPreview]> {
        let deferred = Promise<[EmailPreview]>.pending()
     ...
     */
    open class func waitForLatestEmail( inboxId: UUID? = nil,  timeout: Int64? = nil,  unreadOnly: Bool? = nil,  before: Date? = nil,  since: Date? = nil,  sort: Sort_waitForLatestEmail? = nil,  delay: Int64? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<Email> {
     ...
     */
    open class func waitForLatestSms( waitForSingleSmsOptions: WaitForSingleSmsOptions, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<SmsDto> {
        let deferred = Promise<SmsDto>.pending()
        waitForLatestSmsWithRequestBuilder(waitForSingleSmsOptions: waitForSingleSmsOptions).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body!)
            case let .failure(error):
    ...
    open class func waitForLatestSmsWithRequestBuilder(waitForSingleSmsOptions: WaitForSingleSmsOptions) -> RequestBuilder<SmsDto> {
        let path = "/waitForLatestSms"
        let URLString = mailslurpAPI.basePath + path
        let parameters = JSONEncodingHelper.encodingParameters(forEncodableObject: waitForSingleSmsOptions)
    ...
    /**
     ...
     - returns: Promise<[EmailPreview]>
     */
    open class func waitForMatchingEmails( inboxId: UUID,  count: Int,  matchOptions: MatchOptions,  before: Date? = nil,  since: Date? = nil,  sort: Sort_waitForMatchingEmails? = nil,  delay: Int64? = nil,  timeout: Int64? = nil,  unreadOnly: Bool? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<[EmailPreview]> {
        let deferred = Promise<[EmailPreview]>.pending()
    ...
    /**
     ...
     - returns: Promise<Email>
     */
    open class func waitForMatchingFirstEmail( inboxId: UUID,  matchOptions: MatchOptions,  timeout: Int64? = nil,  unreadOnly: Bool? = nil,  since: Date? = nil,  before: Date? = nil,  sort: Sort_waitForMatchingFirstEmail? = nil,  delay: Int64? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<Email> {
        let deferred = Promise<Email>.pending()
    ...
    /**
     ...
     - returns: Promise<Email>
     */
    open class func waitForNthEmail( inboxId: UUID? = nil,  index: Int? = nil,  timeout: Int64? = nil,  unreadOnly: Bool? = nil,  since: Date? = nil,  before: Date? = nil,  sort: Sort_waitForNthEmail? = nil,  delay: Int64? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<Email> {
        let deferred = Promise<Email>.pending()
     ...
     */
    open class func waitForSms( waitForSmsConditions: WaitForSmsConditions, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<[SmsPreview]> {
