...
@objc open class WebhookControllerAPI : NSObject {
     ...
     */
    open class func getAllWebhookResults( before: Date? = nil,  page: Int? = nil,  searchFilter: String? = nil,  since: Date? = nil,  size: Int? = nil,  sort: Sort_getAllWebhookResults? = nil,  unseenOnly: Bool? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<PageWebhookResult> {
        let deferred = Promise<PageWebhookResult>.pending()
        getAllWebhookResultsWithRequestBuilder(before: before, page: page, searchFilter: searchFilter, since: since, size: size, sort: sort, unseenOnly: unseenOnly).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body!)
            case let .failure(error):
     ...
     */
    open class func getAllWebhookResultsWithRequestBuilder(before: Date? = nil, page: Int? = nil, searchFilter: String? = nil, since: Date? = nil, size: Int? = nil, sort: Sort_getAllWebhookResults? = nil, unseenOnly: Bool? = nil) -> RequestBuilder<PageWebhookResult> {
    ...
    /**
     ...
     - returns: Promise<PageWebhookResult>
     */
    open class func getWebhookResults( webhookId: UUID,  before: Date? = nil,  page: Int? = nil,  searchFilter: String? = nil,  since: Date? = nil,  size: Int? = nil,  sort: Sort_getWebhookResults? = nil,  unseenOnly: Bool? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<PageWebhookResult> {
        let deferred = Promise<PageWebhookResult>.pending()
        getWebhookResultsWithRequestBuilder(webhookId: webhookId, before: before, page: page, searchFilter: searchFilter, since: since, size: size, sort: sort, unseenOnly: unseenOnly).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body!)
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<PageWebhookResult> 
     */
    open class func getWebhookResultsWithRequestBuilder(webhookId: UUID, before: Date? = nil, page: Int? = nil, searchFilter: String? = nil, since: Date? = nil, size: Int? = nil, sort: Sort_getWebhookResults? = nil, unseenOnly: Bool? = nil) -> RequestBuilder<PageWebhookResult> {
