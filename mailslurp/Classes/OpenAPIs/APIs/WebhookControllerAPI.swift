...
@objc open class WebhookControllerAPI : NSObject {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getTestWebhookPayload(apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue, completion: @escaping ((_ data: WebhookPayload?,_ error: Error?) -> Void)) {
        getTestWebhookPayloadWithRequestBuilder().execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - API Key:
       - type: apiKey x-api-key 
       - name: API_KEY
     - returns: RequestBuilder<WebhookPayload> 
     */
    open class func getTestWebhookPayloadWithRequestBuilder() -> RequestBuilder<WebhookPayload> {
        ...
        let requestBuilder: RequestBuilder<WebhookPayload>.Type = mailslurpAPI.requestBuilderFactory.getBuilder()
