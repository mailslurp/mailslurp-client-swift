...
@objc open class AttachmentControllerAPI : NSObject {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getAttachments(fileNameFilter: String? = nil, page: Int? = nil, size: Int? = nil, sort: Sort_getAttachments? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue, completion: @escaping ((_ data: PageAttachmentEntity?,_ error: Error?) -> Void)) {
