...
@objc open class AttachmentControllerAPI : NSObject {
     ...
     */
    open class func getAttachments( before: Date? = nil,  fileNameFilter: String? = nil,  page: Int? = nil,  since: Date? = nil,  size: Int? = nil,  sort: Sort_getAttachments? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<PageAttachmentEntity> {
        let deferred = Promise<PageAttachmentEntity>.pending()
        getAttachmentsWithRequestBuilder(before: before, fileNameFilter: fileNameFilter, page: page, since: since, size: size, sort: sort).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body!)
            case let .failure(error):
     ...
     */
    open class func getAttachmentsWithRequestBuilder(before: Date? = nil, fileNameFilter: String? = nil, page: Int? = nil, since: Date? = nil, size: Int? = nil, sort: Sort_getAttachments? = nil) -> RequestBuilder<PageAttachmentEntity> {
        let path = "/attachments"
        let URLString = mailslurpAPI.basePath + path
        let parameters: [String: Any]? = nil
     ...
     */
    open class func uploadAttachment( uploadOptions: UploadAttachmentOptions, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<[String]> {
    ...
    /**
     ...
     - returns: Promise<[String]>
     */
    open class func uploadAttachmentBytes( contentType: String? = nil,  filename: String? = nil,  byteArray: Data? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<[String]> {
        let deferred = Promise<[String]>.pending()
        uploadAttachmentBytesWithRequestBuilder(contentType: contentType, filename: filename, byteArray: byteArray).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body!)
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<[String]> 
     */
    open class func uploadAttachmentBytesWithRequestBuilder(contentType: String? = nil, filename: String? = nil, byteArray: Data? = nil) -> RequestBuilder<[String]> {
    ...
    /**
     ...
     - returns: Promise<[String]>
     */
    open class func uploadMultipartForm( file: URL,  contentType: String? = nil,  filename: String? = nil,  xFilename: String? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<[String]> {
        let deferred = Promise<[String]>.pending()
