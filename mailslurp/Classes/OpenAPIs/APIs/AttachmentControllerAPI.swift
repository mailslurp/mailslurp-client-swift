...
@objc open class AttachmentControllerAPI : NSObject {
    ...
    /**
     ...
     - returns: Promise<[String]>
     */
    open class func uploadAttachmentBytes( string: String? = nil,  filename: String? = nil,  byteArray: Data? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<[String]> {
        let deferred = Promise<[String]>.pending()
