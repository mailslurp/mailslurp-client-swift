...
@objc open class ContactControllerAPI : NSObject {
     ...
     */
    open class func getAllContacts( before: Date? = nil,  page: Int? = nil,  since: Date? = nil,  size: Int? = nil,  sort: Sort_getAllContacts? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<PageContactProjection> {
        let deferred = Promise<PageContactProjection>.pending()
        getAllContactsWithRequestBuilder(before: before, page: page, since: since, size: size, sort: sort).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body!)
            case let .failure(error):
     ...
     */
    open class func getAllContactsWithRequestBuilder(before: Date? = nil, page: Int? = nil, since: Date? = nil, size: Int? = nil, sort: Sort_getAllContacts? = nil) -> RequestBuilder<PageContactProjection> {
