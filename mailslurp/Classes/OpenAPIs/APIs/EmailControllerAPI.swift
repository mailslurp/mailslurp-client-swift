...
@objc open class EmailControllerAPI : NSObject {
     ...
     */
    open class func getEmailsPaginated( before: Date? = nil,  inboxId: [UUID]? = nil,  page: Int? = nil,  searchFilter: String? = nil,  since: Date? = nil,  size: Int? = nil,  sort: Sort_getEmailsPaginated? = nil,  unreadOnly: Bool? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<PageEmailProjection> {
        let deferred = Promise<PageEmailProjection>.pending()
        getEmailsPaginatedWithRequestBuilder(before: before, inboxId: inboxId, page: page, searchFilter: searchFilter, since: since, size: size, sort: sort, unreadOnly: unreadOnly).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body!)
            case let .failure(error):
     ...
     */
    open class func getEmailsPaginatedWithRequestBuilder(before: Date? = nil, inboxId: [UUID]? = nil, page: Int? = nil, searchFilter: String? = nil, since: Date? = nil, size: Int? = nil, sort: Sort_getEmailsPaginated? = nil, unreadOnly: Bool? = nil) -> RequestBuilder<PageEmailProjection> {
        let path = "/emails"
        let URLString = mailslurpAPI.basePath + path
        let parameters: [String: Any]? = nil
    ...
    /**
     ...
     - parameter emailAddress: (query) emailAddress 
    ...
    /**
     ...
     - returns: Promise<PageEmailProjection>
     */
    open class func getOrganizationEmailsPaginated( before: Date? = nil,  inboxId: [UUID]? = nil,  page: Int? = nil,  searchFilter: String? = nil,  since: Date? = nil,  size: Int? = nil,  sort: Sort_getOrganizationEmailsPaginated? = nil,  unreadOnly: Bool? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<PageEmailProjection> {
        let deferred = Promise<PageEmailProjection>.pending()
        getOrganizationEmailsPaginatedWithRequestBuilder(before: before, inboxId: inboxId, page: page, searchFilter: searchFilter, since: since, size: size, sort: sort, unreadOnly: unreadOnly).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body!)
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<PageEmailProjection> 
     */
    open class func getOrganizationEmailsPaginatedWithRequestBuilder(before: Date? = nil, inboxId: [UUID]? = nil, page: Int? = nil, searchFilter: String? = nil, since: Date? = nil, size: Int? = nil, sort: Sort_getOrganizationEmailsPaginated? = nil, unreadOnly: Bool? = nil) -> RequestBuilder<PageEmailProjection> {
