...
@objc open class EmailControllerAPI : NSObject {
    ...
    /**
     ...
     - returns: Promise<Void>
     */
    open class func sendEmailSourceOptional( inboxId: UUID,  sendEmailOptions: SendEmailOptions,  useDomainPool: Bool? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<Void> {
        let deferred = Promise<Void>.pending()
        sendEmailSourceOptionalWithRequestBuilder(inboxId: inboxId, sendEmailOptions: sendEmailOptions, useDomainPool: useDomainPool).execute(apiResponseQueue) { result -> Void in
            switch result {
            case .success:
                deferred.resolver.fulfill(())
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func sendEmailSourceOptionalWithRequestBuilder(inboxId: UUID, sendEmailOptions: SendEmailOptions, useDomainPool: Bool? = nil) -> RequestBuilder<Void> {
        var path = "/emails"
