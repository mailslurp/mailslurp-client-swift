...
@objc open class EmailControllerAPI : NSObject {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getEmailsPaginated(inboxId: [UUID]? = nil, page: Int? = nil, searchFilter: String? = nil, size: Int? = nil, sort: Sort_getEmailsPaginated? = nil, unreadOnly: Bool? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue, completion: @escaping ((_ data: PageEmailProjection?, _ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getOrganizationEmailsPaginated(inboxId: [UUID]? = nil, page: Int? = nil, searchFilter: String? = nil, size: Int? = nil, sort: Sort_getOrganizationEmailsPaginated? = nil, unreadOnly: Bool? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue, completion: @escaping ((_ data: PageEmailProjection?, _ error: Error?) -> Void)) {
