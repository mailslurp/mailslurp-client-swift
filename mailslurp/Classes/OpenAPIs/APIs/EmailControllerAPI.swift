...
@objc open class EmailControllerAPI : NSObject {
    ...
    /**
     ...
     - returns: Promise<Email>
     */
    open class func getLatestEmailInInbox( inboxId: UUID, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<Email> {
        let deferred = Promise<Email>.pending()
    ...
    /**
     ...
     - returns: RequestBuilder<Email> 
     */
    open class func getLatestEmailInInboxWithRequestBuilder(inboxId: UUID) -> RequestBuilder<Email> {
