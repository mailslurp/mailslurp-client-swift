...
@objc open class EmailControllerAPI : NSObject {
     ...
     */
    open class func applyImapFlagOperation( emailId: UUID,  imapFlagOperationOptions: ImapFlagOperationOptions, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<EmailPreview> {
     ...
     */
    open class func downloadAttachment( emailId: UUID,  attachmentId: String,  apiKey: String? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<Data> {
     ...
     */
    open class func downloadAttachmentBase64( emailId: UUID,  attachmentId: String, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<DownloadAttachmentDto> {
     ...
     */
    open class func forwardEmail( emailId: UUID,  forwardEmailOptions: ForwardEmailOptions, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<SentEmailDto> {
     ...
     */
    open class func getAttachmentMetaData( emailId: UUID,  attachmentId: String, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<AttachmentMetaData> {
    ...
    /**
     ...
     - returns: Promise<[AttachmentMetaData]>
     */
    open class func getEmailAttachments( emailId: UUID, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<[AttachmentMetaData]> {
        let deferred = Promise<[AttachmentMetaData]>.pending()
     ...
     */
    open class func getEmailCount(apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<CountDto> {
     ...
     */
    open class func getEmailHTMLJson( emailId: UUID,  decode: Bool? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<EmailHtmlDto> {
     ...
     */
    open class func getEmailHTMLQuery( emailId: UUID,  htmlSelector: String, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<EmailTextLinesResult> {
     ...
     */
    open class func getEmailLinks( emailId: UUID, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<EmailLinksResult> {
     ...
     */
    open class func getEmailPreviewURLs( emailId: UUID, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<EmailPreviewUrls> {
     ...
     */
    open class func getEmailsPaginated( inboxId: [UUID]? = nil,  page: Int? = nil,  size: Int? = nil,  sort: Sort_getEmailsPaginated? = nil,  unreadOnly: Bool? = nil,  searchFilter: String? = nil,  since: Date? = nil,  before: Date? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<PageEmailProjection> {
     ...
     */
    open class func getGravatarUrlForEmailAddress( emailAddress: String,  size: String? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<GravatarUrl> {
    ...
    /**
     ...
     - returns: Promise<Email>
     */
    open class func getLatestEmailInInbox1( inboxId: UUID, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<Email> {
        let deferred = Promise<Email>.pending()
    ...
    /**
     ...
     - returns: Promise<PageEmailProjection>
     */
    open class func getOrganizationEmailsPaginated( inboxId: [UUID]? = nil,  page: Int? = nil,  size: Int? = nil,  sort: Sort_getOrganizationEmailsPaginated? = nil,  unreadOnly: Bool? = nil,  searchFilter: String? = nil,  since: Date? = nil,  before: Date? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<PageEmailProjection> {
        let deferred = Promise<PageEmailProjection>.pending()
    ...
    /**
     ...
     - returns: Promise<EmailPreview>
     */
    open class func markAsRead( emailId: UUID,  read: Bool? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<EmailPreview> {
        let deferred = Promise<EmailPreview>.pending()
    ...
    /**
     ...
     - returns: Promise<Void>
     */
    open class func sendEmailSourceOptional( inboxId: UUID,  sendEmailOptions: SendEmailOptions,  useDomainPool: Bool? = nil,  virtualSend: Bool? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<Void> {
        let deferred = Promise<Void>.pending()
