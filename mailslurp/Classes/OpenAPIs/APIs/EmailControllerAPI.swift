...
@objc open class EmailControllerAPI : NSObject {
    ...
    /**
     ...
     - returns: Promise<[AttachmentMetaData]>
     */
    open class func getAttachments( emailId: UUID, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<[AttachmentMetaData]> {
        let deferred = Promise<[AttachmentMetaData]>.pending()
    ...
    /**
     ...
     - returns: Promise<Email>
     */
    open class func getLatestEmail( inboxIds: Set<UUID>? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<Email> {
        let deferred = Promise<Email>.pending()
    ...
    /**
     ...
     - returns: RequestBuilder<Email> 
     */
    open class func getLatestEmailWithRequestBuilder(inboxIds: Set<UUID>? = nil) -> RequestBuilder<Email> {
    ...
    /**
     ...
     - returns: Promise<Void>
     */
    open class func sendEmailSourceOptional( sendEmailOptions: SendEmailOptions,  inboxId: UUID? = nil,  useDomainPool: Bool? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<Void> {
        let deferred = Promise<Void>.pending()
        sendEmailSourceOptionalWithRequestBuilder(sendEmailOptions: sendEmailOptions, inboxId: inboxId, useDomainPool: useDomainPool).execute(apiResponseQueue) { result -> Void in
            switch result {
            case .success:
                deferred.resolver.fulfill(())
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func sendEmailSourceOptionalWithRequestBuilder(sendEmailOptions: SendEmailOptions, inboxId: UUID? = nil, useDomainPool: Bool? = nil) -> RequestBuilder<Void> {
        let path = "/emails"
        let URLString = mailslurpAPI.basePath + path
