...
@objc open class InboxControllerAPI : NSObject {
     ...
     */
    open class func createInbox(_description: String? = nil, emailAddress: String? = nil, expiresAt: Date? = nil, expiresIn: Int64? = nil, favourite: Bool? = nil, name: String? = nil, tags: [String]? = nil, useDomainPool: Bool? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue, completion: @escaping ((_ data: Inbox?,_ error: Error?) -> Void)) {
        createInboxWithRequestBuilder(_description: _description, emailAddress: emailAddress, expiresAt: expiresAt, expiresIn: expiresIn, favourite: favourite, name: name, tags: tags, useDomainPool: useDomainPool).execute(apiResponseQueue) { result -> Void in
            switch result {
     ...
     */
    open class func createInboxWithRequestBuilder(_description: String? = nil, emailAddress: String? = nil, expiresAt: Date? = nil, expiresIn: Int64? = nil, favourite: Bool? = nil, name: String? = nil, tags: [String]? = nil, useDomainPool: Bool? = nil) -> RequestBuilder<Inbox> {
        let path = "/inboxes"
