...
@objc open class InboxControllerAPI : NSObject {
     ...
     */
    open class func createInboxRuleset( inboxId: UUID,  createInboxRulesetOptions: CreateInboxRulesetOptions, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<Void> {
     ...
     */
    open class func createInboxRulesetWithRequestBuilder(inboxId: UUID, createInboxRulesetOptions: CreateInboxRulesetOptions) -> RequestBuilder<Void> {
    ...
    /**
     ...
     - returns: Promise<Void>
     */
    open class func listInboxRulesets( inboxId: UUID,  page: Int? = nil,  searchFilter: String? = nil,  size: Int? = nil,  sort: Sort_listInboxRulesets? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<Void> {
        let deferred = Promise<Void>.pending()
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func listInboxRulesetsWithRequestBuilder(inboxId: UUID, page: Int? = nil, searchFilter: String? = nil, size: Int? = nil, sort: Sort_listInboxRulesets? = nil) -> RequestBuilder<Void> {
        var path = "/inboxes/{inboxId}/rulesets"
        let inboxIdPreEscape = "\(APIHelper.mapValueToPathItem(inboxId))"
        let inboxIdPostEscape = inboxIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{inboxId}", with: inboxIdPostEscape, options: .literal, range: nil)
