...
@objc open class InboxControllerAPI : NSObject {
     ...
     */
    open class func getEmails( inboxId: UUID,  limit: Int? = nil,  minCount: Int64? = nil,  retryTimeout: Int64? = nil,  since: Date? = nil,  size: Int? = nil,  sort: Sort_getEmails? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<[EmailPreview]> {
