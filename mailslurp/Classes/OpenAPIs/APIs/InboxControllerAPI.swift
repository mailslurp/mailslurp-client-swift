...
@objc open class InboxControllerAPI : NSObject {
    /**
     * enum for parameter 
     */
    public enum _createInbox: String, CaseIterable {
    ...
    /**
     ...
     - parameter tagsThatInboxHasBeenTaggedWithTagsCanBeAddedToInboxesToGroupDifferentInboxesWithinAnAccountYouCanAlsoSearchForInboxesByTagInTheDashboardUI: (query)  (optional)
     - parameter optionalNameOfTheInboxDisplayedInTheDashboardForEasierSearchAndUsedAsTheSenderNameWhenSendingEmails: (query)  (optional)
     - parameter optionalDescriptionOfTheInboxForLabellingPurposesIsShownInTheDashboardAndCanBeUsedWith: (query)  (optional)
     ...
     - parameter isTheInboxAFavoriteMarkingAnInboxAsAFavoriteIsTypicallyDoneInTheDashboardForQuickAccessOrFiltering: (query)  (optional)
     ...
     - parameter numberOfMillisecondsThatInboxShouldExistFor: (query)  (optional)
     - parameter dEPRECATEDTeamAccessIsAlwaysTrueGrantTeamAccessToThisInboxAndTheEmailsThatBelongToItForTeamMembersOfYourOrganization: (query)  (optional)
     ...
     */
    open class func createInboxWithRequestBuilder(: String? = nil, tagsThatInboxHasBeenTaggedWithTagsCanBeAddedToInboxesToGroupDifferentInboxesWithinAnAccountYouCanAlsoSearchForInboxesByTagInTheDashboardUI: [String]? = nil, optionalNameOfTheInboxDisplayedInTheDashboardForEasierSearchAndUsedAsTheSenderNameWhenSendingEmails: String? = nil, optionalDescriptionOfTheInboxForLabellingPurposesIsShownInTheDashboardAndCanBeUsedWith: String? = nil, : Bool? = nil, isTheInboxAFavoriteMarkingAnInboxAsAFavoriteIsTypicallyDoneInTheDashboardForQuickAccessOrFiltering: Bool? = nil, : Date? = nil, numberOfMillisecondsThatInboxShouldExistFor: Int64? = nil, dEPRECATEDTeamAccessIsAlwaysTrueGrantTeamAccessToThisInboxAndTheEmailsThatBelongToItForTeamMembersOfYourOrganization: Bool? = nil, : _createInbox? = nil) -> RequestBuilder<InboxDto> {
        let path = "/inboxes"
        ...
        urlComponents?.queryItems = APIHelper.mapValuesToQueryItems([
            ...
            "Optional name of the inbox. Displayed in the dashboard for easier search and used as the sender name when sending emails.": optionalNameOfTheInboxDisplayedInTheDashboardForEasierSearchAndUsedAsTheSenderNameWhenSendingEmails?.encodeToJSON(),
            "Optional description of the inbox for labelling purposes. Is shown in the dashboard and can be used with": optionalDescriptionOfTheInboxForLabellingPurposesIsShownInTheDashboardAndCanBeUsedWith?.encodeToJSON(),
            ...
            "Is the inbox a favorite. Marking an inbox as a favorite is typically done in the dashboard for quick access or filtering": isTheInboxAFavoriteMarkingAnInboxAsAFavoriteIsTypicallyDoneInTheDashboardForQuickAccessOrFiltering?.encodeToJSON(),
            ...
            "Number of milliseconds that inbox should exist for": numberOfMillisecondsThatInboxShouldExistFor?.encodeToJSON(),
            "DEPRECATED (team access is always true). Grant team access to this inbox and the emails that belong to it for team members of your organization.": dEPRECATEDTeamAccessIsAlwaysTrueGrantTeamAccessToThisInboxAndTheEmailsThatBelongToItForTeamMembersOfYourOrganization?.encodeToJSON(),
    ...
    /**
     ...
     - parameter dEPRECATEDOptionallyFilterByTeamAccess: (query)  (optional)
     ...
     */
    open class func getAllInboxes( page: Int? = nil,  size: Int? = nil,  sort: Sort_getAllInboxes? = nil,  favourite: Bool? = nil,  search: String? = nil,  tag: String? = nil,  dEPRECATEDOptionallyFilterByTeamAccess: Bool? = nil,  since: Date? = nil,  before: Date? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<PageInboxProjection> {
        let deferred = Promise<PageInboxProjection>.pending()
        getAllInboxesWithRequestBuilder(page: page, size: size, sort: sort, favourite: favourite, search: search, tag: tag, dEPRECATEDOptionallyFilterByTeamAccess: dEPRECATEDOptionallyFilterByTeamAccess, since: since, before: before).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body!)
            case let .failure(error):
     ...
     */
    open class func getAllInboxesWithRequestBuilder(page: Int? = nil, size: Int? = nil, sort: Sort_getAllInboxes? = nil, favourite: Bool? = nil, search: String? = nil, tag: String? = nil, dEPRECATEDOptionallyFilterByTeamAccess: Bool? = nil, since: Date? = nil, before: Date? = nil) -> RequestBuilder<PageInboxProjection> {
        ...
        urlComponents?.queryItems = APIHelper.mapValuesToQueryItems([
            ...
            "DEPRECATED. Optionally filter by team access.": dEPRECATEDOptionallyFilterByTeamAccess?.encodeToJSON(),
    ...
    /**
     * enum for parameter sortTheResultsByReceivedDateAndDirectionASCOrDESC
     */
    public enum SortTheResultsByReceivedDateAndDirectionASCOrDESC_getEmails: String, CaseIterable {
        case asc = "ASC"
        case desc = "DESC"
    }
    ...
    /**
     ...
     - parameter idOfInboxThatEmailsBelongsTo: (path)  
     - parameter aliasForLimitAssessedFirstBeforeAssessingAnyPassedLimit: (query)  (optional)
     ...
     - parameter sortTheResultsByReceivedDateAndDirectionASCOrDESC: (query)  (optional)
     ...
     */
    open class func getEmailsWithRequestBuilder(idOfInboxThatEmailsBelongsTo: UUID, aliasForLimitAssessedFirstBeforeAssessingAnyPassedLimit: Int? = nil, limit: Int? = nil, sortTheResultsByReceivedDateAndDirectionASCOrDESC: SortTheResultsByReceivedDateAndDirectionASCOrDESC_getEmails? = nil, retryTimeout: Int64? = nil, delayTimeout: Int64? = nil, minCount: Int64? = nil, unreadOnly: Bool? = nil, excludeEmailsReceivedAfterThisISO8601DateTime: Date? = nil, excludeEmailsReceivedBeforeThisISO8601DateTime: Date? = nil) -> RequestBuilder<[EmailPreview]> {
        var path = "/inboxes/{inboxId}/emails"
        let idOfInboxThatEmailsBelongsToPreEscape = "\(APIHelper.mapValueToPathItem(idOfInboxThatEmailsBelongsTo))"
        let idOfInboxThatEmailsBelongsToPostEscape = idOfInboxThatEmailsBelongsToPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{Id of inbox that emails belongs to}", with: idOfInboxThatEmailsBelongsToPostEscape, options: .literal, range: nil)
        let URLString = mailslurpAPI.basePath + path
        let parameters: [String: Any]? = nil

        var urlComponents = URLComponents(string: URLString)
        urlComponents?.queryItems = APIHelper.mapValuesToQueryItems([
            "Alias for limit. Assessed first before assessing any passed limit.": aliasForLimitAssessedFirstBeforeAssessingAnyPassedLimit?.encodeToJSON(),
            "limit": limit?.encodeToJSON(),
            "Sort the results by received date and direction ASC or DESC": sortTheResultsByReceivedDateAndDirectionASCOrDESC?.encodeToJSON(),
            ...
            "Exclude emails received after this ISO 8601 date time": excludeEmailsReceivedAfterThisISO8601DateTime?.encodeToJSON(),
            "Exclude emails received before this ISO 8601 date time": excludeEmailsReceivedBeforeThisISO8601DateTime?.encodeToJSON(),
        ])
    ...
    /**
     ...
     - returns: Promise<CountDto>
     */
    open class func getInboxEmailCount( idOfInboxThatEmailsBelongsTo: UUID, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<CountDto> {
        let deferred = Promise<CountDto>.pending()
        getInboxEmailCountWithRequestBuilder(idOfInboxThatEmailsBelongsTo: idOfInboxThatEmailsBelongsTo).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body!)
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<CountDto> 
     */
    open class func getInboxEmailCountWithRequestBuilder(idOfInboxThatEmailsBelongsTo: UUID) -> RequestBuilder<CountDto> {
     ...
     */
    open class func getInboxEmailsPaginated( idOfInboxThatEmailsBelongsTo: UUID,  page: Int? = nil,  size: Int? = nil,  sort: Sort_getInboxEmailsPaginated? = nil,  since: Date? = nil,  before: Date? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<PageEmailPreview> {
        let deferred = Promise<PageEmailPreview>.pending()
        getInboxEmailsPaginatedWithRequestBuilder(idOfInboxThatEmailsBelongsTo: idOfInboxThatEmailsBelongsTo, page: page, size: size, sort: sort, since: since, before: before).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body!)
            case let .failure(error):
     ...
     */
    open class func getInboxEmailsPaginatedWithRequestBuilder(idOfInboxThatEmailsBelongsTo: UUID, page: Int? = nil, size: Int? = nil, sort: Sort_getInboxEmailsPaginated? = nil, since: Date? = nil, before: Date? = nil) -> RequestBuilder<PageEmailPreview> {
    ...
    /**
     ...
     - parameter optionalPageSizeInInboxSentEmailListPagination: (query)  (optional, default to 20)
     - parameter sort: (query) Optional createdAt sort direction ASC or DESC (optional, default to .asc)
     ...
     */
    open class func getInboxSentEmails( inboxId: UUID,  page: Int? = nil,  optionalPageSizeInInboxSentEmailListPagination: Int? = nil,  sort: Sort_getInboxSentEmails? = nil,  searchFilter: String? = nil,  since: Date? = nil,  before: Date? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<PageSentEmailProjection> {
        let deferred = Promise<PageSentEmailProjection>.pending()
        getInboxSentEmailsWithRequestBuilder(inboxId: inboxId, page: page, optionalPageSizeInInboxSentEmailListPagination: optionalPageSizeInInboxSentEmailListPagination, sort: sort, searchFilter: searchFilter, since: since, before: before).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body!)
            case let .failure(error):
     ...
     */
    open class func getInboxSentEmailsWithRequestBuilder(inboxId: UUID, page: Int? = nil, optionalPageSizeInInboxSentEmailListPagination: Int? = nil, sort: Sort_getInboxSentEmails? = nil, searchFilter: String? = nil, since: Date? = nil, before: Date? = nil) -> RequestBuilder<PageSentEmailProjection> {
        ...
        urlComponents?.queryItems = APIHelper.mapValuesToQueryItems([
            "page": page?.encodeToJSON(),
            "Optional page size in inbox sent email list pagination": optionalPageSizeInInboxSentEmailListPagination?.encodeToJSON(),
            "sort": sort?.encodeToJSON(),
     ...
     */
    open class func getInboxTags(apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<Set<String>> {
        let deferred = Promise<Set<String>>.pending()
     ...
     */
    open class func getInboxTagsWithRequestBuilder() -> RequestBuilder<Set<String>> {
        ...
        let requestBuilder: RequestBuilder<Set<String>>.Type = mailslurpAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter optionalPageSizeInInboxTrackingPixelListPagination: (query)  (optional, default to 20)
     - parameter sort: (query) Optional createdAt sort direction ASC or DESC (optional, default to .asc)
     - parameter searchFilter: (query) Optional search filter (optional)
     - parameter since: (query) Optional filter by created after given date time (optional)
     - parameter before: (query) Optional filter by created before given date time (optional)
     ...
     */
    open class func listInboxTrackingPixels( inboxId: UUID,  page: Int? = nil,  optionalPageSizeInInboxTrackingPixelListPagination: Int? = nil,  sort: Sort_listInboxTrackingPixels? = nil,  searchFilter: String? = nil,  since: Date? = nil,  before: Date? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<PageTrackingPixelProjection> {
        let deferred = Promise<PageTrackingPixelProjection>.pending()
        listInboxTrackingPixelsWithRequestBuilder(inboxId: inboxId, page: page, optionalPageSizeInInboxTrackingPixelListPagination: optionalPageSizeInInboxTrackingPixelListPagination, sort: sort, searchFilter: searchFilter, since: since, before: before).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body!)
            case let .failure(error):
     ...
     */
    open class func listInboxTrackingPixelsWithRequestBuilder(inboxId: UUID, page: Int? = nil, optionalPageSizeInInboxTrackingPixelListPagination: Int? = nil, sort: Sort_listInboxTrackingPixels? = nil, searchFilter: String? = nil, since: Date? = nil, before: Date? = nil) -> RequestBuilder<PageTrackingPixelProjection> {
        ...
        urlComponents?.queryItems = APIHelper.mapValuesToQueryItems([
            "page": page?.encodeToJSON(),
            "Optional page size in inbox tracking pixel list pagination": optionalPageSizeInInboxTrackingPixelListPagination?.encodeToJSON(),
            "sort": sort?.encodeToJSON(),
            "searchFilter": searchFilter?.encodeToJSON(),
            "since": since?.encodeToJSON(),
            "before": before?.encodeToJSON(),
    ...
    /**
     ...
     - parameter iDOfTheInboxYouWantToSendTheEmailFrom: (path)  
     - parameter sendEmailOptions: (body)  
     - parameter apiResponseQueue: The queue on which api response is dispatched.
     - returns: Promise<Void>
     */
    open class func sendEmail( iDOfTheInboxYouWantToSendTheEmailFrom: UUID,  sendEmailOptions: SendEmailOptions, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<Void> {
        let deferred = Promise<Void>.pending()
        sendEmailWithRequestBuilder(iDOfTheInboxYouWantToSendTheEmailFrom: iDOfTheInboxYouWantToSendTheEmailFrom, sendEmailOptions: sendEmailOptions).execute(apiResponseQueue) { result -> Void in
            switch result {
            case .success:
                deferred.resolver.fulfill(())
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func sendEmailWithRequestBuilder(iDOfTheInboxYouWantToSendTheEmailFrom: UUID, sendEmailOptions: SendEmailOptions) -> RequestBuilder<Void> {
        var path = "/inboxes/{inboxId}"
        let iDOfTheInboxYouWantToSendTheEmailFromPreEscape = "\(APIHelper.mapValueToPathItem(iDOfTheInboxYouWantToSendTheEmailFrom))"
        let iDOfTheInboxYouWantToSendTheEmailFromPostEscape = iDOfTheInboxYouWantToSendTheEmailFromPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{ID of the inbox you want to send the email from}", with: iDOfTheInboxYouWantToSendTheEmailFromPostEscape, options: .literal, range: nil)
        let URLString = mailslurpAPI.basePath + path
     ...
     */
    open class func sendEmailAndConfirm( iDOfTheInboxYouWantToSendTheEmailFrom: UUID,  sendEmailOptions: SendEmailOptions, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<SentEmailDto> {
        let deferred = Promise<SentEmailDto>.pending()
        sendEmailAndConfirmWithRequestBuilder(iDOfTheInboxYouWantToSendTheEmailFrom: iDOfTheInboxYouWantToSendTheEmailFrom, sendEmailOptions: sendEmailOptions).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body!)
            case let .failure(error):
     ...
     */
    open class func sendEmailAndConfirmWithRequestBuilder(iDOfTheInboxYouWantToSendTheEmailFrom: UUID, sendEmailOptions: SendEmailOptions) -> RequestBuilder<SentEmailDto> {
