...
@objc open class InboxControllerAPI : NSObject {
     ...
     */
    open class func createInbox(_description: String? = nil, emailAddress: String? = nil, expiresAt: Date? = nil, favourite: Bool? = nil, name: String? = nil, tags: [String]? = nil, useDomainPool: Bool? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue, completion: @escaping ((_ data: Inbox?,_ error: Error?) -> Void)) {
        createInboxWithRequestBuilder(_description: _description, emailAddress: emailAddress, expiresAt: expiresAt, favourite: favourite, name: name, tags: tags, useDomainPool: useDomainPool).execute(apiResponseQueue) { result -> Void in
            switch result {
     ...
     */
    open class func createInboxWithRequestBuilder(_description: String? = nil, emailAddress: String? = nil, expiresAt: Date? = nil, favourite: Bool? = nil, name: String? = nil, tags: [String]? = nil, useDomainPool: Bool? = nil) -> RequestBuilder<Inbox> {
        let path = "/inboxes"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getAllInboxes(favourite: Bool? = nil, page: Int? = nil, search: String? = nil, size: Int? = nil, sort: Sort_getAllInboxes? = nil, tag: String? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue, completion: @escaping ((_ data: PageInboxProjection?,_ error: Error?) -> Void)) {
        getAllInboxesWithRequestBuilder(favourite: favourite, page: page, search: search, size: size, sort: sort, tag: tag).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getExpiredInboxRecordById(expiredId: UUID, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue, completion: @escaping ((_ data: ExpiredInboxDto?,_ error: Error?) -> Void)) {
        getExpiredInboxRecordByIdWithRequestBuilder(expiredId: expiredId).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     Get an expired inbox record
     - GET /inboxes/expired-records/{expiredId}
     ...
     */
    open class func getExpiredInboxRecordByIdWithRequestBuilder(expiredId: UUID) -> RequestBuilder<ExpiredInboxDto> {
        var path = "/inboxes/expired-records/{expiredId}"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getExpiredInboxRecordByInboxId(inboxId: UUID, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue, completion: @escaping ((_ data: ExpiredInboxDto?,_ error: Error?) -> Void)) {
        getExpiredInboxRecordByInboxIdWithRequestBuilder(inboxId: inboxId).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     Get expired inbox record for a previously existing inbox
     - GET /inboxes/{inboxId}/expired-record
     ...
     - returns: RequestBuilder<ExpiredInboxDto> 
     */
    open class func getExpiredInboxRecordByInboxIdWithRequestBuilder(inboxId: UUID) -> RequestBuilder<ExpiredInboxDto> {
        var path = "/inboxes/{inboxId}/expired-record"
        let inboxIdPreEscape = "\(APIHelper.mapValueToPathItem(inboxId))"
        let inboxIdPostEscape = inboxIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{inboxId}", with: inboxIdPostEscape, options: .literal, range: nil)
        let URLString = mailslurpAPI.basePath + path
     ...
     * enum for parameter sort
     */
    public enum Sort_getExpiredInboxRecords: String, CaseIterable {
        case asc = "ASC"
        case desc = "DESC"
    }
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getExpiredInboxRecords(page: Int? = nil, size: Int? = nil, sort: Sort_getExpiredInboxRecords? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue, completion: @escaping ((_ data: PageExpiredInboxRecordProjection?,_ error: Error?) -> Void)) {
        getExpiredInboxRecordsWithRequestBuilder(page: page, size: size, sort: sort).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
     ...
     */
    open class func getExpiredInboxRecordsWithRequestBuilder(page: Int? = nil, size: Int? = nil, sort: Sort_getExpiredInboxRecords? = nil) -> RequestBuilder<PageExpiredInboxRecordProjection> {
        let path = "/inboxes/expired-records"
        let URLString = mailslurpAPI.basePath + path
        let parameters: [String:Any]? = nil
