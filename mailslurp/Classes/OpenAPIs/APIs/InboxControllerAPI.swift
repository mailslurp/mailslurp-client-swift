...
@objc open class InboxControllerAPI : NSObject {
     ...
     */
    open class func getAllInboxes( favourite: Bool? = nil,  page: Int? = nil,  search: String? = nil,  size: Int? = nil,  sort: Sort_getAllInboxes? = nil,  tag: String? = nil,  teamAccess: Bool? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<PageInboxProjection> {
     ...
     */
    open class func getEmails( inboxId: UUID,  delayTimeout: Int64? = nil,  limit: Int? = nil,  minCount: Int64? = nil,  retryTimeout: Int64? = nil,  since: Date? = nil,  size: Int? = nil,  sort: Sort_getEmails? = nil,  unreadOnly: Bool? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<[EmailPreview]> {
        let deferred = Promise<[EmailPreview]>.pending()
        getEmailsWithRequestBuilder(inboxId: inboxId, delayTimeout: delayTimeout, limit: limit, minCount: minCount, retryTimeout: retryTimeout, since: since, size: size, sort: sort, unreadOnly: unreadOnly).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body!)
            case let .failure(error):
     ...
     */
    open class func getEmailsWithRequestBuilder(inboxId: UUID, delayTimeout: Int64? = nil, limit: Int? = nil, minCount: Int64? = nil, retryTimeout: Int64? = nil, since: Date? = nil, size: Int? = nil, sort: Sort_getEmails? = nil, unreadOnly: Bool? = nil) -> RequestBuilder<[EmailPreview]> {
     ...
     */
    open class func getInboxEmailsPaginated( inboxId: UUID,  page: Int? = nil,  size: Int? = nil,  sort: Sort_getInboxEmailsPaginated? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<PageEmailPreview> {
     ...
     */
    open class func getInboxSentEmails( inboxId: UUID,  page: Int? = nil,  searchFilter: String? = nil,  size: Int? = nil,  sort: Sort_getInboxSentEmails? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<PageSentEmailProjection> {
        let deferred = Promise<PageSentEmailProjection>.pending()
        getInboxSentEmailsWithRequestBuilder(inboxId: inboxId, page: page, searchFilter: searchFilter, size: size, sort: sort).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body!)
            case let .failure(error):
     ...
     */
    open class func getInboxSentEmailsWithRequestBuilder(inboxId: UUID, page: Int? = nil, searchFilter: String? = nil, size: Int? = nil, sort: Sort_getInboxSentEmails? = nil) -> RequestBuilder<PageSentEmailProjection> {
    ...
    /**
     ...
     - returns: Promise<[Inbox]>
     */
    open class func getInboxes( size: Int? = nil,  sort: Sort_getInboxes? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<[Inbox]> {
        let deferred = Promise<[Inbox]>.pending()
     ...
     */
    open class func getOrganizationInboxes( page: Int? = nil,  searchFilter: String? = nil,  size: Int? = nil,  sort: Sort_getOrganizationInboxes? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<PageOrganizationInboxProjection> {
        let deferred = Promise<PageOrganizationInboxProjection>.pending()
        getOrganizationInboxesWithRequestBuilder(page: page, searchFilter: searchFilter, size: size, sort: sort).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body!)
            case let .failure(error):
     ...
     */
    open class func getOrganizationInboxesWithRequestBuilder(page: Int? = nil, searchFilter: String? = nil, size: Int? = nil, sort: Sort_getOrganizationInboxes? = nil) -> RequestBuilder<PageOrganizationInboxProjection> {
     ...
     */
    open class func listInboxRulesets( inboxId: UUID,  page: Int? = nil,  searchFilter: String? = nil,  size: Int? = nil,  sort: Sort_listInboxRulesets? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<PageInboxRulesetDto> {
        let deferred = Promise<PageInboxRulesetDto>.pending()
        listInboxRulesetsWithRequestBuilder(inboxId: inboxId, page: page, searchFilter: searchFilter, size: size, sort: sort).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body!)
            case let .failure(error):
     ...
     */
    open class func listInboxRulesetsWithRequestBuilder(inboxId: UUID, page: Int? = nil, searchFilter: String? = nil, size: Int? = nil, sort: Sort_listInboxRulesets? = nil) -> RequestBuilder<PageInboxRulesetDto> {
        var path = "/inboxes/{inboxId}/rulesets"
        let inboxIdPreEscape = "\(APIHelper.mapValueToPathItem(inboxId))"
        let inboxIdPostEscape = inboxIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{inboxId}", with: inboxIdPostEscape, options: .literal, range: nil)
     ...
     */
    open class func listInboxTrackingPixels( inboxId: UUID,  page: Int? = nil,  searchFilter: String? = nil,  size: Int? = nil,  sort: Sort_listInboxTrackingPixels? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<PageTrackingPixelProjection> {
        let deferred = Promise<PageTrackingPixelProjection>.pending()
        listInboxTrackingPixelsWithRequestBuilder(inboxId: inboxId, page: page, searchFilter: searchFilter, size: size, sort: sort).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body!)
            case let .failure(error):
     ...
     */
    open class func listInboxTrackingPixelsWithRequestBuilder(inboxId: UUID, page: Int? = nil, searchFilter: String? = nil, size: Int? = nil, sort: Sort_listInboxTrackingPixels? = nil) -> RequestBuilder<PageTrackingPixelProjection> {
