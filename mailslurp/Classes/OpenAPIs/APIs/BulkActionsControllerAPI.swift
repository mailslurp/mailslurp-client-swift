...
@objc open class BulkActionsControllerAPI : NSObject {
     ...
     */
    open class func bulkCreateInboxes( count: Int, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<[InboxDto]> {
     ...
     */
    open class func bulkDeleteInboxes( requestBody: [UUID], apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<Void> {
