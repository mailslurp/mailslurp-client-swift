...
@objc open class WaitForControllerAPI : NSObject {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func waitForMatchingFirstEmail(matchOptions: MatchOptions, inboxId: UUID? = nil, timeout: Int64? = nil, unreadOnly: Bool? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue, completion: @escaping ((_ data: Email?,_ error: Error?) -> Void)) {
