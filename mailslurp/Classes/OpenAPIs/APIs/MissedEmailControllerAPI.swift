...
@objc open class MissedEmailControllerAPI : NSObject {
     ...
     */
    open class func getAllUnknownMissedEmails( inboxId: UUID? = nil,  page: Int? = nil,  searchFilter: String? = nil,  size: Int? = nil,  sort: Sort_getAllUnknownMissedEmails? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<PageUnknownMissedEmailProjection> {
        let deferred = Promise<PageUnknownMissedEmailProjection>.pending()
        getAllUnknownMissedEmailsWithRequestBuilder(inboxId: inboxId, page: page, searchFilter: searchFilter, size: size, sort: sort).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body!)
            case let .failure(error):
     ...
     */
    open class func getAllUnknownMissedEmailsWithRequestBuilder(inboxId: UUID? = nil, page: Int? = nil, searchFilter: String? = nil, size: Int? = nil, sort: Sort_getAllUnknownMissedEmails? = nil) -> RequestBuilder<PageUnknownMissedEmailProjection> {
