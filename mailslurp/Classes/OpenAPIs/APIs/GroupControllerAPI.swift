...
@objc open class GroupControllerAPI : NSObject {
     ...
     */
    open class func getAllGroups( before: Date? = nil,  page: Int? = nil,  since: Date? = nil,  size: Int? = nil,  sort: Sort_getAllGroups? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<PageGroupProjection> {
        let deferred = Promise<PageGroupProjection>.pending()
        getAllGroupsWithRequestBuilder(before: before, page: page, since: since, size: size, sort: sort).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body!)
            case let .failure(error):
     ...
     */
    open class func getAllGroupsWithRequestBuilder(before: Date? = nil, page: Int? = nil, since: Date? = nil, size: Int? = nil, sort: Sort_getAllGroups? = nil) -> RequestBuilder<PageGroupProjection> {
     ...
     */
    open class func getGroupWithContactsPaginated( groupId: UUID,  before: Date? = nil,  page: Int? = nil,  since: Date? = nil,  size: Int? = nil,  sort: Sort_getGroupWithContactsPaginated? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<PageContactProjection> {
        let deferred = Promise<PageContactProjection>.pending()
        getGroupWithContactsPaginatedWithRequestBuilder(groupId: groupId, before: before, page: page, since: since, size: size, sort: sort).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body!)
            case let .failure(error):
     ...
     */
    open class func getGroupWithContactsPaginatedWithRequestBuilder(groupId: UUID, before: Date? = nil, page: Int? = nil, since: Date? = nil, size: Int? = nil, sort: Sort_getGroupWithContactsPaginated? = nil) -> RequestBuilder<PageContactProjection> {
