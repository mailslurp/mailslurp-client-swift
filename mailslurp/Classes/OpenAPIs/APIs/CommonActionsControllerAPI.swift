...
@objc open class CommonActionsControllerAPI : NSObject {
    /**
     ...
     - parameter useDomainPool: (query) useDomainPool 
     - parameter apiResponseQueue: The queue on which api response is dispatched.
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func createNewEmailAddress(useDomainPool: Bool, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue, completion: @escaping ((_ data: Inbox?,_ error: Error?) -> Void)) {
        createNewEmailAddressWithRequestBuilder(useDomainPool: useDomainPool).execute(apiResponseQueue) { result -> Void in
            switch result {
     ...
     */
    open class func createNewEmailAddressWithRequestBuilder(useDomainPool: Bool) -> RequestBuilder<Inbox> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func createNewEmailAddress1(useDomainPool: Bool, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue, completion: @escaping ((_ data: Inbox?,_ error: Error?) -> Void)) {
        createNewEmailAddress1WithRequestBuilder(useDomainPool: useDomainPool).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<Inbox> 
     */
    open class func createNewEmailAddress1WithRequestBuilder(useDomainPool: Bool) -> RequestBuilder<Inbox> {
