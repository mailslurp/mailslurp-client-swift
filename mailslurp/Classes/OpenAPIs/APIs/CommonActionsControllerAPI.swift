...
@objc open class CommonActionsControllerAPI : NSObject {
    ...
    /**
     ...
     - parameter emailAddress: (query) emailAddress (optional)
     - parameter expiresAt: (query) expiresAt (optional)
     - parameter expiresIn: (query) expiresIn (optional)
     - parameter favourite: (query) favourite (optional)
     - parameter inboxType: (query) inboxType (optional)
     ...
     */
    open class func createNewEmailAddress( allowTeamAccess: Bool? = nil,  _description: String? = nil,  emailAddress: String? = nil,  expiresAt: Date? = nil,  expiresIn: Int64? = nil,  favourite: Bool? = nil,  inboxType: InboxType_createNewEmailAddress? = nil,  name: String? = nil,  tags: [String]? = nil,  useDomainPool: Bool? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<Inbox> {
        let deferred = Promise<Inbox>.pending()
        createNewEmailAddressWithRequestBuilder(allowTeamAccess: allowTeamAccess, _description: _description, emailAddress: emailAddress, expiresAt: expiresAt, expiresIn: expiresIn, favourite: favourite, inboxType: inboxType, name: name, tags: tags, useDomainPool: useDomainPool).execute(apiResponseQueue) { result -> Void in
            switch result {
     ...
     */
    open class func createNewEmailAddressWithRequestBuilder(allowTeamAccess: Bool? = nil, _description: String? = nil, emailAddress: String? = nil, expiresAt: Date? = nil, expiresIn: Int64? = nil, favourite: Bool? = nil, inboxType: InboxType_createNewEmailAddress? = nil, name: String? = nil, tags: [String]? = nil, useDomainPool: Bool? = nil) -> RequestBuilder<Inbox> {
    ...
    /**
     ...
     - returns: Promise<Inbox>
     */
    open class func createNewEmailAddress1( allowTeamAccess: Bool? = nil,  _description: String? = nil,  emailAddress: String? = nil,  expiresAt: Date? = nil,  expiresIn: Int64? = nil,  favourite: Bool? = nil,  inboxType: InboxType_createNewEmailAddress1? = nil,  name: String? = nil,  tags: [String]? = nil,  useDomainPool: Bool? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<Inbox> {
        let deferred = Promise<Inbox>.pending()
        createNewEmailAddress1WithRequestBuilder(allowTeamAccess: allowTeamAccess, _description: _description, emailAddress: emailAddress, expiresAt: expiresAt, expiresIn: expiresIn, favourite: favourite, inboxType: inboxType, name: name, tags: tags, useDomainPool: useDomainPool).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body!)
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<Inbox> 
     */
    open class func createNewEmailAddress1WithRequestBuilder(allowTeamAccess: Bool? = nil, _description: String? = nil, emailAddress: String? = nil, expiresAt: Date? = nil, expiresIn: Int64? = nil, favourite: Bool? = nil, inboxType: InboxType_createNewEmailAddress1? = nil, name: String? = nil, tags: [String]? = nil, useDomainPool: Bool? = nil) -> RequestBuilder<Inbox> {
