...
@objc open class CommonActionsControllerAPI : NSObject {
     ...
     */
    open class func createNewEmailAddress(allowTeamAccess: Bool? = nil, expiresAt: Date? = nil, expiresIn: Int64? = nil, useDomainPool: Bool? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue, completion: @escaping ((_ data: Inbox?, _ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func createNewEmailAddress1(allowTeamAccess: Bool? = nil, expiresAt: Date? = nil, expiresIn: Int64? = nil, useDomainPool: Bool? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue, completion: @escaping ((_ data: Inbox?, _ error: Error?) -> Void)) {
