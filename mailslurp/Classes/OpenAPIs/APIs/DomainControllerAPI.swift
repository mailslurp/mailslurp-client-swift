...
@objc open class DomainControllerAPI : NSObject {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func updateDomain(_id: UUID, updateDomainDto: UpdateDomainOptions, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue, completion: @escaping ((_ data: DomainDto?,_ error: Error?) -> Void)) {
