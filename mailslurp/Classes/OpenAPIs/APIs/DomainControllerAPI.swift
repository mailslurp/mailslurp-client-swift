...
@objc open class DomainControllerAPI : NSObject {
    ...
    /**
     ...
     - returns: Promise<DomainDto>
     */
    open class func createDomain( createDomainOptions: CreateDomainOptions, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<DomainDto> {
        let deferred = Promise<DomainDto>.pending()
    ...
    /**
     ...
     - returns: Promise<DomainDto>
     */
    open class func updateDomain( _id: UUID,  updateDomainOptions: UpdateDomainOptions, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<DomainDto> {
        let deferred = Promise<DomainDto>.pending()
