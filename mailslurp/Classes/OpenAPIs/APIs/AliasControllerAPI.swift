...
@objc open class AliasControllerAPI : NSObject {
     ...
     */
    open class func getAliasEmails( aliasId: UUID,  page: Int? = nil,  size: Int? = nil,  sort: Sort_getAliasEmails? = nil,  since: Date? = nil,  before: Date? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<PageEmailProjection> {
     ...
     */
    open class func getAliasThreads( aliasId: UUID,  page: Int? = nil,  size: Int? = nil,  sort: Sort_getAliasThreads? = nil,  since: Date? = nil,  before: Date? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<PageThreadProjection> {
     ...
     */
    open class func getAliases( page: Int? = nil,  size: Int? = nil,  sort: Sort_getAliases? = nil,  since: Date? = nil,  before: Date? = nil, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<PageAlias> {
    ...
    /**
     ...
     - returns: Promise<SentEmailDto>
     */
    open class func sendAliasEmail( aliasId: UUID,  sendEmailOptions: SendEmailOptions, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<SentEmailDto> {
        let deferred = Promise<SentEmailDto>.pending()
    ...
    /**
     ...
     - returns: Promise<AliasDto>
     */
    open class func updateAlias( aliasId: UUID,  updateAliasOptions: UpdateAliasOptions, apiResponseQueue: DispatchQueue = mailslurpAPI.apiResponseQueue) -> Promise<AliasDto> {
        let deferred = Promise<AliasDto>.pending()
