...
@objc public class MissedEmail: NSObject, Codable {
    ...
    public init(_id: UUID? = nil, userId: UUID? = nil, subject: String? = nil, bodyExcerpt: String? = nil, attachmentCount: Int, from: String? = nil, to: [String], cc: [String], bcc: [String], inboxIds: [UUID], createdAt: Date, updatedAt: Date) {
        self._id = _id
        self.userId = userId
