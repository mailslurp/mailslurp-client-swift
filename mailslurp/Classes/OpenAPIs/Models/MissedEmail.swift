...
@objc public class MissedEmail: NSObject, Codable {
    ...
    public init(attachmentCount: Int, bcc: [String], bodyExcerpt: String? = nil, cc: [String], createdAt: Date, from: String? = nil, _id: UUID? = nil, inboxIds: [UUID], subject: String? = nil, to: [String], updatedAt: Date, userId: UUID? = nil) {
