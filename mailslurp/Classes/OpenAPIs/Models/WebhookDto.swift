...
@objc public class WebhookDto: NSObject, Codable { 
    ...
    public init(basicAuth: Bool?, createdAt: Date?, eventName: EventName?, _id: UUID?, inboxId: UUID?, method: Method?, name: String?, payloadJsonSchema: String?, updatedAt: Date, url: String?) {
