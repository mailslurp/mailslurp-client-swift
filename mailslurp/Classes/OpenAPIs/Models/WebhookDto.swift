...
@objc public class WebhookDto: NSObject, Codable {
    ...
    public init(_id: UUID, userId: UUID, basicAuth: Bool, name: String? = nil, inboxId: UUID, url: String, method: Method, payloadJsonSchema: String, createdAt: Date, updatedAt: Date, eventName: EventName? = nil) {
        self._id = _id
        self.userId = userId
