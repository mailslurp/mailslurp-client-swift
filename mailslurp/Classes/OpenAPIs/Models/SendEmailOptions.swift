...
@objc public class SendEmailOptions: NSObject, Codable {
    ...
    public init(toContacts: [UUID]? = nil, toGroup: UUID? = nil, to: [String]? = nil, from: String? = nil, cc: [String]? = nil, bcc: [String]? = nil, subject: String? = nil, replyTo: String? = nil, body: String? = nil, html: Bool? = nil, charset: String? = nil, attachments: [String]? = nil, templateVariables: [String: AnyCodable]? = nil, template: UUID? = nil, sendStrategy: SendStrategy? = nil, useInboxName: Bool? = nil, addTrackingPixel: Bool? = nil) {
