...
@objc public class SendEmailOptions: NSObject, Codable { 
    ...
    public init(attachments: [String]?, bcc: [String]?, body: String?, cc: [String]?, charset: String?, from: String?, isHTML: Bool?, replyTo: String?, sendStrategy: SendStrategy?, subject: String?, template: UUID?, templateVariables: Any?, to: [String]?, toContacts: [UUID]?, toGroup: UUID?) {
