...
@objc public class PageInboxRulesetDto: NSObject, Codable {
    ...
    public init(content: [InboxRulesetDto]? = nil, pageable: Pageable? = nil, last: Bool? = nil, totalPages: Int? = nil, totalElements: Int64? = nil, size: Int? = nil, number: Int? = nil, sort: Sort? = nil, first: Bool? = nil, numberOfElements: Int? = nil, empty: Bool? = nil) {
