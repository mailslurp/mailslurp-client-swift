...
@objc public class SentEmailDto: NSObject, Codable {
    ...
    public init(attachments: [String]? = nil, bcc: [String]? = nil, body: String? = nil, bodyMD5Hash: String? = nil, cc: [String]? = nil, charset: String? = nil, from: String? = nil, _id: UUID? = nil, inboxId: UUID? = nil, isHTML: Bool? = nil, pixelIds: [UUID]? = nil, replyTo: String? = nil, sentAt: Date, subject: String? = nil, to: [String]? = nil, userId: UUID? = nil) {
