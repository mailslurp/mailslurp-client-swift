...
@objc public class SentEmailDto: NSObject, Codable {
    ...
    public init(_id: UUID, userId: UUID, inboxId: UUID, to: [String]? = nil, from: String? = nil, replyTo: String? = nil, cc: [String]? = nil, bcc: [String]? = nil, attachments: [String]? = nil, subject: String? = nil, bodyMD5Hash: String? = nil, body: String? = nil, charset: String? = nil, isHTML: Bool? = nil, sentAt: Date, pixelIds: [UUID]? = nil, messageId: String? = nil) {
        self._id = _id
        self.userId = userId
