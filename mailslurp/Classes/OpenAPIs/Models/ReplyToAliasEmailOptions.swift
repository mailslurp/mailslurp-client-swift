...
@objc public class ReplyToAliasEmailOptions: NSObject, Codable {
    ...
    public init(attachments: [String]? = nil, body: String? = nil, charset: String? = nil, isHTML: Bool? = nil, sendStrategy: SendStrategy? = nil, template: UUID? = nil, templateVariables: Any? = nil, useInboxName: Bool? = nil) {
