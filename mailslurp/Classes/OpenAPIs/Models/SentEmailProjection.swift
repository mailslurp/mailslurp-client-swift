...
@objc public class SentEmailProjection: NSObject, Codable {
    ...
    public init(_id: UUID, from: String? = nil, userId: UUID, subject: String? = nil, inboxId: UUID, to: [String], attachments: [String], createdAt: Date, bcc: [String], cc: [String], bodyMD5Hash: String? = nil) {
        self._id = _id
        self.from = from
        self.userId = userId
