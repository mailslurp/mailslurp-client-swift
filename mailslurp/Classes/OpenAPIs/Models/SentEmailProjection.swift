...
@objc public class SentEmailProjection: NSObject, Codable {
    ...
    public init(_id: UUID, from: String? = nil, userId: UUID, subject: String? = nil, attachments: [String], inboxId: UUID, createdAt: Date, to: [String], bcc: [String], cc: [String], bodyMD5Hash: String? = nil) {
        self._id = _id
        self.from = from
        self.userId = userId
