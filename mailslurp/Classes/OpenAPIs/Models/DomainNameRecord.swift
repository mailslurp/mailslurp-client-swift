...
@objc public class DomainNameRecord: NSObject, Codable {
    ...
    public init(recordType: RecordType? = nil, name: String? = nil, recordEntries: [String]? = nil, ttl: Int64? = nil) {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(recordEntries, forKey: .recordEntries)
