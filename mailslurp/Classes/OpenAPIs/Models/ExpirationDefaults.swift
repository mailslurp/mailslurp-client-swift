...
@objc public class ExpirationDefaults: NSObject, Codable {
    ...
    public var canPermanentInboxNum: NSNumber? {
        get {
            return canPermanentInbox as NSNumber?
        }
    }
    public var nextInboxAllowsPermanent: Bool?
    public var nextInboxAllowsPermanentNum: NSNumber? {
        get {
            return nextInboxAllowsPermanent as NSNumber?
        }
    }

    public init(defaultExpirationMillis: Int64? = nil, maxExpirationMillis: Int64? = nil, defaultExpiresAt: Date? = nil, canPermanentInbox: Bool? = nil, nextInboxAllowsPermanent: Bool? = nil) {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(canPermanentInbox, forKey: .canPermanentInbox)
        try container.encodeIfPresent(nextInboxAllowsPermanent, forKey: .nextInboxAllowsPermanent)
    }
