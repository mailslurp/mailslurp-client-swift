...
@objc public class EmailProjection: NSObject, Codable {
    ...
    public init(_id: UUID, from: String? = nil, subject: String? = nil, attachments: [String]? = nil, inboxId: UUID, to: [String], bcc: [String]? = nil, cc: [String]? = nil, createdAt: Date, read: Bool? = nil, bodyMD5Hash: String? = nil, bodyExcerpt: String? = nil, teamAccess: Bool? = nil) {
        self._id = _id
        self.from = from
