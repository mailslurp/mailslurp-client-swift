...
@objc public class EmailProjection: NSObject, Codable {
    ...
    public init(attachments: [String]? = nil, bcc: [String]? = nil, bodyExcerpt: String? = nil, bodyMD5Hash: String? = nil, cc: [String]? = nil, createdAt: Date, from: String? = nil, _id: UUID, inboxId: UUID, read: Bool? = nil, subject: String? = nil, teamAccess: Bool? = nil, to: [String]) {
