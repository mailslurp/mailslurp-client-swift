...
@objc public class EmailProjection: NSObject, Codable {
    ...
    public init(_id: UUID? = nil, from: String? = nil, teamAccess: Bool? = nil, read: Bool? = nil, bodyMD5Hash: String? = nil, bodyExcerpt: String? = nil, subject: String? = nil, inboxId: UUID? = nil, to: [String]? = nil, attachments: [String]? = nil, bcc: [String]? = nil, cc: [String]? = nil, createdAt: Date? = nil) {
        self._id = _id
        self.from = from
