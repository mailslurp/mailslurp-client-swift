...
@objc public class EmailProjection: NSObject, Codable {
    ...
    public init(_id: UUID, from: String? = nil, createdAt: Date, subject: String? = nil, inboxId: UUID, to: [String], attachments: [String]? = nil, bcc: [String]? = nil, cc: [String]? = nil, teamAccess: Bool? = nil, read: Bool? = nil, bodyMD5Hash: String? = nil, bodyExcerpt: String? = nil) {
        self._id = _id
        self.from = from
