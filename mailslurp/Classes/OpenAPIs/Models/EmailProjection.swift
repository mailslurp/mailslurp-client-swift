...
@objc public class EmailProjection: NSObject, Codable {
    ...
    public init(_id: UUID, from: String? = nil, inboxId: UUID, subject: String? = nil, to: [String], attachments: [String]? = nil, bcc: [String]? = nil, cc: [String]? = nil, createdAt: Date, teamAccess: Bool? = nil, read: Bool? = nil, bodyMD5Hash: String? = nil, bodyExcerpt: String? = nil) {
        self._id = _id
        self.from = from
