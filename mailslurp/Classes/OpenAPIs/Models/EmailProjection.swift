...
@objc public class EmailProjection: NSObject, Codable {
    ...
    public init(_id: UUID, from: String? = nil, subject: String? = nil, inboxId: UUID, attachments: [String]? = nil, to: [String], createdAt: Date, bcc: [String]? = nil, cc: [String]? = nil, teamAccess: Bool, read: Bool, bodyMD5Hash: String? = nil, bodyExcerpt: String? = nil) {
        self._id = _id
        self.from = from
