...
@objc public class EmailProjection: NSObject, Codable {
    ...
    public init(_id: UUID, from: String? = nil, subject: String? = nil, inboxId: UUID, attachments: [String]? = nil, to: [String], bcc: [String]? = nil, cc: [String]? = nil, createdAt: Date, teamAccess: Bool? = nil, read: Bool? = nil, bodyMD5Hash: String? = nil, bodyExcerpt: String? = nil) {
        self._id = _id
        self.from = from
