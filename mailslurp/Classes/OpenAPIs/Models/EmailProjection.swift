...
@objc public class EmailProjection: NSObject, Codable { 
    ...
    public init(attachments: [String]?, bcc: [String]?, bodyMD5Hash: String?, cc: [String]?, createdAt: Date, from: String?, _id: UUID, inboxId: UUID, read: Bool?, subject: String?, to: [String]) {
