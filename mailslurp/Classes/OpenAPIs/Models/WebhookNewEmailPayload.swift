...
@objc public class WebhookNewEmailPayload: NSObject, Codable {
    ...
    public init(messageId: String? = nil, webhookId: UUID? = nil, eventName: EventName? = nil, webhookName: String? = nil, inboxId: UUID? = nil, emailId: UUID? = nil, createdAt: Date? = nil, to: [String]? = nil, from: String? = nil, cc: [String]? = nil, bcc: [String]? = nil, subject: String? = nil, attachmentMetaDatas: [AttachmentMetaData]? = nil) {
