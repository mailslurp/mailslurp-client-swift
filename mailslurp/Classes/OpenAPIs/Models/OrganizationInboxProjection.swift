...
@objc public class OrganizationInboxProjection: NSObject, Codable {
    ...
    public init(createdAt: Date? = nil, emailAddress: String? = nil, favourite: Bool? = nil, _id: UUID? = nil, inboxType: InboxType? = nil, name: String? = nil, readOnly: Bool? = nil, tags: [String]? = nil, teamAccess: Bool? = nil) {
