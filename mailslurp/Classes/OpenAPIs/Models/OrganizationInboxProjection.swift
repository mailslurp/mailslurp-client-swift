...
@objc public class OrganizationInboxProjection: NSObject, Codable {
    ...
    public init(_id: UUID? = nil, createdAt: Date? = nil, name: String? = nil, emailAddress: String? = nil, favourite: Bool? = nil, tags: Set<String>? = nil, teamAccess: Bool? = nil, inboxType: InboxType? = nil, readOnly: Bool? = nil) {
        self._id = _id
