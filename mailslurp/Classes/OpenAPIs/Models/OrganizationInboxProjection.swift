...
@objc public class OrganizationInboxProjection: NSObject, Codable {
    ...
    public init(_id: UUID, createdAt: Date, name: String? = nil, emailAddress: String? = nil, favourite: Bool, tags: Set<String>? = nil, teamAccess: Bool, inboxType: InboxType? = nil, readOnly: Bool) {
        self._id = _id
