...
@objc public class ReplyToEmailOptions: NSObject, Codable {
    ...
    public init(attachments: [String]? = nil, body: String? = nil, charset: String? = nil, from: String? = nil, isHTML: Bool? = nil, replyTo: String? = nil, sendStrategy: SendStrategy? = nil, template: UUID? = nil, templateVariables: Any? = nil, useInboxName: Bool? = nil) {
