...
@objc public class ReplyToEmailOptions: NSObject, Codable { 
    ...
    public init(attachments: [String]?, body: String?, charset: String?, from: String?, isHTML: Bool?, replyTo: String?, sendStrategy: SendStrategy?, template: UUID?, templateVariables: Any?, useInboxName: Bool?) {
