...
@objc public class InboxDto: NSObject, Codable {
    ...
    public init(_id: UUID? = nil, userId: UUID? = nil, createdAt: Date? = nil, name: String? = nil, _description: String? = nil, emailAddress: String? = nil, expiresAt: String? = nil, favourite: Bool? = nil, tags: Set<String>? = nil, inboxType: InboxType? = nil, readOnly: Bool? = nil) {
        self._id = _id
        self.userId = userId
