...
@objc public class InboxDto: NSObject, Codable {
    ...
    public init(_id: UUID, userId: UUID? = nil, createdAt: Date, name: String? = nil, _description: String? = nil, emailAddress: String, expiresAt: String? = nil, favourite: Bool, tags: [String]? = nil, inboxType: InboxType? = nil, readOnly: Bool) {
        self._id = _id
        self.userId = userId
