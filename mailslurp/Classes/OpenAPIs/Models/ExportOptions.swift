...
@objc public class ExportOptions: NSObject, Codable {
    ...
    public init(outputFormat: OutputFormat? = nil, excludePreviouslyExported: Bool? = nil, createdEarliestTime: Date? = nil, createdOldestTime: Date? = nil, filter: String? = nil, listSeparatorToken: String? = nil) {
