...
@objc public class ExportOptions: NSObject, Codable { 
    ...
    public init(outputFormat: OutputFormat, excludePreviouslyExported: Bool?, createdEarliestTime: Date?, createdOldestTime: Date?, filter: String?, listSeparatorToken: Any?) {
