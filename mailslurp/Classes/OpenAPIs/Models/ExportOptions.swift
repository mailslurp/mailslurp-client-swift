...
@objc public class ExportOptions: NSObject, Codable {
    ...
    public var listSeparatorToken: AnyCodable?

    public init(outputFormat: OutputFormat, excludePreviouslyExported: Bool? = nil, createdEarliestTime: Date? = nil, createdOldestTime: Date? = nil, filter: String? = nil, listSeparatorToken: AnyCodable? = nil) {
