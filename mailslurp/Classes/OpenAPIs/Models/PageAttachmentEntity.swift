...
@objc public class PageAttachmentEntity: NSObject, Codable { 
    ...
    public var content: [AttachmentEntity]?
    ...
    public init(content: [AttachmentEntity]?, empty: Bool?, first: Bool?, last: Bool?, number: Int?, numberOfElements: Int?, pageable: Pageable?, size: Int?, sort: Sort?, totalElements: Int64?, totalPages: Int?) {
