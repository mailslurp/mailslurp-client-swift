...
@objc public class WaitForConditions: NSObject, Codable {
    ...
    public init(count: Int, countType: CountType? = nil, inboxId: UUID, matches: [MatchOption]? = nil, since: Date? = nil, sortDirection: SortDirection? = nil, timeout: Int64, unreadOnly: Bool? = nil) {
        self.count = count
