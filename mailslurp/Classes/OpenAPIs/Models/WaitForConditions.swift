...
@objc public class WaitForConditions: NSObject, Codable {
    ...
    public init(before: Date? = nil, count: Int? = nil, countType: CountType? = nil, delayTimeout: Int64? = nil, inboxId: UUID, matches: [MatchOption]? = nil, since: Date? = nil, sortDirection: SortDirection? = nil, timeout: Int64, unreadOnly: Bool? = nil) {
        self.before = before
        self.count = count
