...
@objc public class PageBouncedRecipients: NSObject, Codable {
    ...
    public init(content: [BounceRecipient]? = nil, pageable: Pageable? = nil, totalElements: Int64? = nil, totalPages: Int? = nil, last: Bool? = nil, size: Int? = nil, number: Int? = nil, sort: Sort? = nil, numberOfElements: Int? = nil, first: Bool? = nil, empty: Bool? = nil) {
