...
@objc public class Email: NSObject, Codable { 
    ...
    public init(analysis: EmailAnalysis?, attachments: [String]?, bcc: [String]?, body: String?, bodyMD5Hash: String?, cc: [String]?, charset: String?, createdAt: Date?, from: String?, headers: [String:String]?, _id: UUID?, inboxId: UUID?, isHTML: Bool?, read: Bool?, subject: String?, to: [String]?, updatedAt: Date?, userId: UUID?) {
