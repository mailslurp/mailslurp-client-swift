...
@objc public class Email: NSObject, Codable {
    ...
    public init(_id: UUID? = nil, userId: UUID? = nil, inboxId: UUID? = nil, to: [String]? = nil, from: String? = nil, sender: Sender? = nil, recipients: EmailRecipients? = nil, replyTo: String? = nil, cc: [String]? = nil, bcc: [String]? = nil, headers: [String: String]? = nil, attachments: [String]? = nil, subject: String? = nil, body: String? = nil, bodyExcerpt: String? = nil, bodyMD5Hash: String? = nil, charset: String? = nil, analysis: EmailAnalysis? = nil, createdAt: Date? = nil, updatedAt: Date? = nil, read: Bool? = nil, teamAccess: Bool? = nil, html: Bool? = nil) {
        self._id = _id
        self.userId = userId
