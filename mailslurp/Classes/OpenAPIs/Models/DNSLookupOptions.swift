...
@objc public class DNSLookupOptions: NSObject, Codable {
    ...
    public var omitFinalDNSDotNum: NSNumber? {
        get {
            return omitFinalDNSDot as NSNumber?
        }
    }
    /** List of record types you wish to query such as MX, DNS, TXT, NS, A etc. */
    public var recordTypes: [RecordTypes]?

    public init(hostname: String? = nil, omitFinalDNSDot: Bool? = nil, recordTypes: [RecordTypes]? = nil) {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(omitFinalDNSDot, forKey: .omitFinalDNSDot)
        try container.encodeIfPresent(recordTypes, forKey: .recordTypes)
    }
