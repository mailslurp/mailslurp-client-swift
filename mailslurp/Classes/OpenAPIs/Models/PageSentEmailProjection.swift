...
@objc public class PageSentEmailProjection: NSObject, Codable {
    ...
    public init(content: [SentEmailProjection]? = nil, pageable: Pageable? = nil, size: Int? = nil, number: Int? = nil, totalPages: Int? = nil, numberOfElements: Int? = nil, totalElements: Int64? = nil, last: Bool? = nil, sort: Sort? = nil, first: Bool? = nil, empty: Bool? = nil) {
