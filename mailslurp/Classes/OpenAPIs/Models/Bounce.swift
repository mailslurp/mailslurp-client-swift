...
@objc public class Bounce: NSObject, Codable {
    ...
    public init(bounceMta: String? = nil, bounceRecipients: [String]? = nil, bounceSubType: String? = nil, bounceType: String? = nil, createdAt: Date, _id: UUID? = nil, notificationType: String, sender: String, sentToRecipients: [String]? = nil, updatedAt: Date, userId: UUID) {
