...
@objc public class Inbox: NSObject, Codable { 
    ...
    public init(createdAt: Date?, _description: String?, emailAddress: String?, expiresAt: String?, favourite: Bool?, _id: UUID?, name: String?, readOnly: Bool?, tags: [String]?, teamAccess: Bool?, userId: UUID?) {
