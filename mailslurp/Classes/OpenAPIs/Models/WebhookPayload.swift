...
@objc public class WebhookPayload: NSObject, Codable { 
    ...
    public init(attachmentMetaDatas: [AttachmentMetaData]?, bcc: [String]?, cc: [String]?, createdAt: Date?, emailId: UUID?, eventName: EventName?, from: String?, _id: String?, inboxId: UUID?, subject: String?, to: [String]?, webhookId: UUID?, webhookName: String?) {
