...
@objc public class CreateContactOptions: NSObject, Codable {
    ...
    public init(firstName: String? = nil, lastName: String? = nil, company: String? = nil, emailAddresses: Set<String>? = nil, tags: Set<String>? = nil, metaData: AnyCodable? = nil, optOut: Bool? = nil, groupId: UUID? = nil) {
