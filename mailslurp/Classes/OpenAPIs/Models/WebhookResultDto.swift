...
@objc public class WebhookResultDto: NSObject, Codable {
    ...
    public init(createdAt: Date, httpMethod: HttpMethod, _id: UUID? = nil, inboxId: UUID, messageId: String, redriveId: UUID? = nil, responseBodyExtract: String? = nil, responseStatus: Int? = nil, responseTimeMillis: Int64, resultType: ResultType? = nil, seen: Bool? = nil, updatedAt: Date, userId: UUID, webhookEvent: WebhookEvent, webhookId: UUID, webhookUrl: String) {
