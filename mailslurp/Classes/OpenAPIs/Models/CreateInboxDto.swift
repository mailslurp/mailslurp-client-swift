...
@objc public class CreateInboxDto: NSObject, Codable { 
    ...
    public init(allowTeamAccess: Bool?, _description: String?, emailAddress: String?, expiresAt: Date?, expiresIn: Int64?, favourite: Bool?, name: String?, tags: [String]?, useDomainPool: Bool?) {
