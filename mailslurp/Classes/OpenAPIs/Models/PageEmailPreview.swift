...
@objc public class PageEmailPreview: NSObject, Codable {
    ...
    public init(content: [EmailPreview]? = nil, pageable: Pageable? = nil, totalElements: Int64? = nil, totalPages: Int? = nil, last: Bool? = nil, size: Int? = nil, number: Int? = nil, sort: Sort? = nil, numberOfElements: Int? = nil, first: Bool? = nil, empty: Bool? = nil) {
