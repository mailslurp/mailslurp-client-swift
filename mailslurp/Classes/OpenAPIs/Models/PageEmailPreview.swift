...
@objc public class PageEmailPreview: NSObject, Codable {
    ...
    public init(content: [EmailPreview]? = nil, pageable: PageableObject? = nil, total: Int64? = nil, last: Bool? = nil, totalElements: Int64? = nil, totalPages: Int? = nil, size: Int? = nil, number: Int? = nil, sort: Sort? = nil, first: Bool? = nil, numberOfElements: Int? = nil, empty: Bool? = nil) {
