...
@objc public class DomainDto: NSObject, Codable { 
    ...
    public init(catchAllInboxId: UUID?, createdAt: Date, dkimTokens: [String]?, domain: String?, domainNameRecords: [DomainNameRecord]?, domainType: DomainType?, _id: UUID, isVerified: Bool?, updatedAt: Date, userId: UUID, verificationToken: String?) {
