...
@objc public class DomainDto: NSObject, Codable { 
    ...
    public init(createdAt: Date, dkimTokens: [String]?, domain: String?, domainNameRecords: [DomainNameRecord]?, _id: UUID, isVerified: Bool?, updatedAt: Date, userId: UUID, verificationToken: String?) {
