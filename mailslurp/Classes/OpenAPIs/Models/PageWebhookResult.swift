...
@objc public class PageWebhookResult: NSObject, Codable { 
    ...
    public init(content: [WebhookResultEntity]?, empty: Bool?, first: Bool?, last: Bool?, number: Int?, numberOfElements: Int?, pageable: Pageable?, size: Int?, sort: Sort?, totalElements: Int64?, totalPages: Int?) {
