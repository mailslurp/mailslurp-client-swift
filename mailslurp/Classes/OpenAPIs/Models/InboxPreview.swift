...
@objc public class InboxPreview: NSObject, Codable {
    ...
    public init(_id: UUID? = nil, emailAddress: String? = nil, createdAt: Date? = nil, favourite: Bool? = nil, name: String? = nil, tags: Set<String>? = nil, teamAccess: Bool? = nil, inboxType: InboxType? = nil, expiresAt: String? = nil) {
        self._id = _id
