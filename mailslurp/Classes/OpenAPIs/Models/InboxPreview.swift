...
@objc public class InboxPreview: NSObject, Codable {
    ...
    public init(_id: UUID, emailAddress: String? = nil, createdAt: Date, favourite: Bool, name: String? = nil, tags: [String]? = nil, teamAccess: Bool, inboxType: InboxType? = nil, virtualInbox: Bool? = nil, expiresAt: String? = nil) {
        self._id = _id
