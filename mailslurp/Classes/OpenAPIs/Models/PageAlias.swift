...
@objc public class PageAlias: NSObject, Codable { 
    ...
    public init(content: [Alias]?, empty: Bool?, first: Bool?, last: Bool?, number: Int?, numberOfElements: Int?, pageable: Pageable?, size: Int?, sort: Sort?, totalElements: Int64?, totalPages: Int?) {
