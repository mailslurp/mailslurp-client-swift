...
@objc public class WebhookResultEntity: NSObject, Codable {
    ...
    public init(createdAt: Date, httpMethod: HttpMethod, _id: UUID? = nil, inboxId: UUID, messageId: String, responseBodyExtract: String? = nil, responseStatus: Int? = nil, responseTimeMillis: Int64, resultType: ResultType? = nil, updatedAt: Date, userId: UUID, webhookEvent: WebhookEvent, webhookId: UUID, webhookUrl: String) {
