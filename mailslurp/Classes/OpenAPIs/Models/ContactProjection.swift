...
@objc public class ContactProjection: NSObject, Codable {
    ...
    public init(_id: UUID, groupId: UUID? = nil, createdAt: Date, firstName: String? = nil, lastName: String? = nil, company: String? = nil, emailAddresses: [String]? = nil, optOut: Bool? = nil) {
        self._id = _id
