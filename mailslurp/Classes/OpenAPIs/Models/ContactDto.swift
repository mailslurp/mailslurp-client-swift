...
@objc public class ContactDto: NSObject, Codable {
    ...
    public init(_id: UUID? = nil, groupId: UUID? = nil, firstName: String? = nil, lastName: String? = nil, company: String? = nil, emailAddresses: Set<String>? = nil, primaryEmailAddress: String? = nil, tags: Set<String>? = nil, metaData: AnyCodable? = nil, optOut: Bool? = nil, createdAt: Date? = nil) {
        self._id = _id
