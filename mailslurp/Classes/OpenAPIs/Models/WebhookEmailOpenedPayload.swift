...
@objc public class WebhookEmailOpenedPayload: NSObject, Codable {
    ...
    public init(messageId: String? = nil, webhookId: UUID? = nil, eventName: EventName? = nil, webhookName: String? = nil, inboxId: UUID? = nil, pixelId: UUID? = nil, sentEmailId: UUID? = nil, recipient: String? = nil, createdAt: Date? = nil) {
