...
@objc public class AttachmentEntity: NSObject, Codable, JSONEncodable {
    ...
    public init(_id: UUID? = nil, attachmentId: String, bucket: String? = nil, userId: UUID, contentType: String? = nil, contentLength: Int64? = nil, contentId: String? = nil, name: String? = nil, createdAt: Date, updatedAt: Date) {
        self._id = _id
