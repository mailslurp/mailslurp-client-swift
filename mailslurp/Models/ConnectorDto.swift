...
@objc public class ConnectorDto: NSObject, Codable, JSONEncodable {
    ...
    public init(_id: UUID, enabled: Bool, userId: UUID, connectorType: ConnectorType, connectorAuthType: ConnectorAuthType, syncEnabled: Bool, syncScheduleType: SyncScheduleType, syncInterval: Int? = nil, imapHost: String? = nil, imapPort: Int? = nil, imapUsername: String? = nil, imapPassword: String? = nil, imapSsl: Bool? = nil, selectFolder: String? = nil, searchTerms: String? = nil, createdAt: Date) {
        self._id = _id
