...
@objcMembers public class PageReputationItems: NSObject, Codable, ParameterConvertible {

    public var content: [ReputationItemProjection]?
    ...
    public init(content: [ReputationItemProjection]? = nil, pageable: PageableObject? = nil, totalElements: Int64, totalPages: Int, last: Bool? = nil, numberOfElements: Int? = nil, sort: SortObject? = nil, first: Bool? = nil, size: Int? = nil, number: Int? = nil, empty: Bool? = nil) {
