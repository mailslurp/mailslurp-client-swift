...
@objcMembers public class GenerateDmarcRecordOptions: NSObject, Codable, ParameterConvertible {

    public enum Version: String, Sendable, Codable, CaseIterable {
        case dmarc1 = "DMARC1"
    }
    public enum Policy: String, Sendable, Codable, CaseIterable {
        case _none = "NONE"
        case quarantine = "QUARANTINE"
        case reject = "REJECT"
    }
    public enum SubdomainPolicy: String, Sendable, Codable, CaseIterable {
        case _none = "NONE"
        case quarantine = "QUARANTINE"
        case reject = "REJECT"
    }
    ...
    public enum Adkim: String, Sendable, Codable, CaseIterable {
        case strict = "STRICT"
        case relaxed = "RELAXED"
    }
    public enum Aspf: String, Sendable, Codable, CaseIterable {
        case strict = "STRICT"
        case relaxed = "RELAXED"
    }
    public enum Fo: String, Sendable, Codable, CaseIterable {
        case fo0 = "FO_0"
        case fo1 = "FO_1"
        case foD = "FO_D"
        case foS = "FO_S"
    }
    public static let percentageRule = NumericRule<Int>(minimum: 1, exclusiveMinimum: false, maximum: 100, exclusiveMaximum: false, multipleOf: nil)
