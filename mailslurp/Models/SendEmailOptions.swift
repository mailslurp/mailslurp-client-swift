...
@objcMembers public class SendEmailOptions: NSObject, Codable, ParameterConvertible {

    public enum SendStrategy: String, Sendable, Codable, CaseIterable {
        case singleMessage = "SINGLE_MESSAGE"
    }
    public enum ValidateEmailAddresses: String, Sendable, Codable, CaseIterable {
    ...
    public var templateVariables: [String: JSONValue]?
    ...
    public init(toContacts: [UUID]? = nil, toGroup: UUID? = nil, to: [String]? = nil, from: String? = nil, fromName: String? = nil, cc: [String]? = nil, bcc: [String]? = nil, subject: String? = nil, replyTo: String? = nil, customHeaders: [String: String]? = nil, body: String? = nil, html: Bool? = nil, isHTML: Bool? = nil, charset: String? = nil, attachments: [String]? = nil, templateVariables: [String: JSONValue]? = nil, template: UUID? = nil, sendStrategy: SendStrategy? = nil, useInboxName: Bool? = nil, addTrackingPixel: Bool? = nil, filterBouncedRecipients: Bool? = nil, validateEmailAddresses: ValidateEmailAddresses? = nil, ignoreEmptyRecipients: Bool? = nil, isXAmpHtml: Bool? = nil, bodyParts: [SendEmailBodyPart]? = nil) {
