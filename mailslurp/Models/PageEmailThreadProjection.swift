//
// PageEmailThreadProjection.swift
//
...
@objcMembers public class PageEmailThreadProjection: NSObject, Codable, ParameterConvertible {

    public var content: [EmailThreadProjection]?
    ...
    public init(content: [EmailThreadProjection]? = nil, pageable: PageableObject? = nil, totalElements: Int64, totalPages: Int, last: Bool? = nil, numberOfElements: Int? = nil, sort: SortObject? = nil, first: Bool? = nil, size: Int? = nil, number: Int? = nil, empty: Bool? = nil) {
