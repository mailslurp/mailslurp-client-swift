...
@objc public class SentEmailProjection: NSObject, Codable, JSONEncodable {
    ...
    public init(_id: UUID, from: String? = nil, subject: String? = nil, userId: UUID, inboxId: UUID, attachments: [String], to: [String], bcc: [String], cc: [String], createdAt: Date, bodyMD5Hash: String? = nil, virtualSend: Bool) {
        self._id = _id
        self.from = from
