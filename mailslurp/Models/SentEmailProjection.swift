...
@objc public class SentEmailProjection: NSObject, Codable {
    ...
    public init(_id: UUID, from: String? = nil, userId: UUID, subject: String? = nil, inboxId: UUID, bodyMD5Hash: String? = nil, bcc: [String], cc: [String], virtualSend: Bool, attachments: [String], to: [String], createdAt: Date) {
        self._id = _id
        self.from = from
        self.userId = userId
