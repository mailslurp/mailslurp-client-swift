...
@objc public class SentEmailProjection: NSObject, Codable, JSONEncodable {
    ...
    public init(subject: String? = nil, _id: UUID, from: String? = nil, userId: UUID, attachments: [String], inboxId: UUID, to: [String], bcc: [String], cc: [String], createdAt: Date, bodyMD5Hash: String? = nil, virtualSend: Bool) {
