...
@objc public class SentEmailProjection: NSObject, Codable, JSONEncodable {
    ...
    public init(_id: UUID, from: String? = nil, userId: UUID, subject: String? = nil, inboxId: UUID, attachments: [String], createdAt: Date, to: [String], bcc: [String], cc: [String], bodyMD5Hash: String? = nil, virtualSend: Bool) {
        self._id = _id
        self.from = from
        self.userId = userId
