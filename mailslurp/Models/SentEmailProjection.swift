...
@objc public class SentEmailProjection: NSObject, Codable {
    ...
    public init(_id: UUID, from: String? = nil, userId: UUID, subject: String? = nil, createdAt: Date, bodyMD5Hash: String? = nil, bcc: [String], cc: [String], virtualSend: Bool, inboxId: UUID, attachments: [String], to: [String]) {
        self._id = _id
        self.from = from
        self.userId = userId
