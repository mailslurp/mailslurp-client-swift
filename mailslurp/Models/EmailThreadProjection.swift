...
@objcMembers public class EmailThreadProjection: NSObject, Codable, ParameterConvertible {
    ...
    public init(subject: String? = nil, sender: SenderProjection? = nil, recipients: EmailRecipientsProjection? = nil, inboxId: UUID? = nil, userId: UUID, updatedAt: Date, createdAt: Date, to: [String], cc: [String]? = nil, bcc: [String]? = nil, hasAttachments: Bool, unread: Bool, messageCount: Int, lastBodyExcerpt: String? = nil, lastTextExcerpt: String? = nil, lastCreatedAt: Date? = nil, lastFrom: String? = nil, lastSender: SenderProjection? = nil, _id: UUID, from: String? = nil) {
