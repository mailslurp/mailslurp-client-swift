...
@objcMembers public class EmailFeatureSupportResult: NSObject, Codable, ParameterConvertible {

    public enum DetectedFeatures: String, Sendable, Codable, CaseIterable {
        case amp = "amp"
    ...
    public static let detectedFeaturesRule = ArrayRule(minItems: nil, maxItems: nil, uniqueItems: true)
