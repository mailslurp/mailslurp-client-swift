...
@objc public class PageThreadProjection: NSObject, Codable, JSONEncodable {
    ...
    public init(content: [ThreadProjection]? = nil, pageable: PageableObject? = nil, total: Int64? = nil, totalElements: Int64? = nil, totalPages: Int? = nil, last: Bool? = nil, numberOfElements: Int? = nil, first: Bool? = nil, size: Int? = nil, number: Int? = nil, sort: SortObject? = nil, empty: Bool? = nil) {
