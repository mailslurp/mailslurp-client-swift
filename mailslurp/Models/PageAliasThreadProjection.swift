//
// PageAliasThreadProjection.swift
//
...
@objcMembers public class PageAliasThreadProjection: NSObject, Codable, ParameterConvertible {

    public var content: [AliasThreadProjection]?
    ...
    public init(content: [AliasThreadProjection]? = nil, pageable: PageableObject? = nil, totalElements: Int64, totalPages: Int, last: Bool? = nil, numberOfElements: Int? = nil, first: Bool? = nil, size: Int? = nil, number: Int? = nil, sort: SortObject? = nil, empty: Bool? = nil) {
