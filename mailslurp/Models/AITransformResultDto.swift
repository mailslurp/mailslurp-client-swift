...
@objcMembers public class AITransformResultDto: NSObject, Codable, JSONEncodable {
    ...
    public init(_id: UUID, userId: UUID, aiTransformId: UUID, aiTransformMappingId: UUID, value: AnyCodable?, entityId: UUID, entityType: EntityType, createdAt: Date, updatedAt: Date) {
        self._id = _id
        self.userId = userId
