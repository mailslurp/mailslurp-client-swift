...
@objc public class ContactProjection: NSObject, Codable, JSONEncodable {
    ...
    public init(_id: UUID, groupId: UUID? = nil, emailAddress: String? = nil, createdAt: Date, firstName: String? = nil, lastName: String? = nil, company: String? = nil, emailAddresses: [String]? = nil, optOut: Bool) {
        self._id = _id
