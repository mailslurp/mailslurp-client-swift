...
@objc public class ContactProjection: NSObject, Codable {
    ...
    public init(_id: UUID, groupId: UUID? = nil, createdAt: Date, lastName: String? = nil, company: String? = nil, emailAddresses: [String]? = nil, optOut: Bool, firstName: String? = nil) {
        self._id = _id
