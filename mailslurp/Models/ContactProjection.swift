...
@objc public class ContactProjection: NSObject, Codable, JSONEncodable {
    ...
    public init(emailAddress: String? = nil, emailAddresses: [String]? = nil, firstName: String? = nil, lastName: String? = nil, company: String? = nil, optOut: Bool? = nil, createdAt: Date, _id: UUID, groupId: UUID? = nil) {
