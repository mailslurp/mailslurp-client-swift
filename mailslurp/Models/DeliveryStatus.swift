...
@objc public class DeliveryStatus: NSObject, Codable {
    ...
    public init(_id: UUID? = nil, userId: UUID, sentId: UUID? = nil, remoteMtaIp: String? = nil, inboxId: UUID? = nil, reportingMta: String? = nil, recipients: [String]? = nil, smtpResponse: String? = nil, processingTimeMillis: Int64? = nil, received: Date? = nil, subject: String? = nil, createdAt: Date, updatedAt: Date) {
        self._id = _id
        self.userId = userId
        self.sentId = sentId
