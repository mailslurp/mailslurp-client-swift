...
@objcMembers public class ReplyToAliasEmailOptions: NSObject, Codable, ParameterConvertible {
    ...
    public init(body: String, isHTML: Bool, charset: String? = nil, attachments: [String]? = nil, templateVariables: [String: JSONValue]? = nil, template: UUID? = nil, sendStrategy: SendStrategy? = nil, customHeaders: [String: String]? = nil, useInboxName: Bool? = nil, html: Bool? = nil) {
        self.body = body
        self.isHTML = isHTML
