//
// PageAITransformResultProjection.swift
//
...
@objcMembers public class PageAITransformResultProjection: NSObject, Codable, ParameterConvertible {

    public var content: [AITransformResultProjectionDto]?
    ...
    public init(content: [AITransformResultProjectionDto]? = nil, pageable: PageableObject? = nil, totalElements: Int64, totalPages: Int, last: Bool? = nil, numberOfElements: Int? = nil, first: Bool? = nil, size: Int? = nil, number: Int? = nil, sort: SortObject? = nil, empty: Bool? = nil) {
