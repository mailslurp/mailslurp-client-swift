...
@objcMembers public class CreateInboxReplierOptions: NSObject, Codable, ParameterConvertible {
    ...
    public static let matchRule = StringRule(minLength: 1, maxLength: nil, pattern: nil)
    ...
    public init(inboxId: UUID? = nil, name: String? = nil, field: Field, match: String, replyTo: String? = nil, subject: String? = nil, from: String? = nil, charset: String? = nil, ignoreReplyTo: Bool? = nil, isHTML: Bool? = nil, body: String? = nil, templateId: UUID? = nil, templateVariables: [String: JSONValue]? = nil) {
