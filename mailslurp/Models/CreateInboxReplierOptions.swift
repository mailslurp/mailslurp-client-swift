...
@objcMembers public class CreateInboxReplierOptions: NSObject, Codable, JSONEncodable {
    ...
    public init(inboxId: UUID? = nil, name: String? = nil, field: Field, match: String, replyTo: String? = nil, subject: String? = nil, from: String? = nil, charset: String? = nil, ignoreReplyTo: Bool? = nil, isHTML: Bool? = nil, body: String? = nil, templateId: UUID? = nil, templateVariables: [String: AnyCodable]? = nil) {
