...
@objcMembers public class DomainDto: NSObject, Codable, ParameterConvertible {

    public enum DomainType: String, Sendable, Codable, CaseIterable {
    ...
    public init(_id: UUID, userId: UUID, domain: String, verificationToken: String, dkimTokens: [String], duplicateRecordsMessage: String? = nil, hasDuplicateRecords: Bool, missingRecordsMessage: String? = nil, hasMissingRecords: Bool, isVerified: Bool, domainNameRecords: [DomainNameRecord], catchAllInboxId: UUID? = nil, createdAt: Date, updatedAt: Date, domainType: DomainType) {
        self._id = _id
        self.userId = userId
        self.domain = domain
        self.verificationToken = verificationToken
        self.dkimTokens = dkimTokens
        self.duplicateRecordsMessage = duplicateRecordsMessage
        self.hasDuplicateRecords = hasDuplicateRecords
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(duplicateRecordsMessage, forKey: .duplicateRecordsMessage)
        try container.encode(hasDuplicateRecords, forKey: .hasDuplicateRecords)
...
extension DomainDto: Identifiable {}
