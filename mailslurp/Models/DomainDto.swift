...
public struct DomainDto: Codable, Hashable {
    ...
    public init(id: UUID, userId: UUID, domain: String, verificationToken: String, dkimTokens: [String], isVerified: Bool, domainNameRecords: [DomainNameRecord], catchAllInboxId: UUID? = nil, createdAt: Date, updatedAt: Date, domainType: DomainType) {
        self.id = id
        self.userId = userId
        self.domain = domain
