...
@objcMembers public class AITransformMappingProjection: NSObject, Codable, ParameterConvertible {
    ...
    public init(userId: UUID, createdAt: Date, aiTransformId: UUID, entityId: UUID? = nil, entityType: EntityType, contentSelector: ContentSelector? = nil, triggerSelector: TriggerSelector? = nil, name: String? = nil, _id: UUID) {
        self.userId = userId
