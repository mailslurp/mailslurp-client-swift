...
@objcMembers public class CreateEmergencyAddressOptions: NSObject, Codable, ParameterConvertible {

    public enum IsoCountryCode: String, Sendable, Codable, CaseIterable {
        case us = "US"
        case gb = "GB"
        case au = "AU"
        case ca = "CA"
