...
@objcMembers public class EmailFeatureOverview: NSObject, Codable, ParameterConvertible {
    ...
    public static let statusesRule = ArrayRule(minItems: nil, maxItems: nil, uniqueItems: true)
