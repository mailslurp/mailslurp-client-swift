...
@objcMembers public class InboxReplierDto: NSObject, Codable, JSONEncodable {
    ...
    public init(_id: UUID, inboxId: UUID? = nil, name: String? = nil, field: Field, match: String, replyTo: String? = nil, subject: String? = nil, from: String? = nil, charset: String? = nil, isHTML: Bool, templateId: UUID? = nil, templateVariables: [String: AnyCodable]? = nil, ignoreReplyTo: Bool, createdAt: Date) {
        self._id = _id
