...
public struct InboxDto: Codable, Hashable {
    ...
    public init(id: UUID, userId: UUID? = nil, createdAt: Date, name: String? = nil, domainId: UUID? = nil, description: String? = nil, emailAddress: String, expiresAt: String? = nil, favourite: Bool, tags: [String]? = nil, inboxType: InboxType? = nil, readOnly: Bool, virtualInbox: Bool) {
        self.id = id
        self.userId = userId
