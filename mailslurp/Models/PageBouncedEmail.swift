...
@objc public class PageBouncedEmail: NSObject, Codable, JSONEncodable {
    ...
    public init(content: [BounceProjection]? = nil, pageable: PageableObject? = nil, totalPages: Int, totalElements: Int64, last: Bool? = nil, numberOfElements: Int? = nil, size: Int? = nil, number: Int? = nil, sort: SortObject? = nil, first: Bool? = nil, empty: Bool? = nil) {
