...
@objcMembers public class PageBouncedEmail: NSObject, Codable, ParameterConvertible {
    ...
    public init(content: [BounceProjection]? = nil, pageable: PageableObject? = nil, totalElements: Int64, totalPages: Int, last: Bool? = nil, numberOfElements: Int? = nil, sort: SortObject? = nil, first: Bool? = nil, size: Int? = nil, number: Int? = nil, empty: Bool? = nil) {
