...
@objcMembers public class CreateWebhookOptions: NSObject, Codable, ParameterConvertible {
    ...
    public init(url: String, basicAuth: BasicAuthOptions? = nil, name: String? = nil, eventName: EventName? = nil, includeHeaders: WebhookHeaders? = nil, requestBodyTemplate: String? = nil, aiTransformId: UUID? = nil, useStaticIpRange: Bool? = false, ignoreInsecureSslCertificates: Bool? = nil, tags: [String]? = nil) {
        self.url = url
