...
@objc public class CreateWebhookOptions: NSObject, Codable, JSONEncodable {
    ...
    public init(url: String, basicAuth: BasicAuthOptions? = nil, name: String? = nil, eventName: EventName? = nil, includeHeaders: WebhookHeaders? = nil, requestBodyTemplate: String? = nil) {
        self.url = url
