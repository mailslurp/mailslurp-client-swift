...
public struct EmergencyAddress: Codable, Hashable {
    ...
    public init(id: UUID? = nil, sid: String, userId: UUID, displayName: String, customerName: String, address1: String, city: String, region: String, postalCode: String, phoneCountry: PhoneCountry, accountSid: String, createdAt: Date, updatedAt: Date) {
        self.id = id
        self.sid = sid
        self.userId = userId
