...
@objcMembers public class BulkSendEmailOptions: NSObject, Codable, ParameterConvertible {

    public static let inboxIdsRule = ArrayRule(minItems: 1, maxItems: nil, uniqueItems: false)
