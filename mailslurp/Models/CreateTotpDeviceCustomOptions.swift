//
// CreateTotpDeviceCustomOptions.swift
//
...
@objcMembers public class CreateTotpDeviceCustomOptions: NSObject, Codable, ParameterConvertible {
    ...
    public init(secret: String, name: String? = nil, username: String? = nil, issuer: String? = nil, digits: Int? = 6, period: Int? = 30, algorithm: String? = nil) {
        self.secret = secret
        self.name = name
