...
/** Collection of items */
public struct SendWithQueueResult: Codable, Hashable {
    ...
    public init(id: UUID, userId: UUID, subject: String? = nil, inboxId: UUID? = nil, headerId: String, delivered: Bool, exceptionName: String? = nil, message: String? = nil, createdAt: Date, updatedAt: Date) {
        self.id = id
        self.userId = userId
