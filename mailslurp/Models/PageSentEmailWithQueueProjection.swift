...
@objc public class PageSentEmailWithQueueProjection: NSObject, Codable, JSONEncodable {
    ...
    public init(content: [SendWithQueueResult], pageable: PageableObject? = nil, total: Int64? = nil, size: Int, number: Int, totalPages: Int, numberOfElements: Int, totalElements: Int64, last: Bool? = nil, sort: Sort? = nil, first: Bool? = nil, empty: Bool? = nil) {
