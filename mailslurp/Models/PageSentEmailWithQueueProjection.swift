...
@objc public class PageSentEmailWithQueueProjection: NSObject, Codable, JSONEncodable {
    ...
    public init(content: [SendWithQueueResult], pageable: PageableObject? = nil, total: Int64? = nil, numberOfElements: Int, totalElements: Int64, totalPages: Int, size: Int, number: Int, last: Bool? = nil, first: Bool? = nil, sort: SortObject? = nil, empty: Bool? = nil) {
