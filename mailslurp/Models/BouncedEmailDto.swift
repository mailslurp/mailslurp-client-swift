...
/** Bounced email */
public struct BouncedEmailDto: Codable, Hashable {
    ...
    public init(id: UUID? = nil, userId: UUID, notificationType: String, sentToRecipients: [String]? = nil, sender: String, bounceMta: String? = nil, bounceType: String? = nil, bounceRecipients: [String]? = nil, bounceSubType: String? = nil, sentEmailId: UUID? = nil, subject: String? = nil, createdAt: Date) {
        self.id = id
        self.userId = userId
