//
// AITransformResultProjectionDto.swift
//
...
@objcMembers public class AITransformResultProjectionDto: NSObject, Codable, ParameterConvertible {
    ...
    public init(_id: UUID, aiTransformId: UUID, aiTransformMappingId: UUID? = nil, userId: UUID, value: JSONValue? = nil, entityId: UUID? = nil, entityType: EntityType? = nil, createdAt: Date) {
        self._id = _id
...
extension AITransformResultProjectionDto: Identifiable {}
