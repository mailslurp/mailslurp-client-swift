...
public struct PhoneNumberDto: Codable, Hashable {
    ...
    public init(id: UUID, userId: UUID, complianceAddress: UUID? = nil, emergencyAddress: UUID? = nil, phoneNumber: String, phoneCountry: PhoneCountry, phonePlan: UUID, createdAt: Date, updatedAt: Date) {
        self.id = id
        self.userId = userId
