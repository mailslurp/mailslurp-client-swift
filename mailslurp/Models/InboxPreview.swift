...
/** Inbox data */
public struct InboxPreview: Codable, Hashable {
    ...
    public init(id: UUID, emailAddress: String? = nil, createdAt: Date, favourite: Bool, name: String? = nil, tags: [String]? = nil, teamAccess: Bool, inboxType: InboxType? = nil, virtualInbox: Bool, expiresAt: String? = nil) {
        self.id = id
