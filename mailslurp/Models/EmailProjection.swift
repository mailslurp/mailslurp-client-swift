...
@objc public class EmailProjection: NSObject, Codable, JSONEncodable {
    ...
    public init(_id: UUID, from: String? = nil, subject: String? = nil, inboxId: UUID, attachments: [String]? = nil, createdAt: Date, to: [String], bcc: [String]? = nil, cc: [String]? = nil, domainId: UUID? = nil, teamAccess: Bool, bodyMD5Hash: String? = nil, read: Bool, bodyExcerpt: String? = nil) {
        self._id = _id
        self.from = from
