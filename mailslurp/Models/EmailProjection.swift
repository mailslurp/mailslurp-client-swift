...
public struct EmailProjection: Codable, Hashable {
    ...
    public init(id: UUID, from: String? = nil, subject: String? = nil, attachments: [String]? = nil, inboxId: UUID, to: [String], createdAt: Date, bcc: [String]? = nil, cc: [String]? = nil, teamAccess: Bool, read: Bool, bodyMD5Hash: String? = nil, bodyExcerpt: String? = nil) {
        self.id = id
        self.from = from
