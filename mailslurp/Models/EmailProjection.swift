...
@objcMembers public class EmailProjection: NSObject, Codable, JSONEncodable {
    ...
    public init(sender: Sender? = nil, recipients: EmailRecipients? = nil, inboxId: UUID, attachments: [String]? = nil, createdAt: Date, to: [String], cc: [String]? = nil, bcc: [String]? = nil, messageId: String? = nil, domainId: UUID? = nil, favourite: Bool? = nil, plusAddress: UUID? = nil, sizeBytes: Int64? = nil, inReplyTo: String? = nil, read: Bool, bodyExcerpt: String? = nil, textExcerpt: String? = nil, bodyPartContentTypes: [String]? = nil, bodyMD5Hash: String? = nil, teamAccess: Bool, subject: String? = nil, _id: UUID, threadId: UUID? = nil, from: String?) {
        self.sender = sender
