...
@objc public class EmailProjection: NSObject, Codable, JSONEncodable {
    ...
    public init(inboxId: UUID, attachments: [String]? = nil, createdAt: Date, to: [String], bcc: [String]? = nil, cc: [String]? = nil, domainId: UUID? = nil, read: Bool, bodyExcerpt: String? = nil, teamAccess: Bool, bodyMD5Hash: String? = nil, textExcerpt: String? = nil, subject: String? = nil, _id: UUID, from: String? = nil) {
