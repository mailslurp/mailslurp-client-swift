...
@objc public class EmailProjection: NSObject, Codable, JSONEncodable {
    ...
    public init(_id: UUID, from: String? = nil, subject: String? = nil, attachments: [String]? = nil, inboxId: UUID, createdAt: Date, to: [String], domainId: UUID? = nil, bcc: [String]? = nil, cc: [String]? = nil, read: Bool, bodyExcerpt: String? = nil, teamAccess: Bool, bodyMD5Hash: String? = nil) {
        self._id = _id
        self.from = from
