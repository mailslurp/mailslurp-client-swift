...
@objc public class ThreadProjection: NSObject, Codable, JSONEncodable {
    ...
    public init(name: String? = nil, _id: UUID, userId: UUID, subject: String? = nil, inboxId: UUID, createdAt: Date, updatedAt: Date, to: [String], bcc: [String]? = nil, cc: [String]? = nil, aliasId: UUID) {
        self.name = name
        self._id = _id
        self.userId = userId
