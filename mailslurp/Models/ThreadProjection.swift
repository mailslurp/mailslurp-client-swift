...
@objc public class ThreadProjection: NSObject, Codable, JSONEncodable {
    ...
    public init(subject: String? = nil, inboxId: UUID, userId: UUID, to: [String], bcc: [String]? = nil, cc: [String]? = nil, aliasId: UUID, createdAt: Date, updatedAt: Date, name: String? = nil, _id: UUID) {
