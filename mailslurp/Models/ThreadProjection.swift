...
@objc public class ThreadProjection: NSObject, Codable, JSONEncodable {
    ...
    public init(inboxId: UUID, userId: UUID, to: [String], bcc: [String]? = nil, cc: [String]? = nil, aliasId: UUID, createdAt: Date, updatedAt: Date, subject: String? = nil, name: String? = nil, _id: UUID) {
