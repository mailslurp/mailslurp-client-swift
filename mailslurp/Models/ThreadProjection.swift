...
@objc public class ThreadProjection: NSObject, Codable, JSONEncodable {
    ...
    public init(createdAt: Date, updatedAt: Date, userId: UUID, inboxId: UUID, to: [String], bcc: [String]? = nil, cc: [String]? = nil, aliasId: UUID, subject: String? = nil, name: String? = nil, _id: UUID) {
