...
@objc public class AttachmentProjection: NSObject, Codable, JSONEncodable {
    ...
    public init(userId: UUID, contentId: String? = nil, attachmentId: String, createdAt: Date, updatedAt: Date, name: String? = nil, contentLength: Int64? = nil, contentType: String? = nil) {
        self.userId = userId
