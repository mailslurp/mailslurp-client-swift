...
@objc public class AttachmentProjection: NSObject, Codable, JSONEncodable {
    ...
    public init(userId: UUID, attachmentId: String, createdAt: Date, updatedAt: Date, contentId: String? = nil, name: String? = nil, contentLength: Int64? = nil, contentType: String? = nil) {
        self.userId = userId
