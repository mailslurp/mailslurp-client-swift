...
@objcMembers public class DNSLookupOptions: NSObject, Codable, ParameterConvertible {

    public enum RecordTypes: String, Sendable, Codable, CaseIterable {
        case a = "A"
        case ns = "NS"
        case md = "MD"
        case mf = "MF"
    ...
    public static let recordTypesRule = ArrayRule(minItems: 1, maxItems: nil, uniqueItems: false)
