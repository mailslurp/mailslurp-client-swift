...
@objcMembers public class WebhookNewContactPayload: NSObject, Codable, ParameterConvertible {
    ...
    public init(messageId: String, webhookId: UUID, webhookName: String? = nil, eventName: EventName, contactId: UUID, groupId: UUID? = nil, firstName: String? = nil, lastName: String? = nil, company: String? = nil, primaryEmailAddress: String? = nil, emailAddresses: [String], tags: [String], metaData: JSONValue? = nil, optOut: Bool, createdAt: Date) {
