...
@objcMembers public class AITransformMappingDto: NSObject, Codable, JSONEncodable {
    ...
    public init(_id: UUID, aiTransformId: UUID, userId: UUID, name: String? = nil, entityId: UUID, entityType: EntityType) {
        self._id = _id
