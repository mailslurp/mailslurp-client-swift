...
@objcMembers public class SearchEmailsOptions: NSObject, Codable, ParameterConvertible {

    public enum SortDirection: String, Sendable, Codable, CaseIterable {
        case asc = "ASC"
        case desc = "DESC"
    }
    public static let pageSizeRule = NumericRule<Int>(minimum: nil, exclusiveMinimum: false, maximum: 100, exclusiveMaximum: false, multipleOf: nil)
