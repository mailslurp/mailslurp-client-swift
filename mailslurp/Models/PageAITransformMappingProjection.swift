//
// PageAITransformMappingProjection.swift
//
...
@objcMembers public class PageAITransformMappingProjection: NSObject, Codable, ParameterConvertible {

    public var content: [AITransformMappingProjection]?
    ...
    public init(content: [AITransformMappingProjection]? = nil, pageable: PageableObject? = nil, totalElements: Int64, totalPages: Int, last: Bool? = nil, numberOfElements: Int? = nil, sort: SortObject? = nil, first: Bool? = nil, size: Int? = nil, number: Int? = nil, empty: Bool? = nil) {
