...
@objcMembers public class WebhookResultDto: NSObject, Codable, ParameterConvertible {
    ...
    public enum WebhookEvent: String, Sendable, Codable, CaseIterable {
    ...
    public enum ResultType: String, Sendable, Codable, CaseIterable {
...
extension WebhookResultDto: Identifiable {}
