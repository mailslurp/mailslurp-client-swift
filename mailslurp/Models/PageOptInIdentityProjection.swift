//
// PageOptInIdentityProjection.swift
//
...
@objcMembers public class PageOptInIdentityProjection: NSObject, Codable, ParameterConvertible {

    public var content: [OptInIdentityProjection]?
    ...
    public init(content: [OptInIdentityProjection]? = nil, pageable: PageableObject? = nil, totalElements: Int64, totalPages: Int, last: Bool? = nil, numberOfElements: Int? = nil, first: Bool? = nil, size: Int? = nil, number: Int? = nil, sort: SortObject? = nil, empty: Bool? = nil) {
