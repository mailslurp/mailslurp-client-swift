...
@objcMembers public class InboxReplierEventProjection: NSObject, Codable, ParameterConvertible {
    ...
    public init(recipients: [String]? = nil, userId: UUID? = nil, emailId: UUID? = nil, inboxId: UUID? = nil, createdAt: Date, sentId: UUID? = nil, replierId: UUID? = nil, message: String? = nil, _id: UUID? = nil, status: Status? = nil) {
