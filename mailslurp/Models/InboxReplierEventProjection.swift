...
@objc public class InboxReplierEventProjection: NSObject, Codable, JSONEncodable {
    ...
    public init(message: String? = nil, _id: UUID? = nil, status: Status? = nil, userId: UUID? = nil, recipients: [String]? = nil, emailId: UUID? = nil, inboxId: UUID? = nil, createdAt: Date, sentId: UUID? = nil, replierId: UUID? = nil) {
