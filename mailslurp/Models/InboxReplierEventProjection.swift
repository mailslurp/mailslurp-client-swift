...
@objc public class InboxReplierEventProjection: NSObject, Codable, JSONEncodable {
    ...
    public init(emailId: UUID? = nil, inboxId: UUID? = nil, recipients: [String]? = nil, userId: UUID? = nil, createdAt: Date, sentId: UUID? = nil, replierId: UUID? = nil, message: String? = nil, _id: UUID? = nil, status: Status? = nil) {
