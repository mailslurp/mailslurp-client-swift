...
@objc public class InboxReplierEventProjection: NSObject, Codable, JSONEncodable {
    ...
    public init(createdAt: Date, recipients: [String]? = nil, emailId: UUID? = nil, inboxId: UUID? = nil, userId: UUID? = nil, sentId: UUID? = nil, replierId: UUID? = nil, message: String? = nil, _id: UUID? = nil, status: Status? = nil) {
