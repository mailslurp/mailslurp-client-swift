...
@objcMembers public class PageDeliveryStatus: NSObject, Codable, ParameterConvertible {
    ...
    public init(content: [DeliveryStatusDto]? = nil, pageable: PageableObject? = nil, totalElements: Int64, totalPages: Int, last: Bool? = nil, numberOfElements: Int? = nil, first: Bool? = nil, size: Int? = nil, number: Int? = nil, sort: SortObject? = nil, empty: Bool? = nil) {
