//
// PageAITransformProjection.swift
//
...
@objcMembers public class PageAITransformProjection: NSObject, Codable, ParameterConvertible {

    public var content: [AITransformProjection]?
    ...
    public init(content: [AITransformProjection]? = nil, pageable: PageableObject? = nil, totalElements: Int64, totalPages: Int, last: Bool? = nil, numberOfElements: Int? = nil, first: Bool? = nil, size: Int? = nil, number: Int? = nil, sort: SortObject? = nil, empty: Bool? = nil) {
