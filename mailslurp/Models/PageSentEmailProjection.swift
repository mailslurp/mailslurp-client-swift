...
@objc public class PageSentEmailProjection: NSObject, Codable {
    ...
    public init(content: [SentEmailProjection], pageable: PageableObject? = nil, total: Int64? = nil, size: Int, number: Int, numberOfElements: Int, totalPages: Int, totalElements: Int64, last: Bool? = nil, sort: Sort? = nil, first: Bool? = nil, empty: Bool? = nil) {
