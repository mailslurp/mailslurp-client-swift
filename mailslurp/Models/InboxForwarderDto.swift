...
@objcMembers public class InboxForwarderDto: NSObject, Codable, ParameterConvertible {
    ...
    public init(_id: UUID, inboxId: UUID? = nil, name: String? = nil, field: Field, match: String, forwardToRecipients: [String], createdAt: Date) {
        self._id = _id
...
extension InboxForwarderDto: Identifiable {}
