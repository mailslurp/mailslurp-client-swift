//
// PageEntityFavouriteItems.swift
//
...
@objcMembers public class PageEntityFavouriteItems: NSObject, Codable, ParameterConvertible {

    public var content: [EntityFavouriteItemProjection]?
    ...
    public init(content: [EntityFavouriteItemProjection]? = nil, pageable: PageableObject? = nil, totalElements: Int64, totalPages: Int, last: Bool? = nil, numberOfElements: Int? = nil, sort: SortObject? = nil, first: Bool? = nil, size: Int? = nil, number: Int? = nil, empty: Bool? = nil) {
