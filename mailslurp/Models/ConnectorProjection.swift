...
@objc public class ConnectorProjection: NSObject, Codable, JSONEncodable {
    ...
    public init(inboxId: UUID, userId: UUID, syncEnabled: Bool, connectorType: ConnectorType, syncScheduleType: SyncScheduleType, syncInterval: Int? = nil, createdAt: Date, _id: UUID? = nil) {
