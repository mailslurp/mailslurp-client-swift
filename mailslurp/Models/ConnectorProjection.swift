...
@objc public class ConnectorProjection: NSObject, Codable, JSONEncodable {
    ...
    public init(_id: UUID? = nil, inboxId: UUID, userId: UUID, createdAt: Date, syncEnabled: Bool, connectorType: ConnectorType, syncScheduleType: SyncScheduleType, syncInterval: Int? = nil) {
        self._id = _id
