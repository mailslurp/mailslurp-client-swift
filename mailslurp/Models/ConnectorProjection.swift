...
@objc public class ConnectorProjection: NSObject, Codable, JSONEncodable {
    ...
    public init(enabled: Bool? = nil, userId: UUID, emailAddress: String? = nil, inboxId: UUID, syncEnabled: Bool? = nil, syncScheduleType: SyncScheduleType, syncInterval: Int? = nil, createdAt: Date, name: String? = nil, _id: UUID? = nil) {
