//
// PagePhoneMessageThreadItemProjection.swift
//
...
@objcMembers public class PagePhoneMessageThreadItemProjection: NSObject, Codable, ParameterConvertible {

    public var content: [PhoneMessageThreadItemProjection]?
    ...
    public init(content: [PhoneMessageThreadItemProjection]? = nil, pageable: PageableObject? = nil, totalElements: Int64, totalPages: Int, last: Bool? = nil, numberOfElements: Int? = nil, sort: SortObject? = nil, first: Bool? = nil, size: Int? = nil, number: Int? = nil, empty: Bool? = nil) {
