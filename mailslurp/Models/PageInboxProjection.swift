...
@objc public class PageInboxProjection: NSObject, Codable, JSONEncodable {
    ...
    public init(content: [InboxPreview]? = nil, pageable: PageableObject? = nil, total: Int64? = nil, totalPages: Int? = nil, totalElements: Int64? = nil, last: Bool? = nil, size: Int? = nil, number: Int? = nil, sort: Sort? = nil, numberOfElements: Int? = nil, first: Bool? = nil, empty: Bool? = nil) {
