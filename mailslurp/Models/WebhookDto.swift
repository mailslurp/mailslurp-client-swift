...
public struct WebhookDto: Codable, Hashable {
    ...
    public init(id: UUID, userId: UUID, basicAuth: Bool, name: String? = nil, inboxId: UUID? = nil, url: String, method: Method, payloadJsonSchema: String, createdAt: Date, updatedAt: Date, eventName: EventName? = nil) {
        self.id = id
        self.userId = userId
