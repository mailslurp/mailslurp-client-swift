//
// PageEntityAutomationItems.swift
//
...
@objcMembers public class PageEntityAutomationItems: NSObject, Codable, ParameterConvertible {

    public var content: [EntityAutomationItemProjection]?
    ...
    public init(content: [EntityAutomationItemProjection]? = nil, pageable: PageableObject? = nil, totalElements: Int64, totalPages: Int, last: Bool? = nil, numberOfElements: Int? = nil, first: Bool? = nil, size: Int? = nil, number: Int? = nil, sort: SortObject? = nil, empty: Bool? = nil) {
