...
@objcMembers public class ImapMailboxStatus: NSObject, Codable, ParameterConvertible {
    ...
    public init(name: String, readOnly: Bool, items: JSONValue?, flags: [String]?, permanentFlags: [String]?, unseenSeqNum: Int64, messages: Int, recent: Int, unseen: Int, uidNext: Int64, uidValidity: Int, appendLimit: Int? = nil) {
        self.name = name
