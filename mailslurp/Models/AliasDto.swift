...
public struct AliasDto: Codable, Hashable {
    ...
    public init(id: UUID, emailAddress: String, maskedEmailAddress: String? = nil, userId: UUID, inboxId: UUID, name: String? = nil, useThreads: Bool? = nil, isVerified: Bool, createdAt: Date? = nil, updatedAt: Date? = nil) {
        self.id = id
