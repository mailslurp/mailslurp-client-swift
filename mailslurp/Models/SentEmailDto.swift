...
@objc public class SentEmailDto: NSObject, Codable {
    ...
    public init(_id: UUID, userId: UUID, inboxId: UUID, to: [String]? = nil, from: String? = nil, replyTo: String? = nil, cc: [String]? = nil, bcc: [String]? = nil, attachments: [String]? = nil, subject: String? = nil, bodyMD5Hash: String? = nil, body: String? = nil, toContacts: [UUID]? = nil, toGroup: UUID? = nil, charset: String? = nil, isHTML: Bool? = nil, sentAt: Date, pixelIds: [UUID]? = nil, messageId: String? = nil, messageIds: [String]? = nil, virtualSend: Bool? = nil, templateId: UUID? = nil, templateVariables: [String: AnyCodable]? = nil, html: Bool? = nil) {
        self._id = _id
        self.userId = userId
