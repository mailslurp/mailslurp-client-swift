...
@objcMembers public class PageEntityEventItems: NSObject, Codable, ParameterConvertible {

    public var content: [EntityEventItemProjection]?
    ...
    public init(content: [EntityEventItemProjection]? = nil, pageable: PageableObject? = nil, totalElements: Int64, totalPages: Int, last: Bool? = nil, numberOfElements: Int? = nil, sort: SortObject? = nil, first: Bool? = nil, size: Int? = nil, number: Int? = nil, empty: Bool? = nil) {
