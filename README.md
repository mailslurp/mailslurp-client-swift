...
*AttachmentControllerAPI* | [**downloadAttachmentAsBase64Encoded**](docs/AttachmentControllerAPI#downloadattachmentasbase64encoded) | **GET** /attachments/{attachmentId}/base64 | Get email attachment as base64 encoded string (alternative to binary responses). To read the content decode the Base64 encoded contents.
