...
*AliasControllerAPI* | [**replyToEmail**](docs/AliasControllerAPI.md#replytoemail) | **PUT** /aliases/{aliasId}/emails/{emailId} | Reply to an email
...
*EmailControllerAPI* | [**replyToEmail1**](docs/EmailControllerAPI.md#replytoemail1) | **PUT** /emails/{emailId} | Reply to an email
