...
*EmailControllerAPI* | [**getEmailHTMLQuery**](docs/EmailControllerAPI.md#getemailhtmlquery) | **POST** /emails/{emailId}/html-query | Parse and return text from an email, stripping HTML and decoding encoded characters
*EmailControllerAPI* | [**getEmailTextLines**](docs/EmailControllerAPI.md#getemailtextlines) | **POST** /emails/{emailId}/text | Parse and return text from an email, stripping HTML and decoding encoded characters
