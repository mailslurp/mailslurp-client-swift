...
*EmailControllerAPI* | [**getAttachments**](docs/EmailControllerAPI#getattachments) | **GET** /emails/{emailId}/attachments | Get all email attachment metadata. Metadata includes name and attachment size.
