...
*AttachmentControllerAPI* | [**uploadAttachment**](docs/AttachmentControllerAPI.md#uploadattachment) | **POST** /attachments | Upload an attachment for sending using base64 file encoding
*AttachmentControllerAPI* | [**uploadAttachmentBytes**](docs/AttachmentControllerAPI.md#uploadattachmentbytes) | **POST** /attachments/bytes | Upload an attachment for sending using file byte stream input octet stream
