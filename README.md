...
*InboxControllerAPI* | [**getExpiredInboxRecordById**](docs/InboxControllerAPI.md#getexpiredinboxrecordbyid) | **GET** /inboxes/expired-records/{expiredId} | Get an expired inbox record
*InboxControllerAPI* | [**getExpiredInboxRecordByInboxId**](docs/InboxControllerAPI.md#getexpiredinboxrecordbyinboxid) | **GET** /inboxes/{inboxId}/expired-record | Get expired inbox record for a previously existing inbox
*InboxControllerAPI* | [**getExpiredInboxRecords**](docs/InboxControllerAPI.md#getexpiredinboxrecords) | **GET** /inboxes/expired-records | List records of expired inboxes
