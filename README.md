...
*EmailControllerAPI* | [**getEmailContentMatch**](docs/EmailControllerAPI.md#getemailcontentmatch) | **GET** /emails/{emailId}/contentMatch | Get email content regex pattern match results. Runs regex against email body and returns match groups.
